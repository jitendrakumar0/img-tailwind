...
class HomeController extends Controller
{
  ...
  //  }
    ...
    //  }
     ...
     public function hire_ott_app_developers()
     {
        return view('hire-ott-app-developers.index');
     }
    ...
    //   }
     ...
     /*==============Services========================*/
      public function hire_dedicated_developers()
      {
        ...
        public function healthcare_demo()
        {
            return view('healthcare-demo.index');
        }

        public function ecommerce_demo()
        {
            return view('ecommerce-demo.index');
        }

        public function education_demo()
        {
            return view('education-demo.index');
        }

        public function banking_demo()
        {
            return view('banking-demo.index');
        }
        
        public function transport_demo()
        {
            return view('transport-demo.index');
        }
        public function media_demo()
        {
            return view('media-demo.index');
        }
        public function tour_demo()
        {
            return view('tour-demo.index');
        }
        public function social_demo()
        {
            return view('social-demo.index');
        }
        public function event_demo()
        {
        ...
        public function progressive_web_app_development()
        {
            return view('progressive-web-app-development.index');
        }

        public function ar_vr_app_development()
        {
            return view('ar-vr-app-development.index');
        }

        public function video_streaming_app_development()
        {
            return view('video-streaming-app-development.index');
        }

        
        public function iot_app_development()
        {
            return view('iot-app-development.index');
        }
        
        public function bespoke_software_development()
        {
            return view('bespoke-software-development.index');
        }
        public function food_delivery_demo()
        {
            return view('food-delivery-demo.index');
        }


        public function fantasy_sports_app_demo()
        {
            return view('fantasy-sports-app-demo.index');
        }

        public function home_services_app_development()
        {
            return view('home-services-app-development.index');
        }

        
        public function laundry_services_app_development()
        {
            return view('laundry-services-app-development.index');
        }

        public function tracking_app_development()
        {
            return view('tracking-app-development.index');
        }

        public function car_wash_app_development()
        {
            return view('car-wash-app-development.index');
        }
      ...
      public function casestudy()
       ...
       public function casestudy_5()
       {
           return view('casestudy-5.index');
       }
    ...
    public function food_delivery_app_development1()
    {
    ...
    public function contact_action_help(Request $request)
    {
        $referral_link = $request->headers->all();
        ...
        if (isset($_FILES['fileToUpload'])) {
            ...
            if (!in_array($ext, $extensions)) {
                ...
                $imgName = "contact" . time() . rand(1, 9999) . '.' . $ext;
                $file_size = $_FILES['fileToUpload']['size'];
                $file_tmp = $_FILES['fileToUpload']['tmp_name'];
                $file_type = $_FILES['fileToUpload']['type'];
        ...
        if((!preg_match($mobileregex, $input['contactnumber']) && $phoneCode=='IN +91')){
            ...
            // } else {
                ...
                $json['error'] = '0';
                $json['msg'] = "Mail Sent successfully.";
                return redirect()->route('thankyou')->with('message', 'Task completed successfully!');
           // }
        } else {
            $json['error'] = '1';
            $json['msg'] = "Some error found";
