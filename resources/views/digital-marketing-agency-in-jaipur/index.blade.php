...
@push('meta')
   <!--  Title -->
   <title>Digital Marketing Company in Jaipur | SMO, PPC, SEO Services</title>

   <!-- Required meta tags -->
   <meta name="title" content="Digital Marketing Company in Jaipur | SMO, PPC, SEO Services" />
   <meta name="description" content="Best Digital Marketing Company in Jaipur. We offer 360-degree online marketing services such as SEO, SMO, PPC, Content Marketing for your business." />
   <meta name="keywords" content="Digital Marketing Company in Jaipur, Digital Marketing Services, Online Marketing Services" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Digital Marketing Company in Jaipur | SMO, PPC, SEO Services">
   <meta name="twitter:description" content="Best Digital Marketing Company in Jaipur. We offer 360-degree online marketing services such as SEO, SMO, PPC, Content Marketing for your business.">
   <meta name="twitter:image" content="{{GETFOLDERPATH()}}/Best-Digital-Marketing-Company-In-Jaipur.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}digital-marketing-agency-in-jaipur.php">
   <meta property="og:title" content="Digital Marketing Company in Jaipur | SMO, PPC, SEO Services">
   <meta property="og:description" content="Best Digital Marketing Company in Jaipur. We offer 360-degree online marketing services such as SEO, SMO, PPC, Content Marketing for your business.">
   <meta property="og:image" content="{{GETFOLDERPATH()}}/Best-Digital-Marketing-Company-In-Jaipur.webp">
   <meta property="og:image:secure_url" content="{{GETFOLDERPATH()}}/Best-Digital-Marketing-Company-In-Jaipur.webp">



   <meta name="classification" content="Digital Marketing Company in Jaipur, Digital Marketing Services, Online Marketing Services" />
   <link rel="canonical" href="{{asset('/')}}digital-marketing-agency-in-jaipur.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/digital-marketing-agency-in-jaipur.min.css">
@endpush
@section('content')
   ...
   <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Best Digital Marketing <b>Company in Jaipur</b></span>
   ...
   @endsection('hero_btn')
   @section('hero_img')
   <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/Best-Digital-Marketing-Company-In-Jaipur.webp" alt="Best Digital Marketing Company In Jaipur">
   @endsection('hero_img')
                  ...
                  <div class="col-lg-5 col-md-12 pe-lg-5 transform-vision-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative tilt_image_pos" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100  position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/The-Famous-Digital-Marketing-Agency-In-Jaipur-That-Cares-About-Business-Sales-And-Traffic!.webp" alt="The Famous Digital Marketing Agency In Jaipur That Cares About Business Sales And Traffic!">
                           <img class="w-100  position-absolute top-0 start-0 bottom-0 end-0 end-0 tz" style="--tz:20px;" src="{{GETFOLDERPATH()}}/12.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">The Famous Digital Marketing Agency In Jaipur That Cares About Business Sales And Traffic!</h2>
         ...
         <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item active">
                  <div class="to-access-thumb">
                     ...
                     <div class="thumb"> <img src="{{GETFOLDERPATH()}}/In-Depth-Business-Analysis.webp" alt="In-Depth Business Analysis">
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  <div class="to-access-thumb">
                     <span class="anime"></span>
                     <div class="thumb"> <img src="{{GETFOLDERPATH()}}/Generation-Of-Traffic.webp" alt="Generation Of Traffic">
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  <div class="to-access-thumb">
                     <span class="anime"></span>
                     <div class="thumb"> <img src="{{GETFOLDERPATH()}}/Generating-Leads.webp" alt="Generating Leads">
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  <div class="to-access-thumb">
                     <span class="anime"></span>
                     <div class="thumb"> <img src="{{GETFOLDERPATH()}}/Develop-Your-Business-Growth.webp" alt="Develop Your Business Growth">
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  <div class="to-access-thumb">
                     <span class="anime"></span>
                     <div class="thumb"> <img src="{{GETFOLDERPATH()}}/Digital-Strategic-Support.webp" alt="Digital Strategic Support">
                     </div>
                  </div>
                  <div class="row">
   ...
   <!-- advantage_payment_gateway section -->
   <div class="container-fluid overflow-hidden advantage_payment_gateway position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row align-items-center">
                  <div class="col-lg-5 col-md-12 pe-lg-5 transform-vision-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative tilt_image_pos" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100  position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/Why-Digital-Marketing-Is-Important-For-Your-Busi.webp" alt="Why Digital Marketing Is Important For Your Business?">
                           <img class="w-100  position-absolute top-md-n50px top-n30px start-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{GETFOLDERPATH()}}/2.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7 col-md-12 mt-lg-0 mt-md-5 mt-5">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Why Digital Marketing Is Important For Your Business?</h2>
                        ...
                        <div class="col-auto mt-3">
                           <div class="row align-items-center">
                              <div class="col-auto">
                                 <i class="imgs img-star rounded-pill text-white fs-xxl-18 fs-xl-18 fs-lg-16 fs-md-15 fs-15 bg-theme1 d-flex w-xxl55px w-xl-55px w-lg-45px w-md-40px w-40px h-xxl-55px h-xl-55px h-lg-45px h-md-40px h-40px justify-content-center align-items-center position-relative zi-2"></i>
                              </div>
                              <div class="col-auto fs-16 text-theme1 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme1 border-3 border-bottom border-theme1 border-3 d-flex align-items-center h-40px pe-4"> For higher ROI</div>
                           </div>
                        </div>
                        <div class="col-auto mt-3">
                           <div class="row align-items-center">
                              ...
                              <div class="col-auto fs-16 text-theme1 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme1 border-3 border-bottom border-theme1 border-3 d-flex align-items-center h-40px pe-4">To grow your business</div>
                           </div>
                        </div>
                        <div class="col-auto mt-3">
                           <div class="row align-items-center">
                              ...
                              <div class="col-auto fs-16 text-theme1 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme1 border-3 border-bottom border-theme1 border-3 d-flex align-items-center h-40px pe-4">To reach the target market</div>
                           </div>
                        </div>
                        <div class="col-auto mt-3">
                           <div class="row align-items-center">
                              ...
                              <div class="col-auto fs-16 text-theme1 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme1 border-3 border-bottom border-theme1 border-3 d-flex align-items-center h-40px pe-4">To increase client sales</div>
                           </div>
                        </div>
                        <div class="col-auto mt-3">
                           <div class="row align-items-center">
                              ...
                              <div class="col-auto fs-16 text-theme1 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme1 border-3 border-bottom border-theme1 border-3 d-flex align-items-center h-40px pe-4">For obtaining bigger returns</div>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <div class="container-fluid development_services py-5 position-relative">
               ...
               <div class="row">
                  <div class="col-12">
                     <div class="row mx-0 pb-4">
                        ...
                        <div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Why Choose IMG Global Infotech For The Best Digital Marketing <b>Services In Jaipur?</b></span></div>
                     </div>
                  </div>
...
@push('scripts')
   ...
   <script src="{{asset('/public')}}/assets/js/digital-marketing-agency-in-jaipur.min.js"></script>
@endpush