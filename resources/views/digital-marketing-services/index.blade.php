            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item active">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12 fw-m text-white mb-1 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal tz text-center" style="--tz:30px;">Search Engine Optimization</div>
                     <div class="col-12 fw-l fs-lg-16 fs-md-15 fs-15 text-white mt-2 mb-3 tz text-center" style="--tz:30px;">Use the powerful search engine optimization techniques to increase the number of people visiting your site. At IMG Global Infotech, effective SEO strategies are employed to first improve search engine ranking and then ensure you maintain your position! It is one of the most cost-effective ways to increase your user base!</div>
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12 fw-m text-white mb-1 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal tz text-center" style="--tz:30px;">Social Media Optimization</div>
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12 fw-m text-white mb-1 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal tz text-center" style="--tz:30px;">PPC and Google Adwords Service</div>
                     <div class="col-12 fw-l fs-lg-16 fs-md-15  fs-sm-15 fs-14 text-white mt-2 mb-3 tz text-center" style="--tz:30px;">Pay per click and Google AdWords are online advertising tools. Using targeted keywords, PPC services and AdWords help you reach a specific audience who are more likely to give you business. The IMG Global Infotech PPC team works in individually or in tandem with SEO to drive both sales and results.</div>
                     <div class="col-12 pt-3">
            ...
            <div class="col-lg-4 col-md-6 col-12 d-flex align-items-stretch">
               <div class="to-access-item">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12 fw-m text-white mb-1 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal tz text-center" style="--tz:30px;">App Store Optimization</div>
                     <div class="col-12 fw-l fs-lg-16 fs-md-15  fs-sm-15 fs-14 text-white mt-2 mb-3 tz text-center" style="--tz:30px;">An app is a necessity for some businesses. Getting users to download it is a must for all! We know you want top ranking for your app. But we also know the technical input and creativity required to get you that ranking. IMG Global Infotech is the leading online marketing company to help you reach increase app download and engagement.</div>
                     <div class="col-12 pt-3">
   ...
   <div class="container-fluid overflow-hidden ecommerce_solutions position-relative py-5">
      <div class="container py-lg-4 position-relative zi-2">
         <div class="row mx-0 pb-5">
            ...
            <div class="col-12 fw-l fs-md-16 fs-15 text-muted mt-3 px-0">You need digital marketing services from a reputed company to survive the cut-throat competition. But, more importantly, you need a partner like IMG Global Infotech who knows the ins and outs of the digital world. It is constantly changing and forever growing.</div>
            <div class="col-12 fw-l fs-md-16 fs-15 text-muted mt-3 px-0">With us as the frontrunners of your campaign, you can expect us to bring you a robust presence.</div>
         </div>
         <div class="row">
            ...
            <div class="col-12 fw-l fs-md-16 fs-15 text-muted mt-3">Contact our digital marketing company to kick-off a robust campaign!</div>
            <div class="col-12 pt-3">
               <a href="{{asset('/request-a-quote.php')}}" class="btn btn-theme3 fs-14 fw-m hero_read_more_btn py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
