...
@push('meta')
   <!--  Title -->
   <title> Healthcare App Development Company, Healthcare App Developers</title>

   <!-- Required meta tags --> 
   <meta name="title" content="Healthcare App Development Company, Healthcare App Developers" />
   <meta name="description" content="IMG is a leading healthcare app development company. Our experienced team of healthcare app developers can create cost-effective mHealth solutions that meet your specific needs." />
   {{-- <meta name="keywords" content="android application development, android app development company, android app development services" /> --}}

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Healthcare App Development Company, Healthcare App Developers">
   <meta name="twitter:description" content="IMG is a leading healthcare app development company. Our experienced team of healthcare app developers can create cost-effective mHealth solutions that meet your specific needs.">
   <meta name="twitter:image" content="{{GETFOLDERPATH()}}/health-care-app-slider.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/healthcare-app-development.php')}}">
   <meta property="og:title" content="Healthcare App Development Company, Healthcare App Developers">
   <meta property="og:description" content="IMG is a leading healthcare app development company. Our experienced team of healthcare app developers can create cost-effective mHealth solutions that meet your specific needs.">
   <meta property="og:image" content="{{GETFOLDERPATH()}}/health-care-app-slider.webp">
   <meta property="og:image:secure_url" content="{{GETFOLDERPATH()}}/health-care-app-slider.webp">


   
   <meta name="classification" content="android application development, android app development company, android app development services" />
...
@push('styles')
   ...
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/healthcare-app-development-company.min.css">
@endpush
@section('content')
{{-- Hero Section --}}
@section('hero_hiddenHeading')
Top Rated Healthcare App Development Company
@endsection('hero_hiddenHeading')
@section('hero_heading')
<span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Top Rated Healthcare  <b> App Development Company</b></span>
@endsection('hero_heading')
@section('hero_tagline')
Being a dependable custom healthcare software development company, IMG Global Infotech, we offer advanced healthcare mobile app services to hospitals, clinics and other organisations to ease their work. Our solution streamlines the process and reduces the effort.
...
@endsection('hero_btn')
@section('hero_img')
<img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/health-care-app-slider.webp" alt="health care app slider">
@endsection('hero_img')
@include('inner-page-section.hero.index')



    <!-- Start Cost-effective Grocery Deliver section -->
   <div class="container-fluid overflow-hidden services-coman bg-white position-relative">
               ...
               <div class="row align-items-center">
                 <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative">
                           <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/health-care-app-development-company.webp" alt="health care app development company">
                        </div>
                     </div>
                  </div>
                 <div class="col-lg-7">
                           ...
                           <div class="row mx-0 pt-lg-0">
                                 ...
                                 <div class="row mx-0">
                                    <div class="col-12 heading fs-md-14 fs-12 left text-dark">
                                       <h2 class="d-none invisible">Top Rated Healthcare App Development</h2>
                                       <h3 class="d-none invisible">Cost Effective mHealth app development</h3>
                                       <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Cost Effective mHealth <b> app development </b></span></div>
                                 </div>
                              </div>
                            </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">In today's digital world, top-notch app development services have become essential to people's lives, and businesses are looking for ways to reach their customers through mobile apps. If you want to increase your business revenue, it's important to adapt to this trend. Hiring a remote app developer from a mobile app development agency can be a great way to accomplish this. At IMG Global Infotech, we offer flexible hiring options, allowing you to hire a mobile developer for the duration of your project, whether it's for days, weeks, or months. You can choose to hire our developers on a full-time, part-time, or hourly basis to meet your project needs.</div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">We specialize in developing cutting-edge digital solutions that connect patients in a safe and convenient manner. Our medical app developers have extensive experience in healthcare web application development and healthcare mobile application development, allowing us to integrate new digital solutions into your healthcare strategy seamlessly. We bring unique capabilities to the table, leveraging our rich healthcare domain knowledge:</div>
                        <div class="col-12">
                           <ul class="row fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">
                              <li class="col-12">Strong mobile UX expertise,</li>
                              <li class="col-12">Expertise in regulatory standards and compliance</li>
                              <li class="col-12">Meets all data security and privacy requirements.</li>
                           </ul>
                        </div>
                     </div>
                     <div class="col-12 pt-3 text-lg-start text-md-center text-center mt-md-1">
                           <a href="#formScroll" class="btn btn-theme3 text-white fs-xxl-13 fs-11 fw-m py-xxl-2 py-1 px-lg-4 px-3 mb-xl-0 mb-3">
                  ...
                  <!-- features mobile app services -->
                  <div class="container-fluid features_mobile_apppp position-relative">
                     <div class="container py-5 zi-2 position-relative">
                        <div class="row mx-0 pb-5">
                           <h3 class="d-none invisible">Why Do You Need a Healthcare App For Your Business</h3>
                           <div class="col-12 heading fs-md-14 fs-12 text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Why Do You Need a Healthcare <b> App For Your Business </b></span></div>
                           <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white text-center mt-3">A healthcare app can offer numerous benefits to your business, including</div>
                        </div>
                        <div class="row develop-boxes justify-content-center">
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                                    <i class="imgd img-procedures"></i>
                                 </span>
                                 
                                 <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Increased Patient Engagement</div>
                                 <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3">A healthcare app allows you to engage with your patients more effectively, by offering features like appointment scheduling, medication reminders, and personalized health tips.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                                    <i class="imgd img-clinic-medical"></i>
                                 </span>
                                 
                                 <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Improved Patient Outcomes</div>
                                 <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3">With a healthcare app, patients can access their health information and track their progress, leading to improved outcomes and better health management.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                                    <i class="imgd img-cogs"></i>
                                 </span>
                                 
                                 <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Streamlined Processes</div>
                                 <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3">A healthcare app can help streamline processes like appointment scheduling, prescription management, and billing, reducing administrative burden and improving efficiency.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                                    <i class="imgd img-chart-line"></i>
                                 </span>
                                 
                                 <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Increased Revenue</div>
                                 <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3">By offering additional services like telemedicine consultations and online medication management, healthcare apps can increase your revenue and expand your customer base.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                                    <i class="imgd img-chart-bar"></i>
                                 </span>
                                 
                                 <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Competitive Advantage</div>
                                 <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3">In today's digital age, having a healthcare app can give you a competitive advantage over other healthcare providers by offering a more modern and convenient way of accessing healthcare services.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                                    <i class="imgd img-copyright"></i>
                                 </span>
                                 
                                 <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Enhanced Brand Image</div>
                                 <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3">By offering a healthcare app, you can enhance your brand image and reputation by demonstrating your commitment to patient care and innovation in healthcare.</div>
                              </div>
                           </div>
                        </div>
                     </div>
   ...
   <div class="container-fluid features_mobile_app position-relative">
      <div class="container py-lg-5 py-md-5 py-4 zi-2 position-relative">
         <div class="row">
               <div class="row mx-0 pb-4">
                  <h3 class="d-none invisible">Features Include in Our Healthcare Mobile App</h3>
                  <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Features Include in  <b> Our Healthcare Mobile App </b></span></div>
               </div>
               </div>
        
               <div class="row develop-boxes mt-4">
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon01.webp" width="100" height="auto" alt="Online payment">
                           </span>
                        </div>
                        <div class="col">
                           
                           <div class="col-12 text-start fw-m text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Online payment</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-white mt-2">As a premier medical app development provider, we deliver top-notch payment gateway integration services. Users of the medical app can pay for doctor appointments using a variety of payment gateways.</div>
                        </div>
                     </div>
                  </div>

                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon02.webp" width="100" height="auto" alt="Insights & Analytics">
                           </span>
                        </div>
                        <div class="col">
                           
                           <div class="col-12 text-start fw-m text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Insights & Analytics</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-dark mt-2">To track the patient's health, we make sure to include this feature in our mobile healthcare software development services. It is useful to anticipate health difficulties based on the data that has been collected and to treat and diagnose diseases as soon as possible.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon03.webp" width="100" height="auto" alt="Online Chat">
                           </span>
                        </div>
                        <div class="col">
                           
                           <div class="col-12 text-start fw-m text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Online Chat</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-white mt-2">As a top healthcare app development firm, we include this function in healthcare applications to keep doctors and patients informed about forthcoming appointments or other pertinent medical information.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon04.webp" width="100" height="auto" alt="Online Appointment">
                           </span>
                        </div>
                        <div class="col">
                           
                           <div class="col-12 text-start fw-m text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Online Appointment</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Patients can search for the doctor and make an appointment online in the most practical manner. In order for the doctor to be ready before the patient arrives, it also collects any additional information about the patient.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon05.webp" width="100" height="auto" alt="Automatic Method">
                           </span>
                        </div>
                        <div class="col">
                           
                           <div class="col-12 text-start fw-m text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Automatic Method</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-white mt-2">To help health professionals better monitor patients and deliver services like better patient management, increased efficiency, quicker billing, and recovery of patient data, our mHealth app developers integrated this feature.</div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon06.webp" width="100" height="auto" alt="Integrating SMS and email">
                           </span>
                        </div>
                        <div class="col">
                           
                           <div class="col-12 text-start fw-m text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Integrating SMS and email</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Patients can answer via text that is automatically forwarded to a specific email address thanks to the integration of SMS and email. It is also helpful to let patients know about immunisations, appointments, and other things via these SMS and email services.</div>
                        </div>
                     </div>
                  </div>
                </div>
     ...
     <div class="image-layer"></div>
      <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
         <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
            <h3 class="d-none invisible">Evolving Healthcare App Solutions</h3>
            <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Evolving Healthcare App <b> Solutions </b></span></div>
            <div class="cpl-12 col-md-10 fw-l fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">Our app solution has a user-friendly interface and things that keep you on edge to schedule your appointment in no time.</div>
         </div>
            <div class="row d-flex align-items-center ">
                <div class="col-lg-8 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">  
                     <ul class="nav nav-tabs border-0">
                           <li class="nav-item">
                              <a class="nav-link active btn text-black fs-lg-19 fs-md-19 fs-13 fw-l my-3 py-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#home"> Patient App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-l my-3 py-2 mx-1 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu1">Doctors App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-l my-3 py-2 mx-1 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu2">Admin Panel</a>
                           </li>
                     </ul>
                </div>
                <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="tab-pane container active p-0" id="home">
                           <div class="row mt-lg-0 mt-md-0 mt-3">
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">             
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/login1.webp" class="w-25" width="100" height="auto" alt="Profile"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Profile</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/search-ad.webp" class="w-20" width="100" height="auto" alt="Find a doctor"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Find a doctor</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/shedule-delivery.webp" class="w-25" width="100" height="auto" alt="Book appointment"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Book appointment</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/sms-notification.webp" class="w-25" width="100" height="auto" alt="Audio/video chat services"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Audio/video chat services</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Medical history"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Medical history</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/promo.webp" class="w-25" width="100" height="auto" alt="In App payments"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">In-App payments</div>
                                          </div>
                                    </div>
                              </div>
                           </div>
                         ...
                         <div class="row mt-lg-0 mt-md-0 mt-3">
                            <div class="col-lg-3 col-md-3 col-6 mb-3">          
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/track.webp" class="w-20" width="100" height="auto" alt="Appointment management"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Appointment management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/login1.webp" class="w-25" width="100" height="auto" alt="Patient’s medical records"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Patient’s medical records</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Prescription"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Prescription</div>
                                          </div>
                                    </div>
                              </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">           
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-cart-process.webp" class="w-25" width="100" height="auto" alt="Analytics and transactions"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Analytics and transactions</div>
                                          </div>
                                    </div>
                              </div>
                           </div>
                     ...
                     <div class="tab-pane container fade p-0" id="menu2">
                           <div class="row mt-lg-0 mt-md-0 mt-3">
                            <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/login1.webp" class="w-25" width="100" height="auto" alt="Dashboard"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Dashboard</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/order-traking.webp" class="w-20" width="100" height="auto" alt="Appointments management"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Appointments management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-wishlist.webp" class="w-25" width="100" height="auto" alt="Doctor management"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Doctor management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                  
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/social-login.webp" class="w-25" width="100" height="auto" alt="Clinic administration"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Clinic administration</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">               
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/promo.webp" class="w-25" width="100" height="auto" alt="Payout administration"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Payout administration</div>
                                          </div>
                                    </div>
                              </div>
                           </div>
                 ...
                 <div class="container-fluid banner-cta1 py-lg-5 py-md-5 py-3 py-2 zi-2 position-relative mt-lg-5 mt-md-5 mt-5">
                   <div class="container">
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-12 col-md-12 col-12">
                           <h3 class="d-none invisible">Ready to Hire the Healthcare App Development Company</h3>
                           <div class="col-12 fw-m fs-md-33 fs-lg-33 fs-24 text-white fw-900 text-center mb-3"> Ready to Hire the Healthcare App Development Company</div>
                           <div class="col-12 fw-l fs-md-18 fs-lg-18 fs-16 text-white text-center">Partner with IMG Global Infotech — the best healthcare app development company in India. Add new capabilities with technology-enabled healthcare solutions developed exclusively by our expert healthcare mobile app developers.</div>
                        </div>
                           <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-center py-3">
                              <a href="#formScroll" class="btn expert-btn fs-lg-15 fs-md-15 fs-14 fw-l py-3 px-md-4 px-4 bg-white">
                  ...
                  <div class="container py-md-5 py-4 position-relative ">
                     <div class="row">
                        <div class="row mx-0 mb-lg-4 mb-md-4 mb-3">
                           ...
                           <div class="col-12 heading fs-md-14 fs-12"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Our <b>Recent Work</b> </span></div>
                        </div>
                     </div>
                     <div class="row align-items-center justify-content-center owl-portfolio-slider owl-carousel mx-0">
                         ...
                         <div class="portfolioBox ">
                         <img src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp" class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1"
                             data-src="{{asset('/public')}}/assets/img/portfolio-section/EcoCosmo-Project.webp" alt="EcoCosmo Project">
                             <div class="portfolioBoxContent">
                         ...
                         <div class="portfolioBox">
                             <img src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp" class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1"
                                 data-src="{{asset('/public')}}/assets/img/portfolio-section/destist-online.webp" alt="destist online">
                                 <div class="portfolioBoxContent">
               ...
               <div class="row align-content-center align-items-center position-relative">
                     <div class="col-lg-7 col-md-12">
                           <div class="row mx-0 pb-3">
                              <h3 class="d-none invisible">Why Is IMG Global Infotech The Best Company For Healthcare App Development?</h3>
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-33 fs-lg-29 fs-md-24 fs-20 text-dark"> Why Is IMG Global Infotech The Best Company For  <b> Healthcare App Development? </b></span></div>
                           </div>
                           <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-mute mb-4">   
                              The team of healthcare mobile app developers at IMG Global Infotech is equipped to offer reliable app solutions that precisely & successfully address the challenges facing your business. You can collaborate with us to work with online Android & iOS developers to build scalable and secure enterprise applications.
                        </div>
                           <div>
                              <div class="row">
            ...
            <div class="accordion" id="accordionExample2">
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="headingOne1">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">
                           What is the difference between medical and healthcare app development?
                        </button>
                     </div>
                     <div id="collapseOne1" class="position-relative accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#accordionExample2">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           Medical apps are software integrated on a mobile device used by the app users to regulate medical devices. While, healthcare apps offer health-related services to the patients.
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="aheadingTwo2">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo2">
                           What are the best use cases of healthcare app development?
                        </button>
                     </div>
                     <div id="collapseTwo2" class="position-relative accordion-collapse collapse" aria-labelledby="aheadingTwo2" data-bs-parent="#accordionExample2">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           Some of the top-notch use cases of healthcare app development are electronic health records, diagnostic systems, e-prescribing, medical billing, and more!
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="acollapseThree3">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3">
                           What are the most integrated features used for healthcare app development by healthcare app development companies?
                        </button>
                     </div>

                     <div id="collapseThree3" class="position-relative accordion-collapse collapse" aria-labelledby="acollapseThree3" data-bs-parent="#accordionExample2">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           Some of the primary features leveraged by healthcare app development company are profile, appointment management, patient’s medical records, prescription, etc.
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="aheadingfour4">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour4" aria-expanded="false" aria-controls="collapsefour4">
                           Which is the best healthcare app developed by you?
                        </button>
                     </div>
                     <div id="collapsefour4" class="position-relative accordion-collapse collapse" aria-labelledby="aheadingfour4" data-bs-parent="#accordionExample2">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           <div class="col-12">
                              One of the best healthcare apps developed by IMG Global Infotech- a leading healthcare app development company is TheaCare to cater to the women’s healthcare needs.
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="aheadingfive5">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive5" aria-expanded="false" aria-controls="collapsefive5">
                           What does a top-notch healthcare app development company cost for efficient app development?
                        </button>
                     </div>
                     <div id="collapsefive5" class="position-relative accordion-collapse collapse" aria-labelledby="aheadingfive5" data-bs-parent="#accordionExample2">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           <div class="col-12">
                              Any terrific healthcare app development company would emphasize clients’ preferences and add their two cents to nourish the idea. Moreover, app development cost varies depending on numerous factors, and the total cost of app development may lie between 30k-160k USD.
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="aheadingsix6">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsesix6" aria-expanded="false" aria-controls="collapsesix6">
                           Why consult a healthcare app development company?
                        </button>
                     </div>
                     <div id="collapsesix6" class="position-relative accordion-collapse collapse" aria-labelledby="aheadingsix6" data-bs-parent="#accordionExample2">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           <div class="col-12">
                              An efficient healthcare app development company can help app owners build an app that offers a frictionless experience to their customers. A few other advantages are:
                           </div>
                           <div class="col-12">
                              <ul>
                                 <li>Boosts health monitoring</li>
   ...
   <div class="container-fluid on_demand position-relative pt-md-2 pt-2">
      <div class="container py-lg-4 py-2 zi-2 position-relatbive p-0">
         <div class="row mx-0">
            <div class="col-12 heading fs-md-14 fs-12 center text-dark">
               <h3 class="d-none invisible">Other On-Demand Services</h3>
               <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Other On-Demand <b> Services</b></span>
            </div>
            <div class="col-lg-10 col-md-10 col-12 mt-2 fw-m fs-lg-16 fs-md-16 fs-sm-17 fs-16 mx-auto p-0 text-center">Showcase of Finest of the Mobile Apps developed by IMG Global Infotech...</div>
         </div>
         <div class="row py-lg-4 py-3 items fantasy-cricket-sldier owl-carousel">
               ...
               <div class="box h-100 flex-column d-flex px-lg-3 px-md-3 px-3 py-lg-4 py-md-4 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/grocery-app-development.png" class="w-lg-80 w-md-50 w-50" alt="Grocery App Development">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1 text-white">Grocery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal text-white">At IMG, we aim to provide high-quality online grocery app development services.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/grocery-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white">
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/jewellery-app-development.png" class="w-lg-75 w-md-50 w-50" alt="Jewellery App Development">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">Jewellery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-17 fs-md-15 flex-fill fs-15 lh-normal  text-white">Get a custom jewellery mobile app/website for easy jewellery shopping.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/jewellery-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4" >
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/food-delivery-app-development.png" class="w-lg-75 w-md-50 w-50" alt="Food Delivery App Development">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1 text-white">Food Delivery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal text-white">IMG is the best Food delivery app development company holding years of experience serving</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/food-delivery-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 text-dark bg-white">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
           ...
           {{--  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                        <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/health-care-app-development.png" class="w-lg-75 w-md-50 w-50" alt="Healthcare App Development">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">Healthcare App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">Delivering world-class healthcare application services to enhance medical care.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/healthcare-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white" >
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
           ...
           <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/pharmacy-app-development.png" class="w-lg-75 w-md-50 w-50" alt="Pharmacy App Development">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">Pharmacy App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">We are experts in mobile app development for pharmacy and pharma related business.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/pharmacy-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/doctor-app-development.png" class="w-lg-75 w-md-50 w-50" alt="Doctor On-Demand App">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">Doctor On-Demand App</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">IMG develops online doctor appointment applications for hospitals, clinics, and doctors.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/doctor-on-demand-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
               ...
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/fashion-app-developemt.png" class="w-lg-75 w-md-50 w-50" alt="Fashion App Development">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-19 fs-18 lh-normal fw-m mb-1  text-white">Fashion App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">Build an enterprise-grade app for your clothing store and take your business to new heights.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/fashion-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
   ...
   {{--
   <!-- Looking for Other Services? section -->
   <div class="container-fluid ecommerce_services overflow-hidden pb-md-100px padding-100px">
      <div class="container py-5 position-relative p-0">
         <div class="row mx-0 pb-2">
            ...
            <h3 class="d-none invisible">Looking for Other Services?</h3>
               <div class="col-12 fs-xl-35 fs-lg-35 fs-md-24 fs-25 text-center text-white fw-l p-0"> Looking for Other Services?</div>
               <div class="col-12 fw-m fs-md-18 fs-lg-18 fs-18 text-white text-md-center text-center py-lg-2 py-md-2 py-2">Explore our other related services to enhance the performance of your digital product.</div>
         </div>
      </div>
    </div>

       <div class="container pb-md-0 position-relative top-n50px">  
              <div class="col-lg-12 col-sm-12 col-md-12 rounded-4 ">      
                <div class="row fantasy-cricket-sldier owl-carousel ">
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4 ">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico  rounded mb-2 text-center">
                           <img class="w-lg-20 w-md-20 w-30 mx-auto " src="{{GETFOLDERPATH()}}/cakephp.webp" alt="Food Delivery App Development" div>
                          
                        <div class="col-12 fw-900 text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Food Delivery App <br>Development</div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                           <img src="{{GETFOLDERPATH()}}/process.webp" alt="Medicine App Development" class="mx-auto w-lg-20 w-md-20 w-30"></div>
                          
                        <div class="col-12 fw-900 text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Medicine App  <br>Development</div>
                     </div>
                  </div>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                           <img src="{{GETFOLDERPATH()}}/website.webp" alt="Healthcare App Development" class="mx-auto w-lg-20 w-md-20 w-30"></div>
                          
                        <div class="col-12 fw-900 text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Healthcare App <br>Development</div>
                     </div>
                  </div>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                           <img src="{{GETFOLDERPATH()}}/ecome.webp" alt="Clothing  App Development" class="mx-auto w-lg-20 w-md-20 w-30"></div>
                          
                        <div class="col-12 fw-900 text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Clothing  App <br>Development</div>
                     </div>
                  </div>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                           <img src="{{GETFOLDERPATH()}}/b2b.webp" alt="Jewellery App Development" class="mx-auto w-lg-20 w-md-20 w-30"></div>
                          
                        <div class="col-12 fw-900 text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Jewellery App<br>Development</div>
                     </div>
                  </div>
...
<script src="{{asset('/public')}}/assets/js/healthcare-app-development-company.min.js"></script>
