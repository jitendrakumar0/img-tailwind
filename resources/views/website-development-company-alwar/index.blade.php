...
@push('meta')
   <!--  Title -->
   <title>Web Development Company in Alwar, Digital Marketing Company in Alwar</title>

   <!-- Required meta tags -->
   <meta name="title" content="Web Development Company in Alwar, Digital Marketing Company in Alwar" />
   <meta name="description" content="IMG Global Infotech is a complete Website Development Company in Alwar, which offers Website Designing and Development, Mobile Application Development, Ecommerce Development and Digital Marketing Services in more than 10 countries." />
   <meta name="keywords" content="Website Development Alwar, Web Development Alwar, Website Development Company Alwar, Website Designing Alwar, Best Website Development Company Alwar, Website Development Solution Alwar, Website Designing Company Alwar, Web Development Services Alwar, Software Development Company Alwar Software Development Services Alwar, Mobile Application Development Alwar,, Digital Marketing Services Alwar, Digital Marketing Company Alwar, SEO Services Alwar, Graphic Design Services Alwar" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Web Development Company in Alwar, Digital Marketing Company in Alwar">
   <meta name="twitter:description" content="IMG Global Infotech is a complete Website Development Company in Alwar, which offers Website Designing and Development, Mobile Application Development, Ecommerce Development and Digital Marketing Services in more than 10 countries.">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/website-development-company-alwar/web-app-development.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}website-development-company-alwar.php">
   <meta property="og:title" content="Web Development Company in Alwar, Digital Marketing Company in Alwar">
   <meta property="og:description" content="IMG Global Infotech is a complete Website Development Company in Alwar, which offers Website Designing and Development, Mobile Application Development, Ecommerce Development and Digital Marketing Services in more than 10 countries.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/website-development-company-alwar/web-app-development.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/website-development-company-alwar/web-app-development.webp">



   <meta name="classification" content="Website Development Alwar, Web Development Alwar, Website Development Company Alwar, Website Designing Alwar, Best Website Development Company Alwar, Website Development Solution Alwar, Website Designing Company Alwar, Web Development Services Alwar, Software Development Company Alwar Software Development Services Alwar, Mobile Application Development Alwar,, Digital Marketing Services Alwar, Digital Marketing Company Alwar, SEO Services Alwar, Graphic Design Services Alwar" />
   <link rel="canonical" href="{{asset('/')}}website-development-company-alwar.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/website-development-company-alwar.min.css">
...
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Web App Development</h1>
                              <div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Website <b> Development Company In Alwar</b></span>
                              </div>
                           </div>
                        </div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white mb-3 mt-3">Our experts deliver edge cutting development services to meet your end to end requirement of your project. Transparent and cost-effective web development services.</div>
                        ...
                        <a href="tel:+91-9694097245" class="btn btn-theme3 text-white fs-14 fw-bold my-3 py-2 px-4">
                           ...
                           <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-theme1 text-white fs-14 fw-bold my-3 py-2 px-4 ms-md-2">
                              <span class="d-block"><span>Enquiry Now</span><i class="imgr ms-2 img-laptop position-relative bottom-n2px"></i></span>
                           </a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/web-app-development2.webp" alt="Web App Development">
                           <img class="w-100 position-absolute top-0 start-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{GETFOLDERPATH()}}/12.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="row mx-0 pb-4">
                  <h2 class="d-none invisible"></h2>
                  <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Our <b> Services </b></span></div>
               </div>
            </div>
            <div class="col-lg-12">
               <div class="row develop-boxes">
                  <div class="col-lg-4 col-md-4 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-50px" src="{{GETFOLDERPATH()}}/mobile-app-icon.webp" alt="Mobile app Development">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Mobile app Development</h3>
                           <div class="col-12">
                               <a class="text-decoration-none" href="{{asset('/mobile-app-development.php')}}">
                                   <div class="row">
                                       <div class="col-12  text-start fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Mobile app Development</div>
                                       <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-muted mt-2">One of the leading companies delivering best-in-class iOS and Android application services. Our methodology is to use advanced technology to build seamless applications.</div>
                                   </div>
                               </a>
                           </div>
                           <div class="hotLinks">
                               <ul class="d-flex list-unstyled p-0">
                                   <li>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-14 fs-14 fw-bold" href="{{asset('/android-application-development.php')}}">Android</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-14 fs-14 fw-bold" href="{{asset('/ios-app-development.php')}}">iPhone</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-14 fs-14 fw-bold" href="{{asset('/flutter-app-development.php')}}">Flutter</a>
                                    </li>
                               </ul>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-4 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-50px" src="{{GETFOLDERPATH()}}/website-design-icon.webp" alt="Website Designing">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Website Designing</h3>
                           <div class="col-12">
                                <a class="text-decoration-none" href="{{asset('/website-design.php')}}">
                                <div class="row">
                                    <div class="col-12 text-start fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Website Designing</div>
                                    <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-muted mt-2">Delivering customised and highly responsive website services with a wide range of solutions. Building innovative design with a personalised touch of your business.</div>
                                </div>
                                </a>    
                           </div>
                           
                           <div class="hotLinks">
                               <ul class="text-start list-unstyled p-0">
                                   <li class="m-0">
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/ui-ux-design-services.php')}}">UI/UX</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/website-redesigning.php')}}">Redesign</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/responsive-web-designing.php')}}">Responsive</a>
                                    </li>
                                    <li class="m-0">
                                        <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/psd-to-html-conversion.php')}}">PSD to HTML</a>
                                    </li>
                               </ul>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-4 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-50px" src="{{GETFOLDERPATH()}}/web-development-icons.webp" alt="Web Development">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Web Development</h3>
                           <div class="col-12">
                               <a class="text-decoration-none" href="{{asset('/web-development.php')}}">
                                   <div class="row">
                                        <div class="col-12 text-start fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Web Development</div>
                                        <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-muted mt-2">Served millions of small and medium sized businesses with scalable and customised  web development services. We have emphasis on building user engaging services.</div>
                                   </div>
                               </a>
                           </div>
                           <div class="hotLinks">
                               <ul class="text-start list-unstyled p-0">
                                   <li class="m-0">
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/ecommerce-website-development.php')}}">Ecommerce</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/cms-development.php')}}">CMS</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/web-portal-development.php')}}">Web Portal</a>
                                     </li>
                                    <li class="m-0">
                                        <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/api-development.php')}}">API</a>
                                       <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                       <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/web-app-development.php')}}">Web App Development</a>
                                   </li>
                               </ul>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-4 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-50px" src="{{GETFOLDERPATH()}}/e-commerce-icon.webp" alt="Ecommerce Development">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Ecommerce Development</h3>
                           <div class="col-12">
                               <a class="text-decoration-none" href="{{asset('/ecommerce-website-development.php')}}">
                                   <div class="row">
                                       <div class="col-12 text-start fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Ecommerce Development</div>
                                        <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-muted mt-2"> Assisting in setting up ecommerce and mcommerce business for our clients by delivering high quality services. Building a complex ecommerce project with top-notch service.</div>
                                   </div>
                               </a>
                           </div>
                           <!-- <div class="hotLinks">
                               <ul class="text-start list-unstyled p-0">
                                   <li class="m-0">
                                    <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/')}}"></a>
                                    <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                    <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/')}}"></a>
                                    <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                    <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/')}}"></a>
                  ...
                  <div class="col-lg-4 col-md-4 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-50px" src="{{GETFOLDERPATH()}}/digital-marketing-icon.webp" alt="Digital Marketing">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Digital Marketing</h3>
                           <div class="col-12">
                               <a class="text-decoration-none" href="{{asset('/digital-marketing-services.php')}}">
                                   <div class="row">
                                       <div class="col-12 text-start fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Digital Marketing</div>
                                        <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-muted mt-2">Through our digital marketing services the ranking of your business and site increases. We thrive to win through internet marketing.</div> 
                                   </div>
                               </a>
                           </div>
                           <div class="hotLinks">
                               <ul class="text-start list-unstyled p-0">
                                   <li class="m-0">
                                        <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/seo-services.php')}}">SEO</a>
                                        <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                        <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/pay-per-click-services.php')}}">PPC</a>
                                        <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                        <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/social-media-marketing-services.php')}}">SMO</a>
                                        <span class="text-theme1 fs-15 mx-1 fw-bold">|</span>
                                        <a class="text-theme2 text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14 fw-bold" href="{{asset('/app-store-optimization-services.php')}}">ASO</a>
                                    </li>
                               </ul>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-4 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-50px" src="{{GETFOLDERPATH()}}/software-development-icon.webp" alt="Software Development">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Software Development</h3>
                           <div class="col-12">
                               <a class="text-decoration-none" href="{{asset('/software-development.php')}}">
                                   <div class="row">
                                        <div class="col-12 text-start fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Software Development</div>
                                        <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-muted mt-2">Our experts have a proven track record of delivering software solutions for your every need of business. We deliver top notch service with multiple technologies.</div>
                                    </div>
                               </a>
                           </div>
                        </div>
      ...
      <div class="container py-5 zi-2 position-relative">
         <div class="row mx-0 align-items-center">
            <div class="col-lg-auto col-12 text-start mb-lg-0 mb-md-4 mb-4">
               <img class="h-70px" src="{{GETFOLDERPATH()}}/call_join.webp" alt="Let's Work Together and Create Bigger Things  Converting your big idea into reality, assisting small and medium sized business to attain profitable business.">
            </div>
            <h2 class="d-none invisible">Let's Work Together and Create Bigger Things  Converting your big idea into reality, assisting small and medium sized business to attain profitable business.</h2>
            <div class="col heading fs-md-14 fs-12 left text-white"><span class="fs-xl-26 fs-lg-22 fs-md-20 fs-18">Let's Work Together and Create Bigger Things <b class="fs-20"> <br> Converting your big idea into reality, assisting small and medium sized business to attain profitable business. </b></span></div>
            <div class="col-lg-auto col-12 text-start mt-lg-0 mt-md-4 mt-4">
               <a  href="{{asset('contact-us.php')}}" class="btn btn-theme3 fs-md-14 fs-13 fw-bold py-2 px-md-4 px-3" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
   ...
   <div class="container-fluid overflow-hidden bg-white about_iphone position-relative">
               ...
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/website-designing-and-development-company-in-alwar.webp" alt="Website Designing and Development Company in Alwar">
                           <img class="w-100 position-absolute top-0 start-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{GETFOLDERPATH()}}/12.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7 col-md-12 mt-lg-0 mt-md-5 mt-5">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Website Designing and Development Company in Alwar</h2>
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Leading Website Designing And Web
                                 <b> Development Company in Alwar</b></span>
                              </div>
                           </div>
                        </div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 text-lg-start text-md-center text-center fs-14 text-muted mt-md-3 mt-0 justify">Being a dynamic company possessing a vision of delivering best quality web development services to numerous clients. We deliver reliable solutions and fully responsive website design to enhance user experience.</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 text-lg-start text-md-center text-center fs-14 text-muted mt-3 justify">We work with the motto of providing affordable website services and giving top functionality. Our experts possess required skills to deliver your project on time and within budget. They work lambasting in solving problems going extra miles to deliver required results.</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 text-lg-start text-md-center text-center fs-14 text-muted mt-3 justify">Offering best solutions to deliver maximised satisfaction and we wish to build long term collaboration with our clients. We believe in -depth research that will transform your solution to the next level containing rich features with innovative UI elements. </div>
                     </div>
                     <div class="col-12 fw-600 fs-lg-16 fs-md-15 text-lg-start text-md-center text-center fs-14 text-muted justify">We are committed to deliver most customised and scalable solutions and we never compromise with the solution performance. </div>
                  </div>
               </div>
            </div>
         </div>
    ...
    <div class="container-fluid achievements position-relative overflow-hidden">
                    ...
                    <div class="row align-items-start">
                        <div class="col-xl-7 position-relative h-100">
                            <div class="row">
                                ...
                                <div class="col-12 mx-md-3 mx-3 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Our <b> Achievements</b></span></div>
                                <div class="col-12 fs-md-16 fs-sm-15 fs-14 text-white py-4 text-md-start text-center">Being successful in the business since 2014, we hold a proven track record of quality workmanship, functional and beautiful screen design, value pricing, and rapid delivery through various IT outsourcing services.</div>
                                <div class="col-12 ps-0">
                                    <div class="row">
                                        <div class="col-sm-3 col-6 py-sm-0 py-4">
                                            <div class="row">
                                                <div class="col-12 text-xl-start text-center mb-3">
                                                    <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/documents.webp" class="h-xxl-60px h-50px" alt="Successful Projects">
                                                </div>
                                                <h3 class="d-none invisible">Successful Projects</h3>
                                                <div class="col-12 text-xl-start text-center fs-xl-40 fs-md-30 fs-sm-25 fs-20 text-white fw-900">1200 <span class="ms-n1 fw-600 text-theme2">+</span></div>
                                                <div class="col-12 text-xl-start text-center text-white fw-600 fs-xl-15 fs-md-14 fs-13">Successful Projects</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 col-6 py-sm-0 py-4">
                                            <div class="row">
                                                <div class="col-12 text-xl-start text-center mb-3">
                                                    <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/trophy.webp" class="h-xxl-60px h-50px" alt="Success Ratio">
                                                </div>
                                                <h3 class="d-none invisible">Success Ratio</h3>
                                                <div class="col-12 text-xl-start text-center fs-xl-40 fs-md-30 fs-sm-25 fs-20 text-white fw-900">98 <span class="ms-n1 fw-600 text-theme2 fs-22">%</span></div>
                                                <div class="col-12 text-xl-start text-center text-white fw-600 fs-xl-15 fs-md-14 fs-13">Success Ratio</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 col-6 py-sm-0 py-4">
                                            <div class="row">
                                                <div class="col-12 text-xl-start text-center mb-3">
                                                    <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/omnichannel-merchandising.webp" class="h-xxl-60px h-50px" alt="Team Members">
                                                </div>
                                                <h3 class="d-none invisible">Team Members</h3>
                                                <div class="col-12 text-xl-start text-center fs-xl-40 fs-md-30 fs-sm-25 fs-20 text-white fw-900">100 <span class="ms-n1 fw-600 text-theme2">+</span></div>
                                                <div class="col-12 text-xl-start text-center text-white fw-600 fs-xl-15 fs-md-14 fs-13">Team Members</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 col-6 py-sm-0 py-4">
                                            <div class="row">
                                                <div class="col-12 text-xl-start text-center mb-3">
                                                    <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/gear.webp" class="h-xxl-60px h-50px" alt="Years in Industry">
                                                </div>
                                                <h3 class="d-none invisible">Years in Industry</h3>
                                                <div class="col-12 text-xl-start text-center fs-xl-40 fs-md-30 fs-sm-25 fs-20 text-white fw-900">8 <span class="ms-n1 fw-600 text-theme2">+</span></div>
                                                <div class="col-12 text-xl-start text-center text-white fw-600 fs-xl-15 fs-md-14 fs-13">Years in Industry</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-5 position-relative align-self-end pt-xl-0 pt-5">
                            <div class="sparater-block d-xl-block d-none">
                                <span class="fw-900 invisible"></span>
                            </div>
                            <div class="row ms-xl-4 ms-n2 me-n2">
                                <div class="col-xl-4 col-md col-sm-4 col-6 px-1">
                                    <a href="#" class="w-100 text-center py-4 d-block">
                                        <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/certified1.webp" class="h-lg-100px h-md-80px h-80px" alt="certified1">
                                    </a>
                                </div>
                                <div class="col-xl-4 col-md col-sm-4 col-6 px-1">
                                    <a href="#" class="w-100 text-center py-4 d-block">
                                        <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/certified2.webp" class="h-lg-100px h-md-80px h-80px" alt="certified2">
                                    </a>
                                </div>
                                <div class="col-xl-4 col-md col-sm-4 col-6 px-1">
                                    <a href="#" class="w-100 text-center py-4 d-block">
                                        <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/certified3.webp" class="h-lg-100px h-md-80px h-80px" alt="certified3">
                                    </a>
                                </div>
                                <div class="col-xl-4 col-md col-sm-4 col-6 px-1">
                                    <a href="#" class="w-100 text-center py-4 d-block">
                                        <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/certified-payu-partner.webp" class="h-lg-100px h-md-80px h-80px" alt="certified-payu-partner">
                                    </a>
                                </div>
                                <div class="col-xl-4 col-md col-sm-4 col-6 px-1">
                                    <a href="#" class="w-100 text-center py-4 d-block">
                                        <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/certified4.webp" class="h-lg-100px h-md-80px h-80px" alt="certified4">
                                    </a>
                                </div>
                                <div class="col-xl-4 col-md col-sm-4 col-6 px-1">
                                    <a href="#" class="w-100 text-center py-4 d-block">
                                        <img src="{{asset('/public')}}/assets/img/website-development-company-alwar/achievements/certified5.webp" class="h-lg-100px h-md-80px h-80px" alt="certified5">
                                    </a>
                                </div>
                            </div>
                        </div>
      ...
      <!-- fifth section start -->
      <div class="container-fluid overflow-hidden web-design-services-section-5 position-relative py-5" style="--bg:url({{asset('/public')}}/assets/img/website-design/hero.webp);">
         <div class="container">
            <div class="row mx-0 pb-5">
               <h2 class="d-none invisible">We Serve All Industries</h2>
               <div class="col-12 heading fs-md-14 fs-12 text-white center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> We Serve <b> All Industries </b></span></div>
            </div>
            <div class="row">
               <div class="col-12 col-md-4">
                  <ul class="fw-600 fs-16 text-white list-unstyled text-capitalize">
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>News Website Development</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>B2B Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Beauty and Fashion</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>E-Commerce</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Entertainment & Media</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Financial Industry</span></li>
                  </ul>
               </div>
               <div class="col-12 col-md-4">
                  <ul class="fw-600 fs-16 text-white list-unstyled text-capitalize">
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Food & Beverage Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Government Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Manpower Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Medical & Healthcare</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Non-Profit</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Blog Website</span></li>
                  </ul>
               </div>
               <div class="col-12 col-md-4">
                  <ul class="fw-600 fs-16 text-white list-unstyled text-capitalize">
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Real Estate Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Schools and Institutions</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Small Business</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Sports</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Technology Services</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-danger me-2"></i></span><span>Tours & Travels</span></li>
                  </ul>
               </div>
            </div>
         </div>
         ...
         <div class="row align-items-center border border-5 rounded p-3 border-white">
            <div class="col-lg-6">
               <div class="row align-items-center">
                  ...
                  <div class="col heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Get Appointment with <b>Our Experts </b></span></div>
               </div>
               <div class="row">
                  <div class="col-lg-10 col-12 text-light px-0 fs-17 fw-600 mt-3">Let's work towards building a user friendly and interactive UI Website. </div>
               </div>
               <div class="row">
                  <div class="col-lg-10 col-12 text-light px-0 fs-17 fw-600 mt-3">We assist to build a robust website design using a convenient website developing strategy to fulfil our customer’s needs and wants.  </div>
               </div>
            </div>
                  ...
                  <div class="col-md-7">
                         <div class="row">
                                 <div class="col-5 pe-0">
                                          <select class="form-select rounded-0 brl h-59px" aria-label="Default select example" style="padding: 0.375rem 0.25rem 0.375rem 0.75rem !important; border-left: 4px solid #e09c19;">
                           ...
                           <div class="col-md-7">
                                 <div class="form-floating">
                                       <select name="requirement" required="" class="form-control rounded-0 pt-2 fw-400">
                                          ...
                                          <option value="Website Design"  selected="selected">Website Design</option>
                              ...
                              <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-4 pe-0">
                                            <select class="form-select rounded-0 fw-400 h-59px" name="phonecode" id="phonecode" aria-label="Default select example" style="padding: 0.375rem 0.25rem 0.375rem 0.75rem !important;">
...
<script src="{{asset('/public')}}/assets/js/website-development-company-alwar.min.js"></script>
