...
@push('meta')
   <!--  Title -->
   <title>Android App Development Company in India, Hire Android Developers</title>
   ...
   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}android-application-development.php">
   ...
   <link rel="canonical" href="{{asset('/')}}android-application-development.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/android-application-development.min.css">
@endpush
@section('content')
{{-- Hero Section --}}
...
<span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Android App <b> Development Company</b></span>
@endsection('hero_heading')
@section('hero_tagline')
Our global clientele showcases quality in developing advanced and scalable Android apps. We plan, create, and implement the best android applications using the latest technologies and deliver robust user experience you will ever come across.
...
<img src="{{asset('/public')}}/assets/img/android-application-development/custom-shape.webp" class="lazy-image w-100" data-src="{{asset('/public')}}/assets/img/android-application-development/android-app-development-company.webp"alt="android-app-development-company" width="100" height="auto">
@endsection('hero_img')
@include('inner-page-section.hero.index')
   ...
   <div class="container-fluid achievements position-relative overflow-hidden">
               ...
               <div class="row">
                  <div class="col-lg-6 col-md-12 position-relative mb-lg-0 mb-md-4 mb-4">
                     <div class="row justify-content-md-start justify-content-center text-md-left text-center">
                        <h2 class="d-none invisible">Our Achievements</h2>
                        <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Our <b> Achievements</b></span></div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-dark pt-4 ps-md-0 text-md-start text-center">Being successful in the business since 2014, we hold a proven track record of quality workmanship, functional and beautiful screen design, value pricing, and rapid delivery through various IT outsourcing services.</div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12 position-relative align-self-end mt-lg-0 mt-md-4 mt-0">
                     <div class="row">
                        <div class="col-12 ps-0">
                           <div class="row">
                              <div class="col-md-3 col-6 my-md-0 my-4 text-lg-start text-md-center text-center">
                                 <div class="row text-md-left text-center">
                                    <div class="col-12 mb-3">
                                       <img src="{{GETFOLDERPATH()}}/documents.webp" width="auto" height="auto" class=" h-60px" alt="Successful Projects">
                                    </div>
                                    <div class="col-12 fs-xxl-34 fs-xl-34 fs-lg-30 fs-md-26 fs-24 text-theme1 fw-900">1200 <span class="ms-n1 fw-600 text-theme2">+</span></div>
                                    <h3 class="d-none invisible">Successful Projects</h3>
                                    <div class="col-12 text-dark fw-600 fs-xxl-14 fs-xl-14 fs-lg-13 fs-md-14 fs-14">Successful Projects</div>
                                 </div>
                              </div>
                              <div class="col-md-3 col-6 my-md-0 my-4 text-lg-start text-md-center text-center">
                                 <div class="row text-md-left text-center">
                                    <div class="col-12 mb-3">
                                       <img src="{{GETFOLDERPATH()}}/omnichannel-merchandising.webp" width="auto" height="auto" class=" h-60px" alt="Happy Customers">
                                    </div>
                                    <div class="col-12 fs-xxl-34 fs-xl-34 fs-lg-30 fs-md-26 fs-24 text-theme1 fw-900">800 <span class="ms-n1 fw-600 text-theme2">+</span></div>
                                    <h3 class="d-none invisible">Happy Customers</h3>
                                    <div class="col-12 text-dark fw-600 fs-xxl-14 fs-xl-14 fs-lg-13 fs-md-14 fs-14">Happy Customers</div>
                                 </div>
                              </div>
                              <div class="col-md-3 col-6 mt-md-0 mt-4 text-lg-start text-md-center text-center">
                                 <div class="row text-md-left text-center">
                                    <div class="col-12 mb-3">
                                       <img src="{{GETFOLDERPATH()}}/trophy.webp" class=" h-60px" alt="Success Ratio">
                                    </div>
                                    <div class="col-12 fs-xxl-34 fs-xl-34 fs-lg-30 fs-md-26 fs-24 text-theme1 fw-900">98 <span class="ms-n1 fw-600 text-theme2 fs-22">%</span></div>
                                    <h3 class="d-none invisible">Success Ratio</h3>
                                    <div class="col-12 text-dark fw-600 fs-xxl-14 fs-xl-14 fs-lg-13 fs-md-14 fs-14">Success Ratio</div>
                                 </div>
                              </div>
                              <div class="col-md-3 col-6 mt-md-0 mt-4 text-lg-start text-md-center text-center">
                                 <div class="row text-md-left text-center">
                                    <div class="col-12 mb-3">
                                       <img src="{{GETFOLDERPATH()}}/gear.webp" width="auto" height="auto" class=" h-60px" alt="Industries Served">
                                    </div>
                                    <div class="col-12 fs-xxl-34 fs-xl-34 fs-lg-30 fs-md-26 fs-24 text-theme1 fw-900">210 <span class="ms-n1 fw-600 text-theme2">+</span></div>
                                    <h3 class="d-none invisible">Industries Served</h3>
                                    <div class="col-12 text-dark fw-600 fs-xxl-14 fs-xl-14 fs-lg-13 fs-md-14 fs-14">Industries Served</div>
                                 </div>
                              </div>
                           </div>
                        </div>
   ...
   <div class="container-fluid overflow-hidden transform_vision position-relative">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                              <img src="{{asset('/public')}}/assets/img/android-application-development/custom-shape.webp" class="lazy-image w-100" data-src="{{asset('/public')}}/assets/img/android-application-development/android-app.webp"alt="Mobile App Development Company In Jaipur That Achieves Your Business Goal!" width="100" height="auto">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/7.webp" alt="">

                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7 mt-lg-0 mt-md-5 mt-5">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Transform your vision into a reality through our game-changing Android Apps</h2>
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Transform your vision into a reality through our <b>game-changing Android Apps</b></span></div>
                           </div>
                        </div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-14 text-muted mt-md-3 mt-0 justify">Did you know that Android is being used by 70% of smartphone users across the globe? Custom Android app development has become a mandatory requirement for every business to reach new heights. It’s the best moment to turn users into your customers. IMG Global Infotech is one of the leading Android app development companies that help to put your business in the forefront through our innovative android app development services.</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-14 text-muted mt-md-3 mt-0 justify">We have experienced and creative android developers who deliver end to end android apps for every type of companies from startups, mid-market companies, enterprise, and leading brands. Our android developers use the latest technologies and frameworks like Xemrin, Phonegap, Ionic, Flutter, and React Native to develop cross-platform and native based applications.</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-14 text-muted mt-md-3 mt-0 justify">Android, being open-source, offers free SDK (Software Development Kit) to the community of developers, which decreases the licensing and development cost. It means the app platform is readily available for customization and integration of Java Programming Language and other latest technological stacks for better business requirements and user experience.</div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-14 text-muted mt-3">We have creative android developers experienced in all top-notch programming languages like CSS, HTML, C, C++, Java, and Kotlin to develop secure and best high-end applications for Android TVs, wearable devices, tablets, and mobiles. Our <a href="{{asset('/')}}mobile-app-development.php" class="text-decoration-none text-theme2">Mobile App Development Services</a> focus on developing trustworthy and interactive apps for all app store categories, including Travel, Tourism, Education & Learning, Health & Fitness, and Photo & Video.</div>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="container-fluid development_services position-relative">
      <div class="container position-relative zi-2 py-5">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Android App Development Services</h2>
            <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Android App <b> Development Services </b></span></div>
         </div>
         <div class="row">
            <div class="col-lg-4 col-md-6 col-12 text-center d-flex align-items-stretch mb-md-4 mb-4">
               <div class="development_services_box w-100">
                  <span class="box_img">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Custom-Android-Development.webp" width="auto" height="auto" alt="Custom Android Development">
                  </span>
                  <h3 class="d-none invisible">Custom Android Development</h3>
                  <div class="col-12 fw-900 text-theme1 fs-lg-18 fs-md-17 fs-17 lh-normal tz" style="--tz:30px;">Custom Android Development</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 mt-2 tz" style="--tz:30px;">Being the best Android Development Company, we offer custom android app development services that address the requirements of every business and deliver android apps as expected by the client.</div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 text-center d-flex align-items-stretch mb-md-4 mb-4">
               <div class="development_services_box w-100">
                  <span class="box_img">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Android-UI-UX-Designing.webp" width="auto" height="auto" alt="Android UI/UX designing">
                  </span>
                  <h3 class="d-none invisible">Android UI/UX designing</h3>
                  <div class="col-12 fw-900 text-theme1 fs-lg-18 fs-md-17 fs-17 lh-normal tz" style="--tz:30px;">Android UI/UX designing</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 mt-2 tz" style="--tz:30px;">We have the best Android UI/UX designers. They implement the best Android UI/UX design techniques to create interactive and user-friendly UI designs that deliver the best experience.</div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 text-center d-flex align-items-stretch mb-md-4 mb-4">
               <div class="development_services_box w-100">
                  <span class="box_img">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Android-Web-Based-Apps.webp" width="auto" height="auto" alt="Android Web-based apps">
                  </span>
                  <h3 class="d-none invisible">Android Web-based apps</h3>
                  <div class="col-12 fw-900 text-theme1 fs-lg-18 fs-md-17 fs-17 lh-normal tz" style="--tz:30px;">Android Web-based apps</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 mt-2 tz" style="--tz:30px;">We help you develop Android applications that improve the operational efficiency of your company every day. We have creative designers capable of building the right type of Android application.</div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 text-center d-flex align-items-stretch mb-md-4 mb-4">
               <div class="development_services_box w-100">
                  <span class="box_img">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/App-Porting.webp" width="auto" height="auto" alt="App Porting">
                  </span>
                  <h3 class="d-none invisible">App Porting</h3>
                  <div class="col-12 fw-900 text-theme1 fs-lg-18 fs-md-17 fs-17 lh-normal tz" style="--tz:30px;">App Porting</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 mt-2 tz" style="--tz:30px;">Do you need to port your Android platform to other platforms like Android to iOS or iOS to Android or other platforms? We are here to help you! We help you convert any apps to your preferred platform.</div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 text-center d-flex align-items-stretch mb-md-4 mb-4">
               <div class="development_services_box w-100">
                  <span class="box_img">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/App-Testing.webp" width="auto" height="auto" alt="App testing">
                  </span>
                  <h3 class="d-none invisible">App testing</h3>
                  <div class="col-12 fw-900 text-theme1 fs-lg-18 fs-md-17 fs-17 lh-normal tz" style="--tz:30px;">App testing</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 mt-2 tz" style="--tz:30px;">We have an experienced quality assurance team that tests the android apps before releasing it to the clients. We assure you that high-performance apps are verified multiple times to deliver the best user experience.</div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 text-center d-flex align-items-stretch mb-md-4 mb-4">
               <div class="development_services_box w-100">
                  <span class="box_img">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/App-Consultation.webp" width="auto" height="auto" alt="App Consultation">
                  </span>
                  <h3 class="d-none invisible">App Consultation</h3>
                  <div class="col-12 fw-900 text-theme1 fs-lg-18 fs-md-17 fs-17 lh-normal tz" style="--tz:30px;">App Consultation</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 mt-2 tz" style="--tz:30px;">Do not worry if you are confused about any project requirements. We have the best Android app consultants capable of suggesting the best work requirements or the right solutions for your project requirements.</div>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="container-fluid development_proccess">
      <div class="container zi-2 position-relative py-5">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Android App Development Process</h2>
            <div class="col-12 heading fs-md-14 fs-12 center text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Android App <b> Development Process </b></span></div>
         </div>
         <div class="row justify-content-center">
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12 text-center d-flex align-items-stretch py-3 px-4">
               <div class="development_process_box shadow w-100 h-100 ps-lg-5">
                  <label>1</label>
                  <h3 class="d-none invisible">Discussion about the project with our analysts</h3>
                  <div class="col-12 fw-900 text-theme3 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal mb-2">Discussion about the project with our analysts</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-2">Once our analyst reviews your project requirements, they choose a suitable developer who can handle your project requirements for delivering the best results.</div>
               </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12 text-center d-flex align-items-stretch py-3 px-4">
               <div class="development_process_box shadow w-100 h-100 ps-lg-5">
                  <label>2</label>
                  <h3 class="d-none invisible">Choose engagement timeline and terms</h3>
                  <div class="col-12 fw-900 text-theme3 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal mb-2">Choose engagement timeline and terms</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-2">Choose your desired engagement timeline and terms for executing your project.</div>
               </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12 text-center d-flex align-items-stretch py-3 px-4">
               <div class="development_process_box shadow w-100 h-100 ps-lg-5">
                  <label>3</label>
                  <h3 class="d-none invisible">Pay online securely</h3>
                  <div class="col-12 fw-900 text-theme3 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal mb-2">Pay online securely</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-2">Our online system is 100% secure, therefore you can make your payment without any hassle.</div>
               </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12 text-center d-flex align-items-stretch py-3 px-4">
               <div class="development_process_box shadow w-100 h-100 ps-lg-5">
                  <label>4</label>
                  <h3 class="d-none invisible">Getting started with us</h3>
                  <div class="col-12 fw-900 text-theme3 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal mb-2">Getting started with us</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-2">Our team of experts will be assigned with your project within 24 hours.</div>
               </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12 text-center d-flex align-items-stretch py-3 px-4">
               <div class="development_process_box shadow w-100 h-100 ps-lg-5">
                  <label>5</label>
                  <h3 class="d-none invisible">Project Delivery</h3>
                  <div class="col-12 fw-900 text-theme3 fs-lg-19 fs-md-17 fs-16 text-capitalize lh-normal mb-2">Project Delivery</div>
                  <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-2">We deliver the project at the right time to the clients, as promised. We assure you of the higher user satisfaction and best results.</div>
               </div>
            </div>
         </div>
      </div>
   ...
   <!-- benifits section -->
   <div class="container-fluid benifits" style="--bg:white;">
      <div class="container zi-2 position-relative py-5">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Benefits Of Availing IMG Global Infotech Android App Developers</h2>
            <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Benefits Of Availing IMG Global <b> Infotech Android App Developers </b></span></div>
         </div>
         <div class="row h-100">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block my-md-3 my-2"><img class="img-fluid h-70px" src="{{GETFOLDERPATH()}}/Message.webp" alt="Free Consultation"></span>
                        </div>
                        <div class="col-12">
                           <div class="row">
                              <h3 class="d-none invisible">Free Consultation</h3>
                              <div class="col-12 fw-900 fs-lg-16 fs-md-15 fs-14 text-uppercase lh-normal benefits_heads text-theme3">Free Consultation</div>
                              <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-3">We offer a free consultation for 30 minutes to discuss the requirements and queries about your project.</div>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 py-4 d-flex align-items-stretch">
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block my-md-3 my-2"><img class="img-fluid h-70px" src="{{GETFOLDERPATH()}}/Person.webp" width="auto" height="auto" alt="Our team of Android Developers"></span>
                        </div>
                        <div class="col-12">
                           <div class="row">
                              <h3 class="d-none invisible">Our team of Android Developers</h3>
                              <div class="col-12 fw-900 fs-lg-16 fs-md-15 fs-14 text-uppercase lh-normal benefits_heads text-theme3">Our team of Android Developers</div>
                              <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-3">Our developers have built 2000+ mobile apps for various business categories.
                              </div>
                           </div>
                        </div>
                     </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 py-4 d-flex align-items-stretch">
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block my-md-3 my-2"><img class="img-fluid h-70px" src="{{GETFOLDERPATH()}}/Call.webp" alt="Customized Hiring Models"></span>
                        </div>
                        <div class="col-12">
                           <div class="row">
                              <h3 class="d-none invisible">Customized Hiring Models</h3>
                              <div class="col-12 fw-900 fs-lg-16 fs-md-15 fs-14 text-uppercase lh-normal benefits_heads text-theme3">Customized Hiring Models</div>
                              <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-3">All our hiring models are flexible and enable you to hire experienced android app developers.
                              </div>
                           </div>
                        </div>
                     </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 py-4 d-flex align-items-stretch">
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block my-md-3 my-2"><img class="img-fluid h-70px" src="{{GETFOLDERPATH()}}/Information.webp" width="auto" height="auto" alt="24/7 technical support"></span>
                        </div>
                        <div class="col-12">
                           <div class="row">
                              <h3 class="d-none invisible">24/7 technical support</h3>
                              <div class="col-12 fw-900 fs-lg-16 fs-md-15 fs-14 text-uppercase lh-normal benefits_heads text-theme3">24/7 technical support</div>
                              <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-3">Our experts will offer the right solution for your project queries. We deliver a seamless user experience with our 24/7 strong support team.</div>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 py-4 d-flex align-items-stretch">
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block my-md-3 my-2"><img class="img-fluid h-70px" src="{{GETFOLDERPATH()}}/copy.webp" width="auto" height="auto" alt="Transparent"></span>
                        </div>
                        <div class="col-12">
                           <div class="row">
                              <h3 class="d-none invisible">Transparent</h3>
                              <div class="col-12 fw-900 fs-lg-16 fs-md-15 fs-14 text-uppercase lh-normal benefits_heads text-theme3">Transparent</div>
                              <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-3">We update our clients about the progress of the project during the complete project development cycle.</div>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 py-4 d-flex align-items-stretch">
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block my-md-3 my-2"><img class="img-fluid h-70px" src="{{GETFOLDERPATH()}}/calendar.webp" width="auto" height="auto" alt="3-month continuous support"></span>
                        </div>
                        <div class="col-12">
                           <div class="row">
                              <h3 class="d-none invisible">3-month continuous support</h3>
                              <div class="col-12 fw-900 fs-lg-16 fs-md-15 fs-14 text-uppercase lh-normal benefits_heads text-theme3">3-month continuous support</div>
                              <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-3">We offer three-month support even after the project delivery and make sure you are not facing any technical issues.</div>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="fantasy-cricket-sldier-box row align-items-start">
                                    <div class="col-lg-5 col-12 order-lg-0 order-md-1 order-1 mt-lg-0 mt-md-4 mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-12 fs-md-19 fs-18 fw-900 pb-3 text-theme3 text-lg-start text-center">Criconn</div>
                                                        <div class="col-12 fs-md-17 fs-16 fw-bold text-muted text-lg-start text-center">Fantasy gaming app</div>
                                                    </div>
                                                </div>
                                                <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 text-lg-start text-center"><p>Every user is not so lucky to perform itself on playground but we Criconn provides you the opportunity to feel the zeal of REAL CRICKET on your finger tips. Simply follow easy steps to join &ldquo;USER FRIENDLY Criconn Application&rdquo; to enter into DIGITAL GAMING ARENA. Criconn is an Application where YOUR cricket fantasies, convert into YOUR TEAM, YOUR PLAYERS, &amp; ultimately YOUR PERFORMERS which transforms YOUR DREAM TEAM to REAL CRICKET over DIGITAL ARENA.</p>

                                                   <p>Every user is not so lucky to perform itself on playground but we Criconn provides you the opportunity to feel the zeal of REAL CRICKET on your finger tips.</p>

                                                   <p>Simply follow easy steps to join &ldquo;USER FRIENDLY Criconn Application&rdquo; to enter into DIGITAL GAMING ARENA.</p>
                                                   </div>
                                                <div class="col-12 mt-4 text-lg-start text-center pb-2">
                                                    <a href="https://criconn.com/" class="btn btn-theme3 fs-14 fw-bold py-2 px-4 me-2">
                                            ...
                                            <div class="row fantasy-cricket-sldier-img text-center justify-content-center">
                                                <div class="col-12 text-center">
                                                    <img class="img-fluid" src="{{GETFOLDERPATH()}}/portfolio-criconn.webp" width="100" height="auto" alt="Criconn">
                                                </div>
                                            </div>
                                            </div>
                                   </div>
                                      ...
                                      <div class="col-lg-5 col-12 order-lg-0 order-md-1 order-1 mt-lg-0 mt-md-4 mt-4">
                                            ...
                                            <div class="row fantasy-cricket-sldier-img text-center justify-content-center">
                                                <div class="col-12 text-center">
                                                <img class="img-fluid" src="{{GETFOLDERPATH()}}/PortfolioImageExchange22.webp" width="100" height="auto" alt="PortfolioImageExchange22">
                                                </div>
                                            </div>
                                      </div>
                                   </div>
                                      ...
                                      <div class="col-lg-5 col-12 order-lg-0 order-md-1 order-1 mt-lg-0 mt-md-4 mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 text-lg-start text-center"><p>FantasyPower11 is one of the reliable and famous fantasy site to play and earn a real money. You can edit your team til last time of the match.</p>
													         </div>
                                                <div class="col-12 mt-4 text-lg-start text-center pb-2">
                                            ...
                                            <div class="row fantasy-cricket-sldier-img text-center justify-content-center">
                                                <div class="col-12 text-center">
                                                   <img class="img-fluid" src="{{GETFOLDERPATH()}}/portfolio-fantasypower11.webp" width="100" height="auto" alt="portfolio-fantasypower11">
                                                </div>
                                            </div>
                                            </div>
                                </div>
                                    ...
                                    <div class="fantasy-cricket-sldier-box row align-items-start">
                                          <div class="col-lg-5 col-12 order-lg-0 order-md-1 order-1 mt-lg-0 mt-md-4 mt-4">
                                                <div class="row">
                                                      ...
                                                      <div class="col-12">
                                                         <div class="row">
                                                            <div class="col-12 fs-md-19 fs-18 fw-900 pb-3 text-theme3 text-lg-start text-center">Myexpert11</div>
                                                            <div class="col-12 fs-md-17 fs-16 fw-bold text-muted text-lg-start text-center">Fantasy Cricket League</div>
                                                         </div>
                                                      </div>
                                                      <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 text-lg-start text-center"><p>MyExpert11 is an amazing fantasy website. People can make their team, play the game and earn the real money.</p></div>
                                                      <div class="col-12 mt-4 text-lg-start text-center pb-2">
                                                         <a href="https://www.myexpert11.com/" class="btn btn-theme3 fs-14 fw-bold py-2 px-4 me-2">
                                                            <span class="d-block"><span>View Live !</span> <i class="imgd img-laptop position-relative bottom-n2px ms-2"></i></span>
                                                         </a> 
                                                      </div>
                                                </div>
                                            ...
                                            <div class="row fantasy-cricket-sldier-img text-center justify-content-center">
                                                <div class="col-12 text-center">
                                                <img class="img-fluid" src="{{GETFOLDERPATH()}}/portfolio-myexpert11.webp" width="100" height="auto" alt="portfolio-myexpert11">
                                                </div>
                                            </div>
                                            </div>
                                        </div>               
   ...
   <div class="container-fluid contact-with-us-section position-relative overflow-hidden" id="contact-with-us-section">
      <div class="container position-relative zi-1 py-5">
         <div class="row align-items-center border border-5 rounded p-3 border-white">
            <div class="col-lg-6">
               <div class="row align-items-center">
                  <h2 class="d-none invisible">Connect With Us</h2>
                  ...
                  <div class="col-md-7">
                         <div class="row">
                                 <div class="col-5 pe-0">
                                          <select class="form-select rounded-0 brl" aria-label="Default select example" style="padding: 0.375rem 0.25rem 0.375rem 0.75rem !important; border-left: 4px solid #e09c19;">
...
<script src="{{asset('/public')}}/assets/js/android-application-development.min.js"></script>
