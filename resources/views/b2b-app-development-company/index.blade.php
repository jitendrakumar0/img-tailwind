...
@push('meta')
   <!--  Title -->
   <title> Best B2B E-Commerce Development Company In India</title>

   <!-- Required meta tags -->
   <meta name="title" content="Best B2B E-Commerce Development Company In India" />
   ...
   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Best B2B E-Commerce Development Company In India">
   ...
   <meta name="twitter:image" content="{{GETFOLDERPATH()}}/b2b-app-development-company-banner.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}b2b-app-development-company.php">
   ...
   <meta property="og:image" content="{{GETFOLDERPATH()}}/b2b-app-development-company-banner.webp">
   <meta property="og:image:secure_url" content="{{GETFOLDERPATH()}}/b2b-app-development-company-banner.webp">
   ...
   <link rel="canonical" href="{{asset('/')}}b2b-app-development-company.php" />
   <meta name="robots" content="noindex, nofollow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/b2b-app-development-company.min.css">
@endpush
@section('content')
{{-- Hero Section --}}
...
<img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/b2b-app-development-company-banner.webp" alt="b2b-app-development-company-banner"></div>
@endsection('hero_img')
                 ...
                 <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center mb-3 text-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative">
                           <img class="w-md-100 w-80 position-relative" src="{{GETFOLDERPATH()}}/b2b-development-company.webp" alt="b2b-development-company">
                        </div>
                     </div>
                  </div>
                 <div class="col-lg-7">
                     ...
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-8 col-md-8 col-12">
                           ...
                           <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-lg-end justify-content-md-end justify-content-center py-2">
                               <a href="#0" class="btn expert-btn fs-lg-17 fs-md-17 fs-14 fw-bold py-3 px-md-4 px-4 bg-white">
                              ...
                              <div class="col-12">
                                 <div class="row ">
                                    <div class="col-lg-6 col-md-12 col-12">
                                       <div class="row justify-content-center mb-3 text-center">
                                             <img class="w-md-70 w-100 position-relative " src="{{GETFOLDERPATH()}}/b2bprocess.webp" alt="hire-android-developer">
                                          </div>
                                    </div>
...
<script src="{{asset('/public')}}/assets/js/b2b-app-development-company.min.js"></script>
...
<script>
const nextArrow= '<img src="public/assets/img/b2b-app-development-company/nextfeature.svg" alt="right arrow" width="30">';
const nextIcon= '<img src="public/assets/img/b2b-app-development-company/next.svg" alt="right arrow" width="30">';
$(function () {
