...
<nav class="navbar navbar-expand-lg navbar-light bg-light d-block">
    ...
    <div class="container bottombar">
        <a class="navbar-brand animate order-1" href="{{asset('/')}}">
            ...
            <img src="{{asset('/public')}}/assets/img/logos/logo-199x55.webp" srcset="{{asset('/public')}}/assets/img/logos/logo-145x45.webp 700w, {{asset('/public')}}/assets/img/logos/logo-199x55.webp 1000w, {{asset('/public')}}/assets/img/logos/logo-199x55.webp 1200w" width="199" height="55" alt="IMG Global Infotech Logo">
            </span>  -->
            <span class="blog_logo">
            <img src="{{asset('/public')}}/assets/img/logos/img-logo-christmas.png"  width="199" height="55" alt="IMG Global Infotech Logo">
            </span> 
            <span style="display:none" class="blog_logo1">
            <img src="{{asset('/public')}}/assets/img/logos/logo-199x55.webp" srcset="{{asset('/public')}}/assets/img/logos/ogo-145x45.webp 700w, {{asset('/public')}}/assets/img/logos/logo-199x55.webp 1000w, {{asset('/public')}}/assets/img/logos/logo-199x55.webp 1200w" width="199" height="55" alt="IMG Global Infotech Logo">
            </span>
        </a>
                                            ...
                                            <div class="sub-menu-sec pt-lg-0 pt-3 col-3">
                                                ...
                                                <ul class=" w-100 d-inline-block position-relative ps-xxl-4 ps-3 mt-xxl-4 mt-2 list-unstyled">
                                                    ...
                                                    <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                        ...
                                                        <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                        <a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/cross-platform-app-development.php')}}">Cross-Platform App </a>
                                                        </li>
                                                        <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                        ...
                                        <div class="sub-menu-center-block cus-full-block row rows">
                                         <div class="sub-menu-sec pt-lg-0 pt-3 col">
                                            <div class="menuHeadTitle text-white fw-m fs-xxl-17 fs-16 m-0"><div class="fw-m m-0 fs-xxl-18 fs-17 text-white p-0 text-decoration-none">Trending Solutions</div></div>
                                                <ul class=" w-100 d-inline-block position-relative ps-xxl-4 ps-3 mt-xxl-4 mt-2 list-unstyled">
                                                    ...
                                                    <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                        ...
                                                        <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                         <a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/jewellery-app-development.php')}}">Jewellery App</a>
                                                        </li>
                                            ...
                                            <div class="sub-menu-sec pt-lg-0 pt-3 col">
                                                <ul class="text-nowrap w-100 d-inline-block position-relative ps-xxl-4 ps-3 mt-xxl-4 mt-2 list-unstyled">
                                                <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                    <a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/diet-and-nutrition-app-development.php')}}">Diet and Nutrition App</a></li>
                                                <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                    ...
                                                    <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                        <a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/gps-tracking-software.php')}}">GPS Tracking Software</a></li>
                                                    <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                    ...
                                                    <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                                        <a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/real-estate-management-software.php')}}">Real Estate Management</a></li>
                                                    <li class="ssub-menu mt-1 ps-4 position-relative w-100">
                                            ...
                                            <div class="sub-menu-sec pt-lg-0 pt-3 col">
                                               ...
                                               <li class="ssub-menu mt-1 ps-4 position-relative w-100"><a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/rfid-attendance-system-india.php')}}">RFID Tracking  </a></li>
                                                   ...
                                                   <li class="ssub-menu mt-1 ps-4 position-relative w-100"><a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/financial-portal-development.php')}}">Financial Portal</a></li>
                                                   ...
                                                   <li class="ssub-menu mt-1 ps-4 position-relative w-100"><a class="text-white text-nowarp position-relative text-decoration-none fs-xxl-15 fs-xl-13 fs-14" href="{{asset('/credit-cooperative-society-software.php')}}">Credit Cooperative</a></li>
        ...
        <form class="d-flex align-self-lg-start align-self-center ms-auto order-lg-4 order-2 mb-3">
			...
			<a class="nav-link d-flex btn  btn-button1  fw-l fs-xxl-16 fs-xl-16 fs-lg-16 fs-14  rounded text-white text-capitalize px-lg-3 py-xxl-2 py-xl-2 py-lg-2 py-md-1 py-sm-1 py-1 d-lg-flex d-none" href="{{asset('/request-a-quote.php')}}">Request a Quote<i class="imgd img-long-arrow-right position-relative fs-23 ms-2 arrowright"></i></a>
...
<div class="offcanvas mobile_header offcanvas-start sidebar" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header align-items-center">
        <div class="offcanvas-title" id="offcanvasExampleLabel">
            ...
            <a class="navbar-brand order-1" href="{{asset('/')}}">
                <img src="{{asset('/public')}}/assets/img/logos/img-logo-christmas.png"  class="h-35px" width="127" height="35" alt="IMG Global Infotech Logo">
            </a>
        </div>
                                ...
                                <div class="row border-start border-3 border-white ms-0 mb-4 position-relative left-2px">
                                    ...
                                    <div class="col-12">
                                        <div class="row grp_items pt-2 ms-0">
                                            ...
                                            <a href="{{asset('/cross-platform-app-development.php')}}" class="col-12 fs-14 text-white">Cross-Platform App Development</a>
                                ...
                                <div class="row border-start border-3 border-white ms-0 mb-4 position-relative left-2px">
                                    ...
                                    <div class="col-12">
                                        <div class="row grp_items pt-2 ms-0">
                                            ...
                                            <a href="{{asset('/diet-and-nutrition-app-development.php')}}" class="col-12 fs-14 text-white">Diet and Nutrition App</a>
                                            <a href="{{asset('/fashion-app-development.php')}}" class="col-12 fs-14 text-white">Fashion App</a>
                                            <a href="{{asset('/jewellery-app-development.php')}}" class="col-12 fs-14 text-white"> Jewellery App</a>
                                            ...
                                            <a href="{{asset('/gps-tracking-software.php')}}" class="col-12 fs-14 text-white">GPS Tracking Software</a>
                                            ...
                                            <a href="{{asset('/financial-portal-development.php')}}" class="col-12 fs-14 text-white"> Financial Portal</a>
                                            ...
                                            <a href="{{asset('/real-estate-management-software.php')}}" class="col-12 fs-14 text-white"> Real Estate Management</a>
                                            <a href="{{asset('/credit-cooperative-society-software.php')}}" class="col-12 fs-14 text-white"> Credit Cooperative</a>
