...
@push('meta')
   <!--  Title -->
   <title>On-Demand Tracking App Development Company | Restaurant App Development</title>

   <!-- Required meta tags -->
   <meta name="title" content="On-Demand Tracking App Development Company | Restaurant App Development" />
   <meta name="description" content="IMG Global Infotech is the leading custom Tracking app development company which provides food ordering app development services for your food business." />
   <meta name="keywords" content="" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="On-Demand Tracking App Development Company | Restaurant App Development">
   <meta name="twitter:description" content="IMG Global Infotech is the leading custom Tracking app development company which provides food ordering app development services for your food business.">
   ...
   <meta property="og:title" content="On-Demand Tracking App Development Company | Restaurant App Development">
   <meta property="og:description" content="IMG Global Infotech is the leading custom Tracking app development company which provides food ordering app development services for your food business.">
   ...
   <link rel="canonical" href="{{asset('/')}}car-wash-app-development.php" />
   <meta name="robots" content="noindex, nofollow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/car-wash-app-development.min.css">
@endpush
@section('content')
{{-- Hero Section --}}
...
<span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Car Wash App <b>Development Company</b></span>
@endsection('hero_heading')
@section('hero_tagline')
Launch your car wash business on the road to success through our expert car wash mobile app development services. Our team specializes in crafting powerful, smart, and reliable On-Demand Car Wash Mobile Apps for any entrepreneurial venture aiming to find a cost-effective way of establishing their service. Unlock unlimited potential with our innovative solutions today – you won't regret it!
...
@endsection('hero_btn')
@section('hero_img')
<img class="w-85 position-relative" src="{{GETFOLDERPATH()}}/Banking_&_Finance_App_Development_Solutions.webp" alt="food app development company banner">
@endsection('hero_img')
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item"><a class="fw-l fs-lg-16 fs-md-15 fs-14 text-theme2 text-decoration-none" href="{{asset('/mobile-app-development.php')}}">Mobile App Development Services</a></li>
                     <li class="breadcrumb-item active fw-l fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Car Wash App Development Company </li>
                  </ol>
               </nav>
            </div>
         </div>
                 ...
                 <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative text-center leftside">
                           <img class="w-lg-100 w-50 position-relative" src="{{GETFOLDERPATH()}}/Banking_&_Finance_App_Development_Solutions.webp" alt="cost effective app">
                        </div>
                     </div>
                  </div>
                 <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pt-lg-0">
                                 ...
                                 <div class="row mx-0">
                                    <h2 class="d-none invisible">Excel the Business of Washing Dirty Cars & Take it to the Next Level</h2>
                                    <div class="col-12 heading fs-md-14 fs-12 left text-dark">
                                       <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Excel the Business of Washing Dirty Cars &  <b> Take it to the Next Level</b></span></div>
                                 </div>
                              </div>
                            </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">Our car wash software help you connect with customers more effectively while allowing them to book their car wash and cleaning service, track their service progress, and make payments conveniently – all from one place!
                            Our On-Demand Car Washing App Development Services are meticulously crafted to meet your business's needs. We guarantee you'll get a well-built app that will take your car washing services to the next level! With our developers' extensive experience in creating cutting-edge mobile apps for any platform or device, you can now easily reach an even broader segment of potential customers.</div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">With our Car Wash App Development Solutions, you can offer customers the comfort and convenience of controlling their car washing experience – from selecting services to tracking progress to making payments. It is easy to use, efficient, secure, and user-friendly – giving you an edge over competitors in the market – so what are you waiting for? Contact us today and start taking your car washing business to the next level!</div>
                     </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-7">
                    ...
                    <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative text-center leftside">
                           <img class="w-lg-100 w-40 position-relative " src="{{asset('/public')}}/assets/img/food-delivery-app-development/reasonsofdemand.webp" alt="reasonsofdemand">
                        </div>
                     </div>
                  </div>
                </div>
...
<div class="container-fluid overflow-hidden car_wash_services_box position-relative py-3 car-wash-section">
        <div class="container py-lg-5 py-md-4 position-relative zi-2">
            <div class="row">
                <div class="col-12">
                    <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                        <h2 class="d-none invisible">How Car wash App Development Helps Your Business Grow</h2>
                        <div class="col-12 heading fs-md-14 fs-12 center"><span
                                class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">How Car wash App Development  <b> Helps Your Business Grow
                                </b></span></div>
                        <div
                            class="col-lg-9 col-md-12 col-12 mt-2 fw-l fs-lg-16 fs-md-16 fs-sm-17 fs-16 text-lg-center text-center mx-auto">
                            Get custom car wash app development loaded with exceptional features and a build-to-scale architecture that can level up your business and offer your customers the best possible car wash service.
                        </div>
                    </div>
                </div>
            </div>

            <div class="row mx-lg-5 mx-md-2 mx-0 mt-lg-5 mt-md-5 mt-3">
                <div class="col-lg-4 col-md-6 col-12  mb-lg-5 mb-5  d-flex align-items-stretch">
                    <div class="car_wash_item px-4 py-5 position-relative shadow">
                        <span class="car_wash_icon position-relative">
                            <img class=" img-fluid" src="{{GETFOLDERPATH()}}/talented-squad.webp" alt="Talented squad"
                                height="50px" width="50px">
                        </span>
                        <span class="count_num fs-90 position-absolute">01</span>
                        <div class="col-12 fw-m  fs-19 lh-normal pt-3">
                           Faster Operations
                        </div>
                        <div class="col-12 fw-l fs-16 text-muted pt-3">As we talk about the ready-made car wash app, it becomes easier to integrate the features, and the app operations become faster. It saves time for the user and service provider.
                        </div>
                        <span class="arrow_icon position-absolute d-flex align-items-center justify-content-center"><i class="imgs img-arrow-right text-white fs-29"></i></span>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12  mb-lg-5 mb-5  d-flex align-items-stretch">
                    <div class="car_wash_item px-4 py-5 position-relative shadow">
                        ...
                        <span class="count_num fs-90 position-absolute">02</span>
                        <div class="col-12 fw-m  fs-19 lh-normal pt-3">
                        Reduce Expenses
                        </div>
                        <div class="col-12 fw-l fs-16 text-muted pt-3">You can control your expenses with the help of a white label car wash development team who will build a solution for you within stringent deadlines and help you reach a wider audience.
                        </div>
                        <span class="arrow_icon position-absolute d-flex align-items-center justify-content-center"><i class="imgs img-arrow-right text-white fs-29"></i></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12  mb-lg-5 mb-5  d-flex align-items-stretch">
                    <div class="car_wash_item px-4 py-5 position-relative shadow">
                        ...
                        <span class="count_num fs-90 position-absolute">03</span>
                        <div class="col-12 fw-m  fs-19 lh-normal pt-3">
                        Marketing on the Go
                        </div>
                        <div class="col-12 fw-l fs-16 text-muted pt-3">With a good car wash application built by professionals, you can simply connect with the experts and market your business to bring in more customers and grow stronger.
                        </div>
                        <span class="arrow_icon position-absolute d-flex align-items-center justify-content-center"><i class="imgs img-arrow-right text-white fs-29"></i></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12  mb-lg-5 mb-5  d-flex align-items-stretch">
                    <div class="car_wash_item px-4 py-5 position-relative shadow">
                        ...
                        <span class="count_num fs-90 position-absolute">04</span>
                        <div class="col-12 fw-m  fs-19 lh-normal pt-3">
                        Customer Acquisition
                        </div>
                        <div class="col-12 fw-l fs-16 text-muted pt-3">With a dedicated mobile application, sharing your services with your customers would be easier. Also, you would have to worry less about the operation and functioning and focus on quality more.
                        </div>
                        <span class="arrow_icon position-absolute d-flex align-items-center justify-content-center"><i class="imgs img-arrow-right text-white fs-29"></i></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12  mb-lg-5 mb-5  d-flex align-items-stretch">
                    <div class="car_wash_item px-4 py-5 position-relative shadow">
                        ...
                        <span class="count_num fs-90 position-absolute">05</span>
                        <div class="col-12 fw-m  fs-19 lh-normal pt-3">
                        Improved Management
                        </div>
                        <div class="col-12 fw-l fs-16 text-muted pt-3">When the reminders are automated, scheduling, checking, picking up, and dropping off vehicles is easier. You don’t have to put your energy into remembering things, simply focus on your core business and expand.
                        </div>
                        <span class="arrow_icon position-absolute d-flex align-items-center justify-content-center"><i class="imgs img-arrow-right text-white fs-29"></i></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12  mb-lg-5 mb-5  d-flex align-items-stretch">
                    <div class="car_wash_item px-4 py-5 position-relative shadow">
                        ...
                        <span class="count_num fs-90 position-absolute">06</span>
                        <div class="col-12 fw-m  fs-19 lh-normal pt-3">
                          
                       On-time Delivery
                        </div>
                        <div class="col-12 fw-l fs-16 text-muted pt-3">With a ready-made car detailing app development team working on your application, you can customize it to fit your business and customer needs, which would help you deliver the cars in a limited time.
                        </div>
                        <span class="arrow_icon position-absolute d-flex align-items-center justify-content-center"><i class="imgs img-arrow-right text-white fs-29"></i></span>
                    </div>
                </div>
     ...
     <div class="image-layer"></div>
      <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
         <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
            <h3 class="d-none invisible">Exemplary Features for Each Panel</h3>
            <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Exemplary Features  <b> for Each Panel </b></span></div>
            ...
            <div class="row d-flex align-items-center ">
                <div class="col-lg-8 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">   
                     <ul class="nav nav-tabs border-0">
                           <li class="nav-item">
                              <a class="nav-link active btn text-black fs-lg-19 fs-md-19 fs-13 fw-l my-3 py-2 mx-3 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#home"> Customer App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-l my-3 py-2 mx-3 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu1">Driver App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-l my-3 py-2 mx-3 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu2">Admin Panel</a>
                           </li>
                     </ul>
                </div>
                        ...
                        <div class="tab-pane container active p-0" id="home">
                           <div class="row mt-lg-0 mt-md-0 mt-3">
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">             
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Sign Up/Logins"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Sign Up/Logins</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-20" width="100" height="auto" alt="Add Service Locations"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Add Service Locations</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Update Availability Status"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Update Availability Status</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Request for Payment from Admin"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Request for Payment from Admin</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="View Completed Job History"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">View Completed Job History</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Accept/Reject Service allotted By Admin"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Accept/Reject Service allotted By Admin</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">            
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Social Media Login"></div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">            
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Order Tracking"></div>
                     ...
                     <div class="tab-pane container fade p-0" id="menu1">
                         <div class="row mt-lg-0 mt-md-0 mt-3">
                            <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Profile"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Sign Up/ Login</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-20" width="100" height="auto" alt="Check Technician Availability for Preferred Location"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Check Technician Availability for Preferred Location</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="View Past Order Details"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">View Past Order Details</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Pay Technician Through System"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Pay Technician Through System</div>
                                          </div>
                                    </div>
                              </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">           
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Cancel Request"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Cancel Request</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Track Technician"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Track Technician</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Delivery Information"></div>
                     ...
                     <div class="tab-pane container fade p-0" id="menu2">
                           <div class="row mt-lg-0 mt-md-0 mt-3">
                            <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Registration of Technician"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Registration of Technician</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-20" width="100" height="auto" alt="Manage User Jobs"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage User Jobs</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Manage Technicians, User Profile and Credentials"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Technicians, User Profile and Credentials</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                  
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Manage Services"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Services</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">               
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Manage Ratings & Feedback"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Ratings & Feedback</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">        
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Manage User Payment History"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage User Payment History</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Analyzing & Reporting"></div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Promo codes"></div>
                 ...
                 <div class="container-fluid banner-cta1 py-lg-5 py-md-5 py-3 py-2 zi-2 position-relative mt-lg-5 mt-md-5 mt-5">
                   <div class="container">
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-12 col-md-12 col-12">
                         <h3 class="d-none invisible">Bespoke Car Wash App Development to Help You Skyrocket Your Sales</h3>
                           <div class="col-12 fw-m fs-md-33 fs-lg-33 fs-24 text-white  text-center mb-3"> Bespoke Car Wash App Development to Help You Skyrocket Your Sales</div>
                           <div class="col-12 fw-l fs-md-18 fs-lg-18 fs-16 text-white text-center">Car Wash and Car Maintenance App Development with Latest Technologies to Give You an Edge Over Your Competition!</div>
                        </div>
            ...
            <div class="container">
               <div class="row align-content-center align-items-center position-relative">
                     <div class="col-lg-7 col-md-12">
                           ...
                           <h3 class="d-none invisible">Why Choose IMG Global Infotech is a Good Tracking App Developer? </h3> 
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-33 fs-lg-29 fs-md-24 fs-20 text-dark"> Why Choose IMG Global Infotech is a Good <b>Tracking App Developer? </b></span></div>
                           </div>
                           <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-mute mb-4">   
                           We offer end-to-end Tracking app development services. With a focus on quality and user experience, we can help you create an app that is user-friendly, efficient, and engaging. Contact us today to discuss your project needs and take the first step towards launching your Tracking app.
                        </div>
                           <div>
                              <div class="row">
   ...
   <div class="container-fluid on_demand position-relative pt-md-2 pt-2">
        ...
        <div class="row py-lg-4 py-3 items fantasy-cricket-sldier owl-carousel">
                ...
                <div class="box h-100 flex-column d-flex px-lg-3 px-md-3 px-3 py-lg-4 py-md-4 py-4">
                    <figure>
                        <picture class="d-flex justify-content-center">
                            <img src="{{GETFOLDERPATH()}}/grocery-app-development-company.webp" class="w-lg-80 w-md-50 w-50"
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
                <div class="box h-100 flex-column d-flex px-3 py-4">
                    <figure>
                        <picture class="d-flex justify-content-center">
                            <img src="{{GETFOLDERPATH()}}/jewellery-app-development-company.webp" class="w-lg-75 w-md-50 w-50"
                                alt="Jewellery App Development">
                        </picture>
                    </figure>
                    <div
                        class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">
                        Jewellery App Development</div>
                    <div
                        class="col-lg-12 col-md-12 col-12 text-balck fs-lg-17 fs-md-15 flex-fill fs-15 lh-normal  text-white">
                        Get a custom jewellery mobile app/website for easy jewellery shopping.</div>
                    <div
                        class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                        <a href="{{asset('/jewellery-app-development.php')}}"
                            class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                            <span class="d-block"><span>Read More</span> <i
                                    class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                    </div>
            ...
            {{--  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4" >
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/food-delivery-app-development-company.webp" class="w-lg-75 w-md-50 w-50"
            alt="Food Delivery App Development">
            </picture>
            </figure>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1 text-white">
                Food Delivery App Development</div>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal text-white">
                IMG is the best Food delivery app development company holding years of experience serving</div>
            <div
                class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                <a href="{{asset('/food-delivery-app-development.php')}}"
                    class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 text-dark bg-white">
                    <span class="d-block"><span>Read More</span> <i
                            class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                </a>
            </div>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
        <div class="box h-100 flex-column d-flex px-3 py-4">
            <figure>
                <picture class="d-flex justify-content-center">
                    <img src="{{GETFOLDERPATH()}}/healthcare-app-development-company.webp" class="w-lg-75 w-md-50 w-50"
                        alt="Healthcare App Development">
                </picture>
            </figure>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">
                Healthcare App Development</div>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">
                Delivering world-class healthcare application services to enhance medical care.</div>
            <div
                class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                <a href="{{asset('/healthcare-app-development.php')}}"
                    class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white">
                    <span class="d-block"><span>Read More</span> <i
                            class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                </a>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
        <div class="box h-100 flex-column d-flex px-3 py-4">
            <figure>
                <picture class="d-flex justify-content-center">
                    <img src="{{GETFOLDERPATH()}}/pharmacy-delivery-app-development.webp" class="w-lg-75 w-md-50 w-50"
                        alt="Pharmacy App Development">
                </picture>
            </figure>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">
                Pharmacy App Development</div>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">
                We are experts in mobile app development for pharmacy and pharma related business.</div>
            <div
                class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                <a href="{{asset('/pharmacy-app-development.php')}}"
                    class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                    <span class="d-block"><span>Read More</span> <i
                            class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                </a>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
        <div class="box h-100 flex-column d-flex px-3 py-4">
            <figure>
                <picture class="d-flex justify-content-center">
                    <img src="{{GETFOLDERPATH()}}/doctor-on-demand-app-development-company.webp" class="w-lg-75 w-md-50 w-50"
                        alt="Doctor On-Demand App">
                </picture>
            </figure>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-m mb-1  text-white">
                Doctor On-Demand App</div>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">
                IMG develops online doctor appointment applications for hospitals, clinics, and doctors.</div>
            <div
                class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                <a href="{{asset('/doctor-on-demand-app-development.php')}}"
                    class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                    <span class="d-block"><span>Read More</span> <i
                            class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                </a>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
        <div class="box h-100 flex-column d-flex px-3 py-4">
            <figure>
                <picture class="d-flex justify-content-center">
                    <img src="{{GETFOLDERPATH()}}/fashion-app-development-company.webp" class="w-lg-75 w-md-50 w-50"
                        alt="Fashion App Development">
                </picture>
            </figure>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-19 fs-18 lh-normal fw-m mb-1  text-white">
                Fashion App Development</div>
            <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">
                Build an enterprise-grade app for your clothing store and take your business to new heights.</div>
            <div
                class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                <a href="{{asset('/fashion-app-development.php')}}"
                    class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-m py-2 px-md-3 px-3 bg-white  text-dark">
                    <span class="d-block"><span>Read More</span> <i
                            class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                </a>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4 ">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico  rounded mb-2 text-center">
                          ...
                          <h3 class="d-none invisible">Tracking App Development</h3>
                        <div class="col-12 fw-m text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Tracking App <br>Development</div>
                     </div>
                  </div>
               </div>
...
<script src="{{asset('/public')}}/assets/js/car-wash-app-development.min.js"></script>
