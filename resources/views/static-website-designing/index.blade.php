...
@push('meta')
   <!--  Title -->
   <title>Static Website Designing Company in India, Static Website Design in India, Static Website Designing in Jaipur</title>

   <!-- Required meta tags -->
   <meta name="title" content="Static Website Designing Company in India, Static Website Design in India, Static Website Designing in Jaipur" />
   <meta name="description" content="IMG Global Infotech is a leading best static website designing company in India that give online presence to your business by its variety of features." />
   <meta name="keywords" content="Static Website Designing, Static Website Designing Company, Static Website Designing Services, Static Website Designing Company in India, Static Website Design Company in India, Static Web Design Company in India, Static Web Design Services in India, Static Website Designing Solution in India, Static Website Designing Agency in India, Static Website Designing Company in Jaipur, Static Website Design Company in Jaipur, Static Web Design Company in Jaipur, Static Web Design Services in Jaipur, Static Website Designing Solution in Jaipur, Static Website Designing Agency in Jaipur" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Static Website Designing Company in India, Static Website Design in India, Static Website Designing in Jaipur">
   <meta name="twitter:description" content="IMG Global Infotech is a leading best static website designing company in India that give online presence to your business by its variety of features.">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/static-website-designing/1.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}static-website-designing.php">
   <meta property="og:title" content="Static Website Designing Company in India, Static Website Design in India, Static Website Designing in Jaipur">
   <meta property="og:description" content="IMG Global Infotech is a leading best static website designing company in India that give online presence to your business by its variety of features.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/static-website-designing/1.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/static-website-designing/1.webp">



   <meta name="classification" content="Static Website Designing, Static Website Designing Company, Static Website Designing Services, Static Website Designing Company in India, Static Website Design Company in India, Static Web Design Company in India, Static Web Design Services in India, Static Website Designing Solution in India, Static Website Designing Agency in India, Static Website Designing Company in Jaipur, Static Website Design Company in Jaipur, Static Web Design Company in Jaipur, Static Web Design Services in Jaipur, Static Website Designing Solution in Jaipur, Static Website Designing Agency in Jaipur" />
   <link rel="canonical" href="{{asset('/')}}static-website-designing.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/static-website-designing.min.css">
@endpush
@section('content')

   <!-- top banner section -->
   <div class="container-fluid overflow-hidden bg-white top_banner position-relative" style="--bg:url({{asset('/public')}}/assets/img/static-website-designing/hero.webp);">
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Static Website Designing</h1>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/static-website-designing/1.webp" alt="Static Website Designing">
                           <img class="w-100 position-absolute top-0 left-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/static-website-designing/12.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/static-website-designing/11.webp" alt="Why Choosing Static Website Is A Beneficial For Your Business?">
                           <img class="w-100 position-absolute top-0 start-0 end-0 bottom-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/static-website-designing/2.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Why Choosing Static Website Is A Beneficial For Your Business?</h2>
   ...
   <div class="container-fluid overflow-hidden ionic-benefits-section position-relative py-5">
      <div class="container zi-2 position-relative py-lg-4">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Benefits Of A Static Website Include</h2>
            <div class="col-12 heading fs-md-14 fs-12 center text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Benefits Of A <b> Static Website Include</b></span></div>
         </div>
         <div class="row">
   ...
   <div class="container-fluid overflow-hidden redesign-web-features position-relative py-5">
      <div class="container py-lg-4 zi-2 position-relative">
         <div class="row mx-0 pb-md-5 pb-4">
            <h2 class="d-none invisible">Features Which Can Be Available In Static Website</h2>
            <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Features Which Can Be Available In <b> Static Website </b></span></div>
         </div>
         <div class="row justify-content-center">
...
@endsection
@push('scripts')
   <script src="{{asset('/public')}}/assets/js/static-website-designing.min.js"></script>
@endpush