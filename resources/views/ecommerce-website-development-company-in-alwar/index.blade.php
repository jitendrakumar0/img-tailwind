...
@push('styles')
   ...
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/ecommerce-website-development-company-in-alwar.min.css">
               ...
               <div class="row pt-4 align-items-center">
                  <div class="col-lg-6 py-lg-5 pt-md-5 pb-md-4 py-4 order-lg-0 order-md-1 order-1">
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        ...
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white mb-3 mt-3">Our experts work with the latest technologies and they understand your detailed requirements so they can meet the needs of your business. Robust and Scalable Ecommerce Web Development Services. </div>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/ecommerce-website-development-company-alwar.webp" alt="ecommerce-website-development-company-alwar">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/ecommerce-development-services.webp" alt="ecommerce-development-services">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
               ...
               <div class="col-lg-4 col-md-6 col-sm-12 col-12 pb-md-0 mb-md-0 pb-5 mb-5 servies-box">
                  <div class="row align-items-center justify-content-center text-center px-md-4 px-0 h-100">
                     ...
                     <div class="row position-relative pt-5 px-3 bg-white brs">
                           ...
                           <div class="col-12 fs-md-17 fs-sm-20 fs-18 text-theme3 fw-900 py-md-0 tz" style="--tz:30px;">Mobile Friendly Design-</div>
                           <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-600 py-md-2 pb-md-5 pb-4 tz" style="--tz:30px;">IMG is an Alwar one of the trusted organisations working towards making websites that are mobile responsive and their UI experience is highly user-friendly. Their designs attract the audience that is using smartphones and make them interested in your E-commerce website.
                           </div>
                  ...
                  <div class="row align-items-center justify-content-center text-center px-md-4 px-0 h-100">
                     <div class="col-md-12">
                         <div class="row position-relative pt-5 px-3 bg-white brs">
                           ...
                           <div class="col-12 fs-md-17 fs-sm-20 fs-18 text-theme3 fw-900 py-md-0 tz" style="--tz:30px;">High Accessibility</div>
                           <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-600 py-md-2 pb-md-5 pb-4 tz" style="--tz:30px;">Being a top e-Commerce website development company I want to make a website which has high accessibility and there is no Complex method to scroll on that particular website. This makes interaction with the user easier and boosts the growth of a business. 
                           </div>
               ...
               <div class="col-lg-4 col-md-6 col-sm-12 col-12 pt-md-5 pb-md-0 mb-md-0 pb-5 mb-5 servies-box">
                  <div class="row align-items-center justify-content-center text-center px-md-4 px-0 h-100 pt-md-5">
                     ...
                     <div class="row position-relative pt-5 px-3 bg-white brs">
                           ...
                           <div class="col-12 fs-md-17 fs-sm-20 fs-18 text-theme3 fw-900 py-md-0 tz" style="--tz:30px;">Systematic Workflow</div>
                           <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-600 py-md-2 pb-md-5 pb-4 tz" style="--tz:30px;">Their work approach is highly systematic and organised. They update you on a time-to-time basis as per your requirement. While connecting with them you will get the benefit of a seamless UI experience and a team who has a working approach systematically. 
                        </div>
               ...
               <div class="col-lg-4 col-md-6 col-sm-12 col-12 pt-md-5 pb-md-0 mb-md-0 pb-5 mb-5 servies-box">
                  <div class="row align-items-center justify-content-center text-center px-md-4 px-0 h-100 pt-md-5">
                     ...
                     <div class="row position-relative pt-5 px-3 bg-white brs">
                           ...
                           <div class="col-12 fs-md-17 fs-sm-20 fs-18 text-theme3 fw-900 py-md-0 tz" style="--tz:30px;">Smooth Communication</div>
                           <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-600 py-md-2 pb-md-5 pb-4 tz" style="--tz:30px;"> The IMG team focuses on every detail that you provide for your project. Their communication has always been smooth with their clients and you will never have to worry about any project changes during the time of the project development process.</div>
                           <div class="col-12">
                     ...
                     <div class="row text-center pt-4 pb-5 h-100">
                        ...
                        <div class="col-12">
                           <div class="row">
                              ...
                              <div class="col-12 fw-900 fs-md-17 fs-sm-16 fs-15 text-uppercase lh-normal benefits_heads text-theme3">100% Customisable</div>
                              <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3"> We obtain every single detail and Perform a detailed analysis based on your stated need. Focusing on your Idea and converting it into a fruitful reality is the task that IMG works on.
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row text-center pt-4 pb-5 h-100">
                        ...
                        <div class="col-12">
                           <div class="row">
                              ...
                              <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">Building the extremely influenceable Ui/Ux experience which will connect your business with the user without any complexity. Influential user activity implementation with the process that will tangle the user base.
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row text-center pt-4 pb-5 h-100">
                        ...
                        <div class="col-12">
                           <div class="row">
                              ...
                              <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">Power-packing your e-commerce platform with the highest level of security makes every activity on your eCommerce website more safe and secure. Taking all the measures to maintain security and build scalability. 
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row text-center pt-4 pb-5 h-100">
                        ...
                        <div class="col-12">
                           <div class="row">
                              ...
                              <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3"> Approaching the analytics where data is collected and it will be used to analyse the recent activity on your eCommerce website. It will help your business in finding new sales opportunities and know how your website is performing. 
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row text-center pt-4 pb-5 h-100">
                        ...
                        <div class="col-12">
                           <div class="row">
                              ...
                              <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3"> We deliver end-to-end support after sales as well. We assure you that we are available with you 24/7 and you can connect with our team after the launch of your website if any problem arises. </div>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row py-4 align-items-center">
                  <div class="col-12">
                     <div class="row">
                        ...
                        <div class="col-12 fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">It is difficult to choose the right and suitable option and in this competitive environment, you need to connect with one of the best eCommerce website development companies in Alwar. But before that, you need to consider these factors-
                           <ul>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">Determine your requirements</li>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">Important to check that prices are within your budget</li>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">How efficient are they?</li>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">Are they providing SEO optimization or not?</li>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">What is their process of implementation?</li>
                           </ul>
                        </div>
                        <div class="col-12 fw-bold fs-md-17 fs-sm-16 fs-15 text-black mt-3">We are committed to fulfilling every requirement keeping in mind to satisfy our customer's needs.
                           <ul>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">Our Developers directly handle all the technical specifications and the technical requirements your project needs.
</li>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">We ensure that our developers have the required resources to make a customer project enhanced and better.
</li>
                              <li class="fw-600 fs-md-17 fs-sm-16 fs-15 text-muted mt-3">We deliver professional websites to our customers that are easy to access. 
</li>
                           </ul>
                        </div>
                        <div class="col-12 fw-bold fs-md-17 fs-sm-16 fs-15 text-muted mt-3">We deliver specialised services with the motive to outline targeted brands in the minds of site users. Our eCommerce website design services assist you in generating business and leads. E-commerce website development has emerged as an important aspect in the retail industry prevailing parallel to the conventional market. 
                        </div>
                     </div>
                  </div>
               </div>
