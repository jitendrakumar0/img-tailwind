...
@if($xmas)
    ...
    <script src="public{{ mix('/tailwind/js/festival-decor/snowfall-xmas/snowfall-xmas.js') }}" defer></script>
@endif
...
@if($newYear)
    ...
    <script src="public{{ mix('/tailwind/js/festival-decor/newYear/newYear.js') }}" defer></script>
@endif
