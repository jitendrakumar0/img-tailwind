...
@push('styles')
<!-- Preload LCP image -->
{{-- <link rel="preload" as="image" href="{{asset('public'.mix('/tailwind/img/unlock-access-to-bespoke-apps-and-product-innovation-with-us.webp'))}}" onload="this.onload=null;this.rel='stylesheet'"> --}}
@endpush
