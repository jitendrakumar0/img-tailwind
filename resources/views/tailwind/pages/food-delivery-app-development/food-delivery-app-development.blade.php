...
<div class="relative md:py-16 py-8  select-none overflow-hidden">
    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-24 md:px-28 xl:px-40 z-10">
        ...
        <div class="md:pt-20 pt-12 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[54%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2    sm:before:content-[''] sm:before:absolute sm:before:border-[3px] sm:before:border-zinc-600 sm:before:inset-0 sm:before:top-[54%] sm:before:left-[-69%] sm:before:border-r-0  sm:before:sm:w-[140px] sm:before:w-[135px]  sm:before:h-[150px] sm:before:h-[156px] sm:before:lg:h-[186px] sm:before:rounded-tl-[18px] sm:before:rounded-bl-[18px]">
                <div class="iconImg h-[35px] sm:h-[40px] lg:h-[50px] w-[35px] sm:w-[40px] lg:w-[50px] mx-auto">
                ...
                <div class="cardHeading bg-white pt-2 text-base text-[13px] lg:text-[18px] text-[#3f3f3f] font-bold z-30 relative">
                    Delivery Details
                </div>
                <div class="text-sm lg:text-base opacity-60 font-semibold pt-2 leading-[120%] sm:px-3 text-ellipsis line-clamp-2">
            ...
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[54%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2">
                ...
                <div class="cardHeading bg-white pt-2 text-base text-[13px] lg:text-[18px] text-[#3f3f3f] font-bold">
                    Order Placement
                </div>
                <div class="text-sm lg:text-base opacity-60 font-semibold pt-2 leading-[120%] sm:px-3 text-ellipsis line-clamp-2">
        ...
        <div class="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
            ...
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:border-[3px] sm:after:border-zinc-600 sm:after:inset-0 sm:after:top-[54%] sm:after:left-[100%] sm:after:border-l-0 sm:after:w-[90px] sm:after:sm:w-[140px] sm:after:h-[158px] sm:after:lg:h-[182px] sm:after:rounded-tr-[18px] sm:after:rounded-br-[18px]">
                <div class="iconImg h-[35px] sm:h-[40px] lg:h-[50px] w-[35px] sm:w-[40px] lg:w-[50px] mx-auto">
        ...
        <div class="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[52%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2     sm:before:content-[''] sm:before:absolute sm:before:h-[3px] sm:before:w-[116px] sm:before:bg-zinc-600 sm:before:top-[52%] sm:before:left-[-113px] sm:before:-z-10 sm:before:translate-y-1/2">
                ...
                <div class="absolute h-[16px] w-[16px] top-[48%] left-[-126px]">
            ...
            <div class="card w-1/3 md:w-1/4 text-center relative">
                <div class="iconImg h-[35px] sm:h-[40px] lg:h-[50px] w-[35px] sm:w-[40px] lg:w-[50px] mx-auto hover:stroke-white">
