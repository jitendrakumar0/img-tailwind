...
<div class="relative pt-16 md:pt-20 lg:pt-32 select-none overflow-hidden">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:pl-48 lg:pr-52 z-[1] relative py-8 sm:py-10 md:py-14 lg:py-20 text-center">


        <div class="text-xl md:text-2xl mb-3">
            Build Online Food Delivery Apps and Unlock 67% Savings
        </div>
        <div class="heading text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-[#111457]  leading-[120%] mb-5">
        ...
        <div class="mt-8 flex items-center flex-wrap gap-y-3 gap-3 md:justify-around">
            <div class="flex items-center gap-3">
                <div class="icon h-[16px] sm:h-[20px] md:h-[25px]  w-[16px] sm:w-[20px] md:w-[25px]">
                    <img src="{{asset('public'.mix('/tailwind/img/rightBlue.svg'))}}" alt="thanku" class="img-fluid h-full w-full ">
                </div>
                <div class="text-[12px] sm:text-base md:text-lg font-bold text-[#111457]">Get solution Delivered in 2 week</div>
            </div>
            <div class="flex items-center gap-3 ">
                <div class="icon h-[16px] sm:h-[20px] md:h-[25px]  w-[16px] sm:w-[20px] md:w-[25px]">
                    <img src="{{asset('public'.mix('/tailwind/img/rightBlue.svg'))}}" alt="thanku" class="img-fluid h-full w-full ">
                </div>
                <div class="text-[12px] sm:text-base md:text-lg font-bold text-[#111457]">Dedicated team of food delivery App Developer</div>
            </div>
        </div>
        <div class="mt-4 flex items-center flex-wrap gap-y-3 gap-3 md:justify-around">
            <div class="flex items-center gap-3">
                ...
                <div class="text-[12px] sm:text-base md:text-lg font-bold text-[#111457]">Proven Expertise & Cost Effective</div>
            </div>
            <div class="flex items-center gap-3 ">
                <div class="icon h-[16px] sm:h-[20px] md:h-[25px]  w-[16px] sm:w-[20px] md:w-[25px]">
                    <img src="{{asset('public'.mix('/tailwind/img/rightBlue.svg'))}}" alt="thanku" class="img-fluid h-full w-full ">
                </div>
                <div class="text-[12px] sm:text-base md:text-lg font-bold text-[#111457]">100% customizable solutions</div>
            </div>
        </div>
        <div class="mt-4 flex items-center flex-wrap gap-y-3 gap-3 md:justify-around">
            <div class="flex items-center gap-3">
                ...
                <div class="text-[12px] sm:text-base md:text-lg font-bold text-[#111457]">Fully Signed NDA & Code Security</div>
            </div>
        </div>
