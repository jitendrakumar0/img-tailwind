...
>>>>>>> origin/Shubham
    ...
    <div class="mx-auto max-w-7xl px-12 sm:px-20 lg:px-32 xl:px-40 z-10">
        ...
        <div class="pt-20 px-20 w-full flex items-center justify-between ">
            <div class="card w-1/4 text-center relative after:content-[''] after:absolute after:h-[3px] after:w-[100px] after:bg-zinc-600 after:top-[54%] after:right-[-90px] after:-z-10 after:translate-y-1/2    before:content-[''] before:absolute before:border-[3px] before:border-zinc-600 before:inset-0 before:top-[54%] before:left-[-69%] before:border-r-0  before:sm:w-[140px] before:w-[135px]  before:h-[150px] before:sm:h-[180px] before:md:h-[180px] before:lg:h-[214px] before:rounded-tl-[18px] before:rounded-bl-[18px]">
            ...
            <div class="card w-1/4 text-center relative after:content-[''] after:absolute after:h-[3px] after:w-[100px] after:bg-zinc-600 after:top-[54%] after:right-[-90px] after:-z-10 after:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
        ...
        <div class="pt-10 px-20 w-full flex items-center justify-between ">
            <div class="card w-1/4 text-center relative after:content-[''] after:absolute after:h-[3px] after:w-[100px] after:bg-zinc-600 after:top-[54%] after:right-[-90px] after:-z-10 after:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
            ...
            <div class="card w-1/4 text-center relative after:content-[''] after:absolute after:border-[3px] after:border-zinc-600 after:inset-0 after:top-[54%] after:left-[100%] after:border-l-0 after:w-[90px] after:sm:w-[140px] after:h-[150px] after:sm:h-[195px] after:md:h-[180px] after:lg:h-[214px] after:rounded-tr-[18px] after:rounded-br-[18px]">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
        ...
        <div class="pt-10 px-20 w-full flex items-center justify-between ">
            <div class="card w-1/4 text-center relative after:content-[''] after:absolute after:h-[3px] after:w-[100px] after:bg-zinc-600 after:top-[56%] after:right-[-90px] after:-z-10 after:translate-y-1/2     before:content-[''] before:absolute before:h-[3px] before:w-[116px] before:bg-zinc-600 before:top-[56%] before:left-[-113px] before:-z-10 before:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
                ...
                <div class="absolute h-[16px] w-[16px] top-[52%] left-[-126px] mt-[2px]">
                    <img src="{{asset('public'.mix('/tailwind/img/leftIcon.svg'))}}" alt="thanku" class="img-fluid h-full w-full ">
                </div>
            </div>
            <div class="card w-1/4 text-center relative after:content-[''] after:absolute after:h-[3px] before:mt-[2px] after:w-[100px] after:bg-zinc-600 after:top-[56%] after:right-[-90px] after:-z-10 after:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto ">
            ...
            <div class="card w-1/4 text-center relative">
