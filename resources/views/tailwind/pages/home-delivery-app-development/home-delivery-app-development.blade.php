            ...
            <div class="flex items-center flex-wrap row-flex relative">
                <div class="lg:w-1/2 w-full px-8 ">
                    <div class="img relative">
                        <img class=" lg:h-full lg:w-full md:h-[500px] mx-auto [-webkit-mask-image:url('../img/mask/mask_7.webp')] [-webkit-mask-size:contain] [-webkit-mask-position:center_center] [-webkit-mask-repeat:no-repeat]" src="{{asset('public'.mix('/tailwind/img/about/aboutimg.webp'))}}" alt="beifit"> 
                    </div>
                </div>
                <div class="relative z-20 lg:w-1/2 w-full">
                    <p class="mt-4 max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black lg:text-start text-center"><span class="font-normal">Get More</span> <span class="font-bold bg-gradient-to-r from-gray-500 via-sky-600 to-gray-500 bg-clip-text text-transparent">Insight About Us</span></p>
                    <p class="mt-4 text-sm md:text-base leading-7 text-slate-600 lg:text-start text-center">IMG is one of the trusted and Promising IT service providers delivering web development, mobile app development and custom software development services to start-up, mid level organizations and various big enterprises aiming to proffer digital success with robust applications. We have a proven track record in having 1200+ satisfied business clients and individuals from different verticals. We are committed to establish a long lasting and happy relationship with our clients.</p>
                
                    <div class="flex items-center lg:justify-start justify-center mt-6 flex-wrap gap-3 w-full  lg:w-[90%]">
            ...
            <div class="flex mt-2 mx-auto md:mt-10 pt-7 sm:pt-8 lg:mx-0 justify-center flex-wrap">
                ...
                <div class="lg:w-1/3 p-7md:w-1/2 w-full p-4">
                    <div class="w-full p-8 border rounded-br-none rounded-3xl shadow-md relative overflow-hidden bg-white before:bg-white/5700 before:absolute befowhite/10t[''] before:w-full before:h-full before:bottom-[-70%] before:left-[-70%] before:-z-70 before:rounded-full md:before:hover:rounded-none md:before:hover:left-0 md:before:hover:bottom-0">
                        ...
                        <div class=" text-[#337ca6]  whitespace-nowrap mt-1 relative z-20 font-semibold text-sm">  Focus on self-development</div>
            ...
            <div class=" md:w-1/2 lg:w-1/3 p-7p-3 w-full">
                <div class="flex flex-col relative bg-white p-6 z-10 overflow-hidden shadow-2xl  h-full rounded-br-none rounded-xl before:absolute  before:duration-300 before:content:-[''] before:w-0 before:h-0 before:bg-purple-200 before: before:bottom-0 before:right-0 before:z[-4] md:hover:before:w-full  md:hover:before:h-full  md:hover:before:top-0  md:hover:before:left-0 md:hover:before:rounded-none">
                    ...
                    <div class="absolute h-full w-full -z-20 top-0 left-0 ">
                        <svg xmlns='http://www.w3.org/2000/svg'   viewBox='0 0 200 200'><rect fill='#ffffff' width='200' height='200'/><polygon  fill='#CEA5F1' fill-opacity='0.04' points='100 0 0 100 100 100 100 200 200 100 200 0'/></svg>
                    </div>
                </div>
            </div>
...
<div class="xl:pt-32 xl:pb-32 md:pb-36 relative overflow-hidden z-[1] bg-slate-900 select-none">
    ...
    <div class="absolute z-0 -top-52 left-1/2 -translate-x-1/2 transform-gpu blur-3xl sm:top-[-28rem] sm:ml-16 sm:translate-x-0 sm:transform-gpu pointer-events-none" aria-hidden="true">
        <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-blue-900 to-blue-700 opacity-20" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div> 
    <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
        <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 z-10 xl:mt-24 xl:mb-24 md:mb-32 relative z-20">
        <div class="flex flex-row flex-wrap items-center jsuttify-center md:py-20 sm:py-16 py-12 h-full w-full">
            <div class="xl:w-2/5 w-full">
                <div class="flex items-center xl:mt-9 bg-white shadow-md rounded-lg rounded-br-none p-3 h-[230px] w-[230px] justify-center  mx-auto">
                    <img src="{{asset('public'.mix('/tailwind/img/about/top-mobile-app-development-company.webp'))}}" alt="process" class="h-full w-full">
                </div>
                <div class="text-white sm:text-xl text-lg font-semibold text-center mt-4 lg:px-5">Review IMG GLOBAL INFOTECH PRIVATE LIMITED ON DesignRush</div>
            ...
            <div class="flex items-center justify-center relative proceingCard  text-center flex-wrap  md:after:absolute md:after:w-[300px] md:after:h-[300px] md:after:bg-blue-200  md:after:rounded-full">
                ...
                <div class="agal-list z-10 relative">
                    <div class="agile-child md:mt-0 mt-14 md:child-1 group md:rotate-[162deg] md:absolute md:right-[-46px] md:bottom-[43px] md:duration-300">
                        <div class="inner-agilee realtive md:w-[350px] md:h-[280px]  md:overflow-hidden md:bg-gray-100 md:group-hover:bg-pink-200/90 md:shadow-slate-100 md:md:shadow-md md:transform md:transition-all md:md:duration-300 md:md:ease-in-out md:md:hover:scale-105 md:md:[clip-path:polygon(50%_0%,_0%_100%,_100%_100%);]   md:md:md:before:absolute md:md:md:before:rounded-full md:md:md:before:top-[-46px] md:before:left-[31px] md:md:before:rotate-[-120deg] before:w-[213px] before:h-[84px] md:before:bg-pink-800 bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl md:p-0 p-4">
                            <div class="counter-div text-white text-lg font-bold text-center rotate-180 mt-10 md:block hidden">
                                01
                            </div>
                        
                            <div class="agile-content-wrapper md:absolute md:h-full md:top-0 md:pt-5 md:left-12 md:right-6 md:w-[240px] md:transform md:rotate-180 md:z-9  md:text-center">
                                <div class="md:hidden  h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:!bg-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-30px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white " xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                                
                                <div class="md:text-slate-900 md:text-xl md:font-bold md:leading-tight text-state-900 text-lg duration-300 md:group-hover:pt-0 pt-10 md:pt-0 font-bold relative pb-4 md:pb-0 text-center md:before:hidden before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Research</div>
                                <div class="text-black/70 text-sm overflow-ellipsis line-clamp-4 md:px-6 mt-2">We start by conducting thorough research to understand your target audience, market trends, and competition. outstanding software .</div>
                            </div>	
                        </div>
                    </div>
                    <div class="agile-child md:mt-0 mt-14 md:child-1 md:rotate-[224deg] md:absolute md:left-[-113px] md:bottom-[8px] group md:duration-300">
                        <div class="inner-agilee realtive md:w-[350px] md:h-[280px] relative md:overflow-hidden md:bg-gray-100 md:group-hover:bg-green-200/90 md:shadow-slate-100 md:shadow-md md:transform md:transition-all md:duration-300 md:ease-in-out md:hover:scale-105 md:[clip-path:polygon(50%_0%,_0%_100%,_100%_100%);]   md:before:absolute md:before:rounded-full md:before:top-[-46px] md:before:left-[31px] md:before:rotate-[-120deg] md:before:w-[213px] md:before:h-[84px] md:before:bg-green-800 bg-white  z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl md:p-0 p-4">
                            <div class="counter-div text-white text-lg md:block hidden font-bold text-center rotate-180 mt-10 ">
                                02
                            </div>
                            <div class="agile-content-wrapper md:absolute md:h-full md:top-0 md:pt-5 md:left-12 md:right-6 md:w-[240px] md:transform md:rotate-180 md:z-9  md:text-center">
                                <div class="md:hidden  h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:!bg-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-30px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white " xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                                
                                <div class="md:text-slate-900 md:text-xl md:font-bold md:leading-tight  text-state-900 text-lg duration-300 md:group-hover:pt-0 pt-10 md:pt-0 font-bold relative pb-4 md:pb-0 text-center md:before:hidden before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Plan</div>
                                <div class="text-black/70 text-sm overflow-ellipsis line-clamp-4 md:px-6 mt-2">Based on the research findings, we work closely with you to define the app's goals, features, and functionalities. outstanding software .</div>
                            </div>	
                        </div>
                    </div>
                    <div class="agile-child md:mt-0 mt-14 child-1 md:rotate-[281deg] md:absolute md:left-[-48px] md:bottom-[-180px] group duration-300">
                        <div class="inner-agilee realtive md:w-[350px] md:h-[280px] relative md:overflow-hidden md:bg-gray-100 md:group-hover:bg-sky-200/90 md:shadow-slate-100 md:shadow-md md:transform md:transition-all md:duration-300 md:ease-in-out md:hover:scale-105 md:[clip-path:polygon(50%_0%,_0%_100%,_100%_100%);]   md:before:absolute md:before:rounded-full md:before:top-[-46px] md:before:left-[31px] md:before:rotate-[-120deg] md:before:w-[213px] md:before:h-[84px] md:before:bg-sky-800 bg-white  z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl md:p-0 p-4">
                            <div class="counter-div text-white text-lg md:block hidden font-bold text-center rotate-[70deg] mt-10">
                                03
                            </div>
                            <div class="agile-content-wrapper md:absolute md:h-full md:top-16 md:pt-5 md:left-4 md:right-0 md:w-[208px] md:transform md:rotate-[64deg] md:z-9  md:text-center">
                                <div class="md:hidden  h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:!bg-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-30px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white " xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>

                                
                                <div class="md:text-slate-900 md:text-xl md:font-bold md:leading-tight text-state-900 text-lg duration-300 md:group-hover:pt-0 pt-10 md:pt-0 font-bold relative pb-4 md:pb-0 text-center md:before:hidden before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Implement</div>
                                <div class="text-black/70 text-sm overflow-ellipsis line-clamp-4 md:px-6 mt-2">Our skilled development team begins the implementation phase, where we build the app's architecture, database, and backend infrastructure.</div>
                            </div>	
                        </div>
                    </div>
    
                    <div class="agile-child md:mt-0 mt-14 child-1 md:rotate-[-20deg] md:absolute md:left-[-172px] md:top-[46px] group duration-300">
                        <div class="inner-agilee realtive md:w-[350px] md:h-[280px] relative md:overflow-hidden md:bg-gray-100 md:group-hover:bg-purple-200/90 md:shadow-slate-100 md:shadow-md md:transform md:transition-all md:duration-300 md:ease-in-out md:hover:scale-105 md:[clip-path:polygon(50%_0%,_0%_100%,_100%_100%);]   md:before:absolute md:before:rounded-full md:before:top-[-46px] md:before:left-[31px] md:before:rotate-[-120deg] md:before:w-[213px] md:before:h-[84px] md:before:bg-purple-800 bg-white  z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl md:p-0 p-4">
                            <div class="counter-div text-white text-lg md:block hidden font-bold text-center rotate-0 mt-10">
                                04
                            </div>
                            <div class="agile-content-wrapper md:absolute md:h-full md:top-32 md:pt-5 md:left-8 md:right-6 md:w-[270px] md:transform md:rotate-0 md:z-9  md:text-center">
                                <div class="md:hidden  h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:!bg-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-30px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white " xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                                
                                <div class="md:text-slate-900 md:text-xl md:font-bold md:leading-tight text-state-900 text-lg duration-300 md:group-hover:pt-0 pt-10 md:pt-0 font-bold relative pb-4 md:pb-0 text-center md:before:hidden before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Testing</div>
                                <div class="text-black/70 text-sm overflow-ellipsis line-clamp-4 md:px-7 mt-2">Quality assurance is a critical step in our process. We conduct various tests, including functional testing, usability testing, performance testing.</div>
                            </div>	
                        </div>
                    </div>
                    <div class="agile-child md:mt-0 mt-14 child-1 md:rotate-[41deg] md:absolute md:right-[27px] md:top-[4px] group duration-300">
                        <div class="inner-agilee realtive md:w-[350px] md:h-[280px] relative md:overflow-hidden md:bg-gray-100 md:group-hover:bg-blue-200/90 md:shadow-slate-100 md:shadow-md md:transform md:transition-all md:duration-300 md:ease-in-out md:hover:scale-105 md:md:[clip-path:polygon(50%_0%,_0%_100%,_100%_100%);]   md:before:absolute md:before:rounded-full md:before:top-[-46px] md:before:left-[31px] md:before:rotate-[-120deg] md:before:w-[213px] md:before:h-[84px] md:before:bg-blue-800 bg-white  z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl md:p-0 p-4">
                            <div class="counter-div text-white text-lg md:block hidden font-bold text-center rotate-0 mt-10">
                                05
                            </div>
                            <div class="agile-content-wrapper md:absolute md:h-full md:top-32 md:pt-5 md:left-7 md:right-6 md:w-[270px] md:transform md:rotate-0 md:z-9  md:text-center">
                                
                                <div class="md:hidden  h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:!bg-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-30px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white " xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                                <div class="md:text-slate-900 md:text-xl md:font-bold md:leading-tight text-state-900 text-lg duration-300 md:group-hover:pt-0 pt-10 md:pt-0 font-bold relative pb-4 md:pb-0 text-center md:before:hidden before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Optimize</div>
                                <div class="text-black/70 text-sm overflow-ellipsis line-clamp-4 md:px-7 mt-2">We continually optimize the app to enhance its performance, speed, and user experience. outstanding software .</div>
                            </div>	
                        </div>
                    </div>
                    <div class="agile-child md:mt-0 mt-14 child-1 md:block hidden md:rotate-[103deg] md:absolute md:right-[85px] md:bottom-[-105px] group duration-300">
                        <div class="inner-agilee md:realtive md:w-[350px] md:h-[280px] relative md:overflow-hidden md:bg-gray-100 md:group-hover:bg-orange-200/90 md:shadow-slate-100 md:shadow-md md:transform md:transition-all md:duration-300 md:ease-in-out md:hover:scale-105 md:[clip-path:polygon(50%_0%,_0%_100%,_100%_100%);]   md:before:absolute md:before:rounded-full md:before:top-[-46px] md:before:left-[31px] md:before:rotate-[-120deg] md:before:w-[213px] md:before:h-[84px] md:before:bg-orange-800 bg-white  z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl md:p-0 p-4">
                            <div class="counter-div text-white text-lg md:block hidden font-bold text-center rotate-180 mt-10">
                                06
                            </div>
                            <div class="agile-content-wrapper md:absolute md:h-full md:top-0 md:pt-5 md:left-12 md:right-6 md:w-[240px] md:transform md:rotate-180 md:z-9  md:text-center">
                                ...
                                <div class="md:text-slate-900 md:text-xl md:font-bold md:leading-tight  text-state-900 text-lg duration-300 md:group-hover:pt-0 pt-10 md:pt-0 font-bold relative pb-4 md:pb-0 text-center md:before:hidden before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Optimize</div>
                                <div class="text-black/70 text-sm overflow-ellipsis line-clamp-4 md:px-6 mt-2">We continually optimize the app to enhance its performance, speed, and user experience. outstanding software .</div>
                            </div>	
                        </div>
                    </div> 
                </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 select-none">
        ...
        <div class="flex flex-wrap items-stretch pt-4 relative z-50">
            <div class="lg:w-1/4 w-full relative -z-10 sm:w-1/2 p-4">
                <div class=" w-full h-full before:!ease-in-out group before:duration-1000 p-3 bg-gray-100 relative before:absolute shadow-lg rounded-br-none rounded-xl before:rounded-br-none before:rounded-xl before:content-[''] before:border-2 before:duration-00 before:border-inset before:h-[0px] group before:w-[0px] before:z-[-90] before:border-blue-600 before:top-[12px] before:left-[12px] hover:before:h-full  hover:before:w-full after:bg-blue-300 after:rounded-xl after:rounded-br-none after:rounded-tr-none after:z-0 after:w-[10px] after:absolute after:h-full after:top-[0px] after:left-[0px] after:duration-300">
                    <div class="h-auto duration-1000 w-full flex flex-col relative z-10 p-3">
                        <div class="flex">
                        ...
                        <div class="w-full h-full">
                                <div class="bg-[rgb(17_24_39)] opacity-100 rounded-3xl rounded-br-none relative overflow-hidden w-full h-full">
                                    <img class=" overflow-hidden absolute inset-0 w-full h-full object-cover [filter:saturate(0)]" src="{{asset('public'.mix('/tailwind/img/about/aboutimg.webp'))}}" alt="beifit">
                                        ...
                                        <div class="text-md text-normal text-white">
                                            With our ERP developed platforms, every user of the system can generate custom reports with ease. So, you can access and examine data faster than ever to make vital business decisions more quickly.
                                        </div>
                                        <div class="py-5">
                                            <a href="https://www.imgglobalinfotech.com/request-a-quote.php" class="rounded-md rounded-br-none bg-white px-5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Explore</a>
                                        </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full">
        <div class="absolute inset-y-0 hidden w-full min-w-[1360px] bg-[url('../img/beams1.webp?id=31a5defd3b15daed788cf2bd1997fc88')] bg-[length:2000px_100%] bg-[position:calc(50%_+_220px)_-50px] bg-no-repeat lg:block pointer-events-none"></div>
            <div class="flex items-center flex-wrap row-flex relative">
                ...
                <div class="relative z-20 lg:w-1/2 w-full">
                    <p class="mt-4 max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black lg:text-start text-center"><span class="font-normal">We provide specialised Android app development</span> <span class="font-bold bg-gradient-to-r from-gray-500 via-sky-600 to-gray-500 bg-clip-text text-transparent">services for all platforms</span></p>
                    <p class="mt-4 text-sm md:text-base leading-7 text-slate-600 lg:text-start text-center">We are custom android app development company with years of experience working with different Android devices and platforms is demonstrated by the portfolio of Android mobile apps we have developed. We have been able to delve deeply into the Android world thanks to the full-cycle bespoke android mobile app development methodology that we employ. Additionally, we have looked into every option, including Android TV, Android Wear, Android tablets, and smartphones.</p>
                    <p class="mt-4 text-sm md:text-base leading-7 text-slate-600 lg:text-start text-center">We deliver user-friendly, intuitive apps using our main tech stack, which is tried-and-true software for developing Android apps. Hire expert Android app developers are aware of the formula for creating apps that receive over a million downloads from the Google Play Store. Our Android native app development company follows simple procedure that has consistently shown to be effective over time. Beyond that, we can assist you in developing a prototype, coming up with a marketing plan, providing ongoing support for your product after it is released, and more.</p>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full">
        <div class="md:pt-3 relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10">
            <p class="mt-4 max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-center">
                <span class="font-normal">Android App  </span> 
                <span class="font-bold bg-gradient-to-r from-gray-500 via-sky-600 to-gray-500 bg-clip-text text-transparent">Development Services </span>
            </p>
            <div class="md:text-base text-sm text-black/70 mt-3 mb-lg-1 text-center">
                Next-Gen Android App Development Beside 
            </div>
        </div>
        <div class="w-full block sm:mt-12 mt-8">
            <div class="flex flex-row flex-wrap w-full">
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        <div class="overlay relative sm:group-hover:h-32 before:duration-300 duration-300 before:absolute before:w-full before:rounded-tr-4xl before:h-full before:bg-no-repeat before:right-0 before-bottom-0 before:left-0  before:bg-[url('../img/carers/overlay-shape2.png')]  before:bg-bottom before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:sm:group-hover:duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="absolute  bottom-0 left-0 duration-300 opacity-0 h-0 sm:group-hover:h-6 overflow-hidden sm:group-hover:opacity-100" width="100%" viewBox="0 0 100 100" version="1.1" preserveAspectRatio="none" height="36px" width="100%" style="fill:#fff"><path stroke-width="0" d="M0 0 C50 100 50 100 100 0  L100 100 0 100"></path></svg>
                        </div>
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Enterprise Android App Development  </div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0">
                                Android provides organizations with a secure and flexible mobility platform—combining devices, apps, and management.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Android Full-cycle App Development   </div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0">
                                An Android activity goes through six major lifecycle stages or callbacks. These are: onCreate(), onStart(), onResume(), onPause(), onStop(), and onDestroy().</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                ...
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20">Android App  Migration </div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0">                            
                    Install your app on your device or emulator, and run tests. Focus on system behavior changes, and work through all app flows.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                ...
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20"> App  Testing </div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0"> Testing and quality assurance: Conducting thorough testing to identify and fix any bugs, glitches, or compatibility issues in the app.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                ...
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20"> Maintenance  & Support</div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0">Providing ongoing support and updates for the app, including bug fixes, feature enhancements, and compatibility updates with new Android versions.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                ...
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20"> UI/UX App  Design</div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0"> Creating visually appealing and user-friendly interfaces for the app, ensuring a smooth and intuitive user experience.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                ...
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20"> Android App API  Integrations</div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0"> Creating server-side infrastructure, APIs, and databases to support the app's functionality, if required.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
                ...
                <div class="lg:w-1/4 md:w-1/3 sm:w-1/2 w-full p-3 py-9">
                    <div class="bg-white  relative z-1 shadow-2xl duration-300 !rounded-tl-4xl group sm:hover:rounded-tr-4xl sm:h-[280px]">
                        ...
                        <div class="p-6 duration-300">
                            <div class="h-16 w-16 flex items-center justify-center rotate-45 rounded-xl shadow-md bg-gradient-to-l sm:group-hover:from-white sm:group-hover:to-white from-purple-600 to-blue-500 absolute duration-300 md:group-hover:top-[30px] top-[-35px] left-0 p-3 right-0 mx-auto"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="flex items-center jsutify-center text-white sm:group-hover:text-purple-600 sm:group-hover:to-blue-600" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.85.63-3.54 1.69-4.9L7.59 9h2.83L7.1 5.69A7.924 7.924 0 0112 4c4.41 0 8 3.59 8 8 0 1.85-.63 3.54-1.69 4.9l-1.9-1.9h-2.83l3.31 3.31A7.874 7.874 0 0112 20c-4.41 0-8-3.59-8-8z"></path><path d="M14.25 14l-1.5-2 1.5-2h-1.5L12 11l-.75-1h-1.5l1.5 2-1.5 2h1.5l.75-1 .75 1zM8 10l-.75 1-.75-1H5l1.5 2L5 14h1.5l.75-1L8 14h1.5L8 12l1.5-2zM16 14l.75-1 .75 1H19l-1.5-2 1.5-2h-1.5l-.75 1-.75-1h-1.5l1.5 2-1.5 2z"></path></svg></div>
                            <div class="text-state-900 text-lg duration-300 sm:group-hover:pt-0 pt-10 font-bold relative pb-5 text-center before:absolute before:bg-gradient-to-r before:from-purple-600 before:to-blue-500 before:bottom-0 before:left-0 before:right-0 before:mx-auto before:h-1 before:w-20"> Android M-commerce  Applications</div>
                            <div class="text-black text-sm mt-3 text-center z-40 relative text-ellipsis line-clamp-4 opacity-100 duration-300 sm:group-hover:opacity-0"> Mobile commerce include mobile banking, in-app purchasing, digital marketplaces, and digital wallets.</div>
                            <div class=" mt-4 overflow-hidden duration-300 absolute  left-0 right-0 bottom-[-30px] opacity-0 mx-auto sm:group-hover:opacity-100 sm:group-hover:bottom-[22px]">
                                <a href="javascript:;" class="duration-300 group text-decoration-none flex items-center justify-center text-[#006cff] font-semibold text-sm"> Learn More <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" class="text-[#006cff] flex items-center text-sm h-3 w-3 ms-1 sm:group-hover:ms-2 duration-300 " xmlns="http://www.w3.org/2000/svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path></svg></a>
                            </div>
                        </div>
