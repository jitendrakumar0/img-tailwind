...
<div class="relative pt-16 md:pt-20 lg:pt-32 select-none overflow-hidden">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:pl-48 lg:pr-52 z-[1] relative py-8 sm:py-10 md:py-14 lg:py-16 text-center">
        ...
        <div class="mt-8 flex items-center flex-wrap gap-y-3 gap-3 md:justify-center mx-auto">
        ...
        <div class="absolute hidden lg:block top-[-2%] left-[-3%] h-[220px] w-[249px]">
            <img src="{{asset('public'.mix('/tailwind/img/pizzaShimg.png'))}}" alt="thanku" class="img-fluid h-full w-full ">
        </div>
        <div class="absolute hidden lg:block bottom-[-1%] right-[-34px] h-[175px] w-[240px]">
...
<div class="relative py-16 md:py-20 my-20 lg:py-32 select-none overflow-hidden">
    <div class="text-black/10 ">
...
>>>>>>> origin/Shubham
    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-24 md:px-32 xl:px-40 z-10">
        <div class="text-[#111457] text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center font-bold">
            How Does Our Food Delivery Solution Works?
        </div>
        <div class="pt-20 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
