...
<div class="mx-auto max-w-7xl px-6 lg:px-8  z-[1] relative bg-gray-100 py-10">
    <div class="md:pt-3 relative container mx-auto max-w-7xl md:px-6 lg:px-8 z-10">
        <p class="mt-4 max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black">
    ...
    <div class="flex flex-wrap mt-10 ">
        <div class="w-4/12 p-4">
            <div class="relative block bg-white shadow-md rounded-b-lg p-6 pt-12">
                <div class="font-bold text-slate-900 text-xl relative before:absolute before:left-0 before:top-[-16px] before:h-[4px] before:w-[40px] before:bg-gradient-to-r before:from-blue-600 before:to-blue-300 ">Learning & Development</div>
                ...
                <div class="h-16 w-16 bg-white rounded-md absolute right-0 top-0 p-3 shadow">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="text-orange-500 " xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0zm0 0h24v24H0V0z"></path><path d="M22 9V7h-2V5c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-2h2v-2h-2v-2h2v-2h-2V9h2zm-4 10H4V5h14v14zM6 13h5v4H6v-4zm6-6h4v3h-4V7zM6 7h5v5H6V7zm6 4h4v6h-4v-6z"></path></svg>
                </div>
            </div>
        </div>
        <div class="w-4/12 p-4">
            <div class="relative block bg-white shadow-md rounded-b-lg p-6 pt-12">
                <div class="font-bold text-slate-900 text-xl">Learning & Development</div>
                <div class="text-black text-sm mt-2 text-ellipsis line-clamp-4 ">Describes work staff to develop academic practices. Still, many leaders struggle to keep their developers on a lifelong path of skill development</div>
            </div>
        </div>
        <div class="w-4/12 p-4">
