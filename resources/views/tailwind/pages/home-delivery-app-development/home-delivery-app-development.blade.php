        ...
        <div class="mt-8 flex items-center flex-wrap gap-y-3 gap-3 justify-center mx-auto">
            <div class="flex items-center justify-center gap-3">
                <div class="icon h-[14px] sm:h-[20px] md:h-[18px]  w-[14px] sm:w-[14px] md:w-[18px]">
                    <img src="{{asset('public'.mix('/tailwind/img/rightBlue.svg'))}}" alt="thanku" class="img-fluid h-full w-full ">
                </div>
...
<div class="relative md:py-16 py-12  select-none overflow-hidden">
    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-24 md:px-32 xl:px-40 z-10">
        ...
        <div class="md:pt-20 pt-12 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[54%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2    sm:before:content-[''] sm:before:absolute sm:before:border-[3px] sm:before:border-zinc-600 sm:before:inset-0 sm:before:top-[54%] sm:before:left-[-69%] sm:before:border-r-0  sm:before:sm:w-[140px] sm:before:w-[135px]  sm:before:h-[150px] sm:before:sm:h-[165px] sm:before:md:h-[180px] sm:before:lg:h-[214px] sm:before:rounded-tl-[18px] sm:before:rounded-bl-[18px]">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
                ...
                <div class="cardHeading bg-white pt-2 text-base sm:text-xl lg:text-2xl text-ellipsis line-clamp-1 text-[#3f3f3f] font-bold z-30 relative">
                    Delivery Details
                </div>
                <div class="text-sm sm:text-base lg:text-lg opacity-60 font-semibold pt-2 leading-[120%] px-3 text-ellipsis line-clamp-2">
                    Fill the contact details for delivery.
                </div>
            </div>
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[54%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
                ...
                <div class="cardHeading bg-white pt-2 text-base sm:text-xl lg:text-2xl text-ellipsis line-clamp-1 text-[#3f3f3f] font-bold">
                    Order Placement
                </div>
                <div class="text-sm sm:text-base lg:text-lg opacity-60 font-semibold pt-2 leading-[120%] px-3 text-ellipsis line-clamp-2">
        ...
        <div class="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
            ...
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:border-[3px] sm:after:border-zinc-600 sm:after:inset-0 sm:after:top-[54%] sm:after:left-[100%] sm:after:border-l-0 sm:after:w-[90px] sm:after:sm:w-[140px] sm:after:h-[150px] sm:after:sm:h-[170px] sm:after:md:h-[180px] sm:after:lg:h-[214px] sm:after:rounded-tr-[18px] sm:after:rounded-br-[18px]">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
                    ...
                    {{-- <img src="{{asset('public'.mix('/tailwind/img/tracking.svg'))}}" alt="thanku" class="img-fluid h-full w-full "> --}}
                </div>
                <div class="cardHeading bg-white pt-2 text-base sm:text-xl lg:text-2xl text-ellipsis line-clamp-1 text-[#3f3f3f] font-bold">
                    Tracking Order
                </div>
        ...
        <div class="pt-10 sm:px-10 lg:px-20 w-full flex items-center justify-between ">
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[52%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2     sm:before:content-[''] sm:before:absolute sm:before:h-[3px] sm:before:w-[116px] sm:before:bg-zinc-600 sm:before:top-[52%] sm:before:left-[-113px] sm:before:-z-10 sm:before:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto">
                ...
                <div class="absolute h-[16px] w-[16px] top-[48%] left-[-126px] mt-[1px] lg:mt-[2px]">
                    <img src="{{asset('public'.mix('/tailwind/img/leftIcon.svg'))}}" alt="thanku" class="img-fluid h-full w-full ">
                </div>
            </div>
            <div class="card w-1/3 md:w-1/4 text-center relative sm:after:content-[''] sm:after:absolute sm:after:h-[3px] sm:before:mt-[2px] sm:after:w-[100px] sm:after:bg-zinc-600 sm:after:top-[52%] sm:after:right-[-90px] sm:after:-z-10 sm:after:translate-y-1/2">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto ">
                    <svg class="h-full w-full" viewBox="0 0 448 320" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M368 96H320V48C320 35.2696 314.943 23.0606 305.941 14.0589C296.939 5.05713 284.73 0 272 0H48C35.2696 0 23.0606 5.05713 14.0589 14.0589C5.05713 23.0606 0 35.2696 0 48V272C0 276.243 1.68571 280.313 4.68629 283.314C7.68687 286.314 11.7565 288 16 288H66.88C70.2433 297.266 76.3781 305.273 84.4506 310.931C92.5232 316.588 102.142 319.624 112 319.624C121.858 319.624 131.477 316.588 139.549 310.931C147.622 305.273 153.757 297.266 157.12 288H322.88C326.243 297.266 332.378 305.273 340.451 310.931C348.523 316.588 358.142 319.624 368 319.624C377.858 319.624 387.477 316.588 395.549 310.931C403.622 305.273 409.757 297.266 413.12 288H432C436.243 288 440.313 286.314 443.314 283.314C446.314 280.313 448 276.243 448 272V176C448 154.783 439.571 134.434 424.569 119.431C409.566 104.429 389.217 96 368 96ZM112 288C108.835 288 105.742 287.062 103.111 285.304C100.48 283.545 98.4289 281.047 97.2179 278.123C96.0069 275.199 95.6901 271.982 96.3074 268.879C96.9248 265.775 98.4487 262.924 100.686 260.686C102.924 258.449 105.775 256.925 108.879 256.307C111.982 255.69 115.199 256.007 118.123 257.218C121.047 258.429 123.545 260.48 125.304 263.111C127.062 265.742 128 268.835 128 272C128 276.243 126.314 280.313 123.314 283.314C120.313 286.314 116.243 288 112 288ZM288 256H157.12C153.757 246.734 147.622 238.727 139.549 233.069C131.477 227.412 121.858 224.376 112 224.376C102.142 224.376 92.5232 227.412 84.4506 233.069C76.3781 238.727 70.2433 246.734 66.88 256H32V208H288V256ZM288 176H32V48C32 43.7565 33.6857 39.6869 36.6863 36.6863C39.6869 33.6857 43.7565 32 48 32H272C276.243 32 280.313 33.6857 283.314 36.6863C286.314 39.6869 288 43.7565 288 48V176ZM368 288C364.835 288 361.742 287.062 359.111 285.304C356.48 283.545 354.429 281.047 353.218 278.123C352.007 275.199 351.69 271.982 352.307 268.879C352.925 265.775 354.449 262.924 356.686 260.686C358.924 258.449 361.775 256.925 364.879 256.307C367.982 255.69 371.199 256.007 374.123 257.218C377.047 258.429 379.545 260.48 381.304 263.111C383.062 265.742 384 268.835 384 272C384 276.243 382.314 280.313 379.314 283.314C376.313 286.314 372.243 288 368 288ZM416 256H413.12C409.757 246.734 403.622 238.727 395.549 233.069C387.477 227.412 377.858 224.376 368 224.376C358.142 224.376 348.523 227.412 340.451 233.069C332.378 238.727 326.243 246.734 322.88 256H320V128H336V192C336 196.243 337.686 200.313 340.686 203.314C343.687 206.314 347.757 208 352 208H416V256ZM368 176V128C380.73 128 392.939 133.057 401.941 142.059C410.943 151.061 416 163.27 416 176H368Z" fill="#083863"/>
                    </svg>
                </div>
                <div class="cardHeading bg-white pt-2 text-base sm:text-xl lg:text-2xl text-ellipsis line-clamp-1 text-[#3f3f3f] font-bold">
                    Delivery
            ...
            <div class="card w-1/3 md:w-1/4 text-center relative">
                <div class="iconImg h-[35px] sm:h-[40px] md:h-[50px] lg:h-[70px] w-[40px] sm:w-[50px] md:w-[60px] lg:w-[70px] mx-auto hover:stroke-white">
                    <svg class="h-full w-full" viewBox="0 0 336 384" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M72 37.3333C72 32.6667 120.17 0 168 0C215.829 0 264 32.6667 264 37.3333C264 53.9733 262.232 63.8272 260.733 69.1936C259.748 72.7147 256.45 74.6667 252.794 74.6667H83.2064C79.5498 74.6667 76.2506 72.7136 75.2672 69.1925C73.7664 63.8251 72 53.9712 72 37.3333ZM152 32C146.109 32 141.333 36.7757 141.333 42.6667C141.333 48.5579 146.109 53.3333 152 53.3333H184C189.89 53.3333 194.667 48.5579 194.667 42.6667C194.667 36.7757 189.89 32 184 32H152ZM83.0698 140.992C47.5466 130.003 56.5109 110.387 70.0661 96H268.906C279.742 109.841 285.557 128.522 252.795 139.705C253.151 142.867 253.333 146.081 253.333 149.333C253.333 196.462 215.127 234.667 168 234.667C120.871 234.667 82.6666 196.462 82.6666 149.333C82.6666 146.522 82.8032 143.739 83.0698 140.992ZM165.092 149.333C193.283 149.333 215.117 147.842 231.871 145.234C231.956 146.589 232 147.955 232 149.333C232 184.679 203.346 213.333 168 213.333C132.654 213.333 104 184.679 104 149.333C104 148.205 104.029 147.084 104.086 145.97C119.685 148.123 139.69 149.333 165.092 149.333ZM257.787 305.057C238.813 275.548 205.688 256 168 256C130.296 256 97.1616 275.562 78.192 305.089C74.7285 299.771 69.3653 295.663 62.753 293.891L42.1461 288.37C27.921 284.558 13.2983 293.001 9.48648 307.226L1.20435 338.135C-2.60749 352.362 5.83474 366.983 20.0608 370.796L40.6666 376.317C47.9541 378.27 55.344 377.007 61.3333 373.398C61.3685 379.26 66.1301 384 72 384C77.8901 384 82.6666 379.225 82.6666 373.333V362.667C82.6666 358.603 82.9504 354.605 83.4997 350.692L139.009 365.565C144.114 376.457 155.175 384 168 384C180.823 384 191.886 376.457 196.991 365.565L252.499 350.692C253.049 354.605 253.333 358.603 253.333 362.667V373.333C253.333 379.225 258.109 384 264 384C269.856 384 274.611 379.28 274.666 373.436C280.646 377.022 288.017 378.273 295.285 376.325L315.891 370.804C330.117 366.992 338.559 352.37 334.748 338.144L326.465 307.234C322.654 293.009 308.031 284.566 293.806 288.379L273.199 293.9C266.603 295.667 261.25 299.759 257.787 305.057ZM89.0986 330.106C100.596 302.274 126.392 281.852 157.333 277.994V321.821C147.686 325.23 140.163 333.134 137.278 343.015L89.0986 330.106ZM246.901 330.106C235.403 302.274 209.606 281.852 178.667 277.994V321.821C188.313 325.23 195.836 333.134 198.721 343.015L246.901 330.106ZM168 362.667C173.89 362.667 178.667 357.891 178.667 352C178.667 346.109 173.89 341.333 168 341.333C162.109 341.333 157.333 346.109 157.333 352C157.333 357.891 162.109 362.667 168 362.667Z" fill="#083863"/>
                    </svg>
                </div>
                <div class="cardHeading bg-white pt-2 text-base sm:text-xl lg:text-2xl text-ellipsis line-clamp-1 text-[#3f3f3f] font-bold">
                    Track Driver
...
<div class="bg-white relative py-8 pb-10">
...
<div class="bg-slate-900  md:h-[75vh] h-full">
    <div class="mx-auto max-w-7xl px-6 lg:px-8  z-[1] relative py-10 overflow-hidden h-full">
        <div class="flex flex-row flex-wrap items-center h-full">
            ...
            <div class="md:w-1/2 w-full md:order-2 order-1">
                <div class="w-1/2 h-1/2 md:ms-auto mx-auto">
                    <img src="{{asset('public'.mix('/tailwind/img/carers/together-IMG-Global-Infotech.avif'))}}" alt="thanku" class="h-full w-full ">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="absolute inset-y-0 hidden w-full min-w-[1360px] bg-[url('../img/beams1.webp?id=31a5defd3b15daed788cf2bd1997fc88')] bg-[length:2000px_100%] bg-[position:calc(50%_+_220px)_-50px] bg-no-repeat lg:block pointer-events-none"></div>
            <div class="flex flex-wrap row-flex relative">
                <div class="lg:w-1/2 w-full px-14 ">
                    <div class="img"><img src="{{asset('public'.mix('/tailwind/img/carers/beifit.png'))}}" alt="thanku" class=" lg:h-full lg:w-full md:h-[500px]  h-full w-full"> </div>
                </div>
    ...
    <div class="container mx-auto z-30 after:absolute after:w-20 after:rounded-full after:h-20 after:right-[50px] after:bottom-[50px] after:bg-gradient-to-br after:from-blue-300 after:to-green-500  before:absolute before:w-20 before:rounded-full before:h-20 before:lg:left-[500px] md:left-[300px] :left-[200px] before:top-[300px] before:bg-gradient-to-br before:from-pink-400 before:to-pink-600 ">
        ...
        <div class="flex flex-row g-3 flex-wrap w-full mt-3 relative z-40">
            <div class="md:w-1/2 w-full lg:p-4 md:p-3 p-2">
                <div class="md:p-5 p-4  bg-white/5 backdrop-blur-sm rounded-[20px] border-[1px] border-solid border-[white]/10 group duration-300 sm:hover:scale-105 sm:hover:border-pink-100">
...
<div class="bg-gray-100 relative overflow-hidden">
    <img src="{{asset('public'.mix('/tailwind/img/carers/beams-pricing.png'))}}" alt="" class="absolute left-1/2 top-0 -ml-[40rem] w-[90.4375rem] max-w-none">
    <div class="mx-auto max-w-7xl px-6 lg:px-8  z-[1] relative py-10 overflow-hidden">
        <div class="card sm:flex items-center bg-white shadow-sm rounded-xl px-6 py-5 w-full duration-300 border-transparent border hover:border hover:border-orange-500">
            <div class="grow">
            ...
            <div class="flex-none sm:mt-0 mt-5">
                <a href="https://www.imgglobalinfotech.com/contact-us.php" class=" inline-flex justify-center rounded-lg rounded-br-none max-md:text-xs text-sm font-semibold max-md:py-2 py-3 px-4 ring-2 ring-gray-200 bg-slate-900 text-white hover:bg-slate-700">
                    <span>
                        <span class="inline-flex items-center gap-1">
                            <span>
        ...
        <div class="card mt-5 sm:flex items-center bg-white shadow-sm rounded-xl px-6 py-5 w-full duration-300 border-transparent border hover:border hover:border-orange-500">
            <div class="grow">
                <div class="text-gray-500 font-semibold text-sm">FULL TIME</div>
