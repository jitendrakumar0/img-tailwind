...
{{--  why a business must have a b2b ecommerce website --}}
...
{{--  why a business must have a b2b ecommerce website end  --}}
            ...
            <div class="w-full lg:w-1/2 px-5 h-auto">
                <div class="mainCard flex flex-wrap shadow-2xl  rounded-md h-full relative sm:before:absolute sm:before:h-[25%] sm:before:top-[12%] sm:before:left-0 sm:before:w-[5px] sm:before:duration-300 sm:before:bg-[#083e56] sm:after:absolute sm:after:top-[12%] sm:after:left-0 sm:after:w-[5px] sm:after:bg-[#083e56] sm:after:duration-500 sm:after:hover:h-[88%] sm:after:h-0">
                    ...
                    <div class="w-full sm:w-[80%] p-4 sm:p-10">
                        <div class="heading text-black font-bold md:text-xl sm:text-lg text-base ">
...
{{-- Our B2B eCommerce  end--}}

{{-- brand logo  --}}

<div class="select-none">
    <div class="bg-slate-50">
        <div class="pb-6 sm:pb-12 [&amp;:has(p>span)]:py-6 [&amp;:has(p>span)]:md:py-8 [&amp;:has(p>span)]:lg:py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full">
            <p class="
                max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black text-center
                ...
                last:*:font-bold last:*:text-theme4
            "></p>
            <div class="md:text-base text-sm text-black/70 text-center mt-3 empty:hidden">                
            </div>
            <div class="swiper logo-clouds before:bg-gradient-to-r before:from-slate-50 before:to-transparent before:w-32 before:z-10 before:inset-0 before:absolute before:pointer-events-none after:bg-gradient-to-l after:from-slate-50 after:to-transparent after:w-32 after:z-10 after:inset-0 after:absolute after:pointer-events-none after:left-auto swiper-initialized swiper-horizontal swiper-backface-hidden" data-swiper="{
                    &quot;slidesPerView&quot;: 1,
                    &quot;spaceBetween&quot;: 20,
                    &quot;loop&quot;: true,
                    &quot;centeredSlides&quot;: true,
                ...
                <div class="
                        swiper-wrapper !ease-linear mt-10 flex items-center

                        *:!h-8
                        
                        *:*:mx-auto *:hover:*:scale-90 *:*:h-full *:*:!w-auto *:*:duration-200 *:*:cursor-pointer *:*:max-h-12 *:*:object-contain
                    " id="swiper-wrapper-0824e83a1f10d5746" aria-live="off" style="transition-duration: 5000ms; transform: translate3d(-138.444px, 0px, 0px);">   
                ...
                <a class="swiper-slide" role="group" aria-label="4 / 10" data-swiper-slide-index="3" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-hero.webp?id=de2333d0234c8ef2c2cbfa582af53799" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-hero.webp?id=de2333d0234c8ef2c2cbfa582af53799" alt="logo clouds hero">
            </a><a class="swiper-slide" role="group" aria-label="5 / 10" data-swiper-slide-index="4" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-myfab11.webp?id=7e9e4d9f500e498df748007d3ce1e811" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-myfab11.webp?id=7e9e4d9f500e498df748007d3ce1e811" alt="logo clouds myfab11">
            </a><a class="swiper-slide" role="group" aria-label="6 / 10" data-swiper-slide-index="5" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-parle.webp?id=5a312b5331cbfd413d804ad0724d0c78" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-parle.webp?id=5a312b5331cbfd413d804ad0724d0c78" alt="logo clouds parle">
            </a><a class="swiper-slide" role="group" aria-label="7 / 10" data-swiper-slide-index="6" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-tata.webp?id=b10e45a9759a4b2c7714ffd786649da8" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-tata.webp?id=b10e45a9759a4b2c7714ffd786649da8" alt="logo clouds tata">
            </a><a class="swiper-slide !h-5 md:!h-7 swiper-slide-prev" role="group" aria-label="8 / 10" data-swiper-slide-index="7" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-titan.webp?id=d63ac10bce2b697ab3f4982defeb0310" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-titan.webp?id=d63ac10bce2b697ab3f4982defeb0310" alt="logo clouds titan">
            </a><a class="swiper-slide swiper-slide-active" role="group" aria-label="9 / 10" data-swiper-slide-index="8" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-adani.webp?id=087b10f7ca0942619a845b38b00712c6" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-adani.webp?id=087b10f7ca0942619a845b38b00712c6" alt="logo clouds adani">
            </a><a class="swiper-slide swiper-slide-next" role="group" aria-label="10 / 10" data-swiper-slide-index="9" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-fabindia.webp?id=c35d1aaf31d43dd204bb4195e474b248" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-fabindia.webp?id=c35d1aaf31d43dd204bb4195e474b248" alt="logo clouds fabindia">
            </a><a class="swiper-slide" role="group" aria-label="1 / 10" data-swiper-slide-index="0" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-titan.webp?id=d63ac10bce2b697ab3f4982defeb0310" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-titan.webp?id=d63ac10bce2b697ab3f4982defeb0310" alt="logo clouds titan">
            </a><a class="swiper-slide" role="group" aria-label="2 / 10" data-swiper-slide-index="1" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-adani.webp?id=087b10f7ca0942619a845b38b00712c6" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-adani.webp?id=087b10f7ca0942619a845b38b00712c6" alt="logo clouds adani">
            </a><a class="swiper-slide" role="group" aria-label="3 / 10" data-swiper-slide-index="2" style="width: 108.444px; margin-right: 30px;">
                <img width="108" height="32" src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-fabindia.webp?id=c35d1aaf31d43dd204bb4195e474b248" data-src="https://www.imgglobalinfotech.com/public/tailwind/img/logo-clouds-fabindia.webp?id=c35d1aaf31d43dd204bb4195e474b248" alt="logo clouds fabindia">
            </a></div>
...
<section class="bg-white">
    <div class="pb-6 md:pb-8 lg:pb-16 select-none">
