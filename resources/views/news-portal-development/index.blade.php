...
@push('meta')
   <!--  Title -->
   <title>News Portal Development | News Portal Website Design Company</title>

   <!-- Required meta tags -->
   <meta name="title" content="News Portal Development | News Portal Website Design Company" />
   <meta name="description" content="News Portal Development - IMG Global Infotech is a leading News Portal Website Design Company in India that offers news channel design services." />
   <meta name="keywords" content="News Portal Development, News Portal Development Jaipur, News Portal Development Company Jaipur, News Portal Website Services Jaipur, News Portal Website Development Jaipur" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="News Portal Development | News Portal Website Design Company">
   <meta name="twitter:description" content="News Portal Development - IMG Global Infotech is a leading News Portal Website Design Company in India that offers news channel design services.">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/news-portal-development/News-Portal-Development-Company.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}news-portal-development.php">
   <meta property="og:title" content="News Portal Development | News Portal Website Design Company">
   <meta property="og:description" content="News Portal Development - IMG Global Infotech is a leading News Portal Website Design Company in India that offers news channel design services.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/news-portal-development/News-Portal-Development-Company.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/news-portal-development/News-Portal-Development-Company.webp">



   <meta name="classification" content="News Portal Development, News Portal Development Jaipur, News Portal Development Company Jaipur, News Portal Website Services Jaipur, News Portal Website Development Jaipur" />
   <link rel="canonical" href="{{asset('/')}}news-portal-development.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/news-portal-development.min.css">
@endpush
@section('content')

   <!-- top banner section -->
   <div class="container-fluid overflow-hidden bg-white top_banner position-relative" style="--bg:url({{asset('/public')}}/assets/img/news-portal-development/hero.webp);">
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">News Portal Development Company</h1>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/news-portal-development/News-Portal-Development-Company.webp" alt="News Portal Development Company">
                           <img class="w-100 position-absolute top-md-n50px top-n30px left-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/news-portal-development/12.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- News Portal Development section -->
   <div class="container-fluid overflow-hidden news_portal_development bg-white position-relative py-5">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/news-portal-development/Why-News-Portal-Development.webp" alt="Why News Portal Development?">
                           <img class="w-100 position-absolute top-lg-n40px top-md-n40px top-n40px start-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/news-portal-development/2.webp" alt="IMG Global Infotech Layer">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Why News Portal Development?</h2>
...
@endsection
@push('scripts')
   <script src="{{asset('/public')}}/assets/js/news-portal-development.min.js"></script>
@endpush