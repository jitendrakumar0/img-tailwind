...
@push('meta')
<!--  Title -->
<title>Offshore Web Development Company India, Offshore Services</title>

<!-- Required meta tags -->
<meta name="title" content="Offshore Web Development Company India, Offshore Services" />
<meta name="description" content="IMG Global Infotech is a leading Offshore Web Development Company in India offers outsourcing web development services. Hire best developers now." />
<meta name="keywords" content="Offshore Java Developer in India, Offshore Web Developer in India, Offshore Web Design in India, Offshore PHP Developer in India, Offshore SEO Developer in India, Offshore SMO Developer in India, Offshore Digital Marketing in India, Offshore Android Developer in India, Offshore IOS Developer in India, Offshore AngularJS Developer in India, Offshore NodeJS Developer in India, Offshore ReactJS Developer in India, Offshore Ionic Developer in India, Offshore CodeIgniter Developer in India, Offshore PHP Cake Developer in India" />

<!-- Twitter Meta -->
<meta name="twitter:title" content="Offshore Web Development Company India, Offshore Services">
<meta name="twitter:description" content="IMG Global Infotech is a leading Offshore Web Development Company in India offers outsourcing web development services. Hire best developers now.">
<meta name="twitter:image" content="{{asset('/public')}}/assets/img/offshore-web-development-india/Offshore-Web-Development-Company.webp">

<!-- Facebook Meta -->
<meta property="og:url" content="{{asset('/')}}offshore-web-development-india.php">
<meta property="og:title" content="Offshore Web Development Company India, Offshore Services">
<meta property="og:description" content="IMG Global Infotech is a leading Offshore Web Development Company in India offers outsourcing web development services. Hire best developers now.">
<meta property="og:image" content="{{asset('/public')}}/assets/img/offshore-web-development-india/Offshore-Web-Development-Company.webp">
<meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/offshore-web-development-india/Offshore-Web-Development-Company.webp">



<meta name="classification" content="Offshore Java Developer in India, Offshore Web Developer in India, Offshore Web Design in India, Offshore PHP Developer in India, Offshore SEO Developer in India, Offshore SMO Developer in India, Offshore Digital Marketing in India, Offshore Android Developer in India, Offshore IOS Developer in India, Offshore AngularJS Developer in India, Offshore NodeJS Developer in India, Offshore ReactJS Developer in India, Offshore Ionic Developer in India, Offshore CodeIgniter Developer in India, Offshore PHP Cake Developer in India" />
<link rel="canonical" href="{{asset('/')}}offshore-web-development-india.php" />
<meta name="robots" content="index, follow" />
@endpush
@push('styles')
<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/offshore-web-development-india.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-start position-relative">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Offshore Web Development Company</h1>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           ...
                           <img src="{{GETFOLDERPATH()}}/cms-development-2.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Offshore-Web-Development-Company.webp"alt="" width="100" height="auto">  
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- Hire Offshore Developers From IMG Section -->
   <div class="container-fluid overflow-hidden Hire_Offshore_Developers_From_IMG_section position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row py-4">
            <div class="col-12">
               <div class="row py-4 align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;">
                           <img src="{{GETFOLDERPATH()}}/cms-development-1.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Hire-Offshore-Developers-From-IMG.webp"alt="Hire Offshore Developers From IMG" width="100" height="auto">  
                           </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Hire Offshore Developers From IMG</h2>
   ...
   <!-- offshore Specialise section -->
   <div class="container-fluid overflow-hidden offshore-specialise position-relative" style="--bg:white;">
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="row mb-5">
                  <div class="col-12">
                     <div class="row mx-0 pb-2">
                        <h2 class="d-none invisible">The Technologies We Specialise In</h2>
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/android.webp" alt="Android"></div>
                  </div>
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/ios.webp" alt="iOS"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/reactnative.png" alt="reactnative"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/flutter.webp" alt="flutter"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/reactjs.webp" alt="ReactJS"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/nodejs.webp" alt="Node.JS"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/php.webp" alt="PHP"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/java.webp" alt="Java"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/angularjs.webp" alt="AngularJS"></div>
                  </div>
                  <div class="media-body">
            ...
            <div class="col-md-2 d-flex align-self-stretch">
               <div class="offshore-specialise-box shadow">
                  <div class="d-flex justify-content-start">
                     <div class="icon d-flex"><img src="{{GETFOLDERPATH()}}/html.webp" alt="HTML5"></div>
                  </div>
                  <div class="media-body">
   ...
   <!-- offshare_services_company section -->
   <div class="container-fluid overflow-hidden bg-white offshare_services_company position-relative" style="--bg:white;">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row align-items-center">
                  <div class="col-12">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Offshore Services Company</h2>
   ...
   <!-- our clients section -->
   <div class="container-fluid overflow-hidden our-clients position-relative">
      <div class="container position-relative zi-2 py-5">
         <div class="row mx-0 pb-4">
            <h2 class="d-none invisible">Our Clients</h2>
            ...
            <div class="col-12">
               <div class="our-clients-inner">
                  <ul class="list-unstyled">
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/adani.webp" alt="adani"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/tata.webp" alt="tata"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/baba-thakur-das.webp" alt="baba-thakur-das"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/nandini-infosys.webp" alt="nandini-infosys"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/mahslg.webp" alt="mahslg"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/medivik.webp" alt="medivik"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/mount-litera.webp" alt="mount-litera"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/nida.webp" alt="nida"></a></li>
                     <li><a class="shadow" href="javascript:;"><img src="{{GETFOLDERPATH()}}/vmg.webp" alt="vmg"></a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <div class="container py-5 position-relative zi-2">
         ...
         <div class="row justify-content-center">
            <div class="col-md-3 mb-5 d-flex align-items-stretch">
               <a href="{{asset('/')}}news-portal-development.php" class="portal_services_box d-block text-decoration-none px-4 py-4 text-center w-100">
                  <span class="api_ico">
            ...
            <div class="col-md-3 mb-5 d-flex align-items-stretch">
               <a href="{{asset('/')}}property-portal-development.php" class="portal_services_box d-block text-decoration-none px-4 py-4 text-center w-100">
                  <span class="api_ico">
            ...
            <div class="col-md-3 mb-5 d-flex align-items-stretch">
               <a href="{{asset('/')}}matrimonial-portal-development.php" class="portal_services_box d-block text-decoration-none px-4 py-4 text-center w-100">
                  <span class="api_ico">
            ...
            <div class="col-md-3 mb-4">
               <a href="{{asset('/')}}education-portal-development.php" class="portal_services_box d-block text-decoration-none px-4 py-4 text-center w-100">
                  <span class="api_ico">
   ...
   <div class="container-fluid overflow-hidden client-testimonials position-relative p-0">
      <div class="container position-relative zi-2 py-5">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Clients Testimonials</h2>
            <div class="col-12 heading fs-md-14 fs-12 center text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Clients <b> Testimonials </b></span></div>
         </div>
  ...
  {{-- <div class="container-fluid overflow-hidden offshore-services position-relative d-xl-done d-lg-done d-md-done d-done">
      <div class="container py-5 position-relative zi-2">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Offshore Development Services</h2>
            <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Offshore <b> Development Services </b></span></div>
         </div>
         <div class="row">
            <div class="col-4 mb-4 d-flex align-items-stretch">
               <div class="offshore-services-box w-100 h-100">
                  <div class="row shadow border rounded mx-0">
                     <div class="col-auto d-flex align-items-center services-box-outer rounded-start">
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 fs-14" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           How Can I communicate with the IMG Global Infotech Team?
                        </button>
                     </h2>
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 fs-14 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           What makes IMG Global Infotech different from others?
                        </button>
                     </h2>
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 fs-14 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                           How can I trust your productivity and work?
                        </button>
                     </h2>
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <h2 class="accordion-header" id="headingfive">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 fs-14 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                           Why Indian software outsourcing companies highly preferred worldwide?
                        </button>
                     </h2>
...
<script src="{{asset('/public')}}/assets/js/offshore-web-development-india.min.js"></script>
@endpush