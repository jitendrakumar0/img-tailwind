...
@push('meta')
   ...
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/hospital-management-software-new/Hospital-Management-Software-Development-Services.webp">
   ...
   <meta property="og:image" content="{{asset('/public')}}/assets/img/hospital-management-software-new/Hospital-Management-Software-Development-Services.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/hospital-management-software-new/Hospital-Management-Software-Development-Services.webp">
...
<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/hospital-management-software-new.min.css">
@endpush
@section('content')

   <!-- top banner section -->
   {{-- <div class="container-fluid overflow-hidden bg-white top_banner position-relative" style="--bg:url({{asset('/public')}}/assets/img/hospital-management-software-new/hero.webp);">
                           ...
                           <div class="row">
                              <div class="col-12">
                                 <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                                    ...
                                    <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Orthopedics</span></div>
                                 </div>
                              </div>
                              <div class="col-12">
...
@endsection
@push('scripts')
<script src="{{asset('/public')}}/assets/js/hospital-management-software-new.js"></script>
