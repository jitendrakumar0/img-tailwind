...
@push('meta')
   <!--  Title -->
   <title>Fantasy Football App Development Company in India - IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Fantasy Football App Development Company in India - IMG Global Infotech" />
   <meta name="description" content=" IMG Global Infotech is a fantasy football app development company in India. We develop robust fantasy football mobile apps for sports enthusiasts, professionals and leagues" />
   <meta name="keywords" content="Fantasy Football App Development, Fantasy Football, Fantasy Football Fix, Fantasy Football App, Fantasy Sports App Developer in India, Fantasy Sports App Development Jaipur, Fantasy Sports App Development Company Jaipur, Fantasy App Development Jaipur, Fantasy Sports Website Development India, Fantasy Cricket Website Developer, Top Fantasy Football Developers in India, Fantasy Football Mobile App Development" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Fantasy Football App Development Company in India - IMG Global Infotech">
   <meta name="twitter:description" content=" IMG Global Infotech is a fantasy football app development company in India. We develop robust fantasy football mobile apps for sports enthusiasts, professionals and leagues">
   <meta name="twitter:image" content="{{GETFOLDERPATH()}}/Fantasy-Football-App-Development.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}fantasy-football-app-development.php">
   <meta property="og:title" content="Fantasy Football App Development Company in India - IMG Global Infotech">
   <meta property="og:description" content=" IMG Global Infotech is a fantasy football app development company in India. We develop robust fantasy football mobile apps for sports enthusiasts, professionals and leagues">
   <meta property="og:image" content="{{GETFOLDERPATH()}}/Fantasy-Football-App-Development.webp">
   <meta property="og:image:secure_url" content="{{GETFOLDERPATH()}}/Fantasy-Football-App-Development.webp">



   <meta name="classification" content="Fantasy Football App Development, Fantasy Football, Fantasy Football Fix, Fantasy Football App, Fantasy Sports App Developer in India, Fantasy Sports App Development Jaipur, Fantasy Sports App Development Company Jaipur, Fantasy App Development Jaipur, Fantasy Sports Website Development India, Fantasy Cricket Website Developer, Top Fantasy Football Developers in India, Fantasy Football Mobile App Development" />
   <link rel="canonical" href="{{asset('/')}}fantasy-football-app-development.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/fantasy-football-app-development.min.css">
@endpush
@section('content')
   ...
   <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Fantasy Football <b>App Development</b></span>
   @endsection('hero_heading')
   @section('hero_tagline')
   Are you planning to take a leap into the world of online gaming? Jump into the future with the best in the market, IMG Global Infotech and witness the growth of your business with the best Fantasy Football Platform in the market. Our professional team of developers packed with years of experience is ready to take you to next level.
...
<img src="{{asset('/public')}}/assets/img/fantasy-football-app-development/shape.webp" class="lazy-image w-100" data-src="{{asset('/public')}}/assets/img/fantasy-football-app-development/Fantasy-Football-App-Development.webp"alt="Fantasy Football App Development" width="100" height="auto">

   <!-- <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/Fantasy-Football-App-Development.webp" alt="Fantasy Football App Development"> -->
   @endsection('hero_img')
   @include('inner-page-section.hero.index')

 

   <!-- Start Your Fantasy section -->
   <div class="container-fluid overflow-hidden bg-white Start_Your_Fantasy_section position-relative">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                          <img src="{{asset('/public')}}/assets/img/fantasy-football-app-development/shape2.webp" class="lazy-image w-100" data-src="{{asset('/public')}}/assets/img/fantasy-football-app-development/Start-Your-Fantasy-Football-Portal-Today.webp"alt="Start-Your-Fantasy-Football-Portal-Today" width="100" height="auto">  
                    </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Start Your Fantasy Football Portal Today!</h2>
                              <div class="col-12 heading fs-md-14 fs-12 left pt-5"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Start Your Fantasy <b> Football Portal Today!</b></span></div>
                           </div>
                        </div>
                        <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-md-0 mt-0">Get started with IMG Global Infotech Pvt. Ltd. today, we provide both custom solution as well as from scratch development depending on your requirements. We have an expert team of highly professional’s individuals who are more than capable to handle start-ups as well as pre-established businesses. Discuss your plans today and pave way to the future of online gaming.</div>
                        <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-0">Football without any doubt is the biggest earning game of the century. Now it’s time to take your share of the pie with the largest developers in the town, We join the online football league and play against your friends and strangers and earn from it. The players get a chance to be a manger for the best and top players in the football world and compete against each other in the online battle of Football Fantasy. We have years of experience to back them up in enduring such projects.</div>
                     </div>
                  </div>
               </div>
            </div>
   ...
   <div class="container-fluid overflow-hidden why-choose-cms position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Why Fantasy Football Software?</h2>
            <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Why Fantasy <b> Football Software?</b></span></div>
            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-4 justify text-center">Football without any doubt is the biggest earning game of the century. Now it’s time to take your share of the pie with the largest developers in the town, We join the online football league and play against your friends and strangers and earn from it. The players get a chance to be a manger for the best and top players in the football world and compete against each other in the online battle of Football Fantasy. We have years of experience to back them up in enduring such projects.
            </div>
            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-4 justify text-center">The software and platforms developed by us automatically takes care of the following things:
            </div>
         </div>
         <div class="row justify-content-center">
            <div class="col-md-9">
               <div class="row justify-content-center">
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Scoring and Points</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 mx-auto" src="{{GETFOLDERPATH()}}/Scoring-and-Points.webp" width="auto" height="58" alt="Scoring and Points"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Scoring and Points</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Points Table</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Points-Table.webp" width="auto" height="58" alt="Points Table"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Points Table</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Ranking</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Ranking.webp" width="auto" height="58" width="100" height="auto" alt="Ranking"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Ranking</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Player Cards</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Player-Cards.webp" width="auto" height="58" alt="Player Cards"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Player Cards</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Tie / Draw management</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Match-Reports.webp" width="auto" height="58" alt="Tie / Draw management"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Tie / Draw management</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Winner declaration</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Winner-declaration.webp" width="auto" height="58" alt="Winner declaration"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Winner declaration</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Payments to the wallets</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Payments-to-the-wallets.webp" width="auto" height="58" alt="Payments to the wallets"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Payments to the wallets</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/User-Reports.webp" width="auto" height="58" alt="User Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">User Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Game Reports</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Game-Reports.webp" width="auto" height="58" alt="Game Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Game Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Match Reports</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Match-Reports.webp" width="auto" height="58" alt="Match Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-l">Match Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        <h3 class="d-none invisible">Payment Reports</h3>
                        <div class="col-12 p-2 fw-l border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Payment-Reports.webp" width="auto" height="58" alt="Payment Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-500">Payment Reports</span>
                        </div>
                     </div>
                  </div>
               </div>
                              ...
                              <div class="col-md-12 ">
                                        <div class="form-floating">
                                            <select name="type"required="" id="type" class="form-control rounded-0 pt-2 fw-400">
                                                ...
                                                <option value="Fantasy Football App Development" selected="selected">Fantasy Football App Development</option>
