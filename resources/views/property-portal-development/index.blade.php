...
@push('meta')
	<!--  Title -->
	<title>IMG Global Infotech - Property Portal Development Company in Jaipur, Property Portal Development Services in Jaipur</title>

	<!-- Required meta tags -->
	<meta name="title" content="IMG Global Infotech - Property Portal Development Company  in Jaipur, Property Portal Development Services  in Jaipur" />
	<meta name="description" content="IMG Global Infotech is Property portal development company in the India. We develop property portal that satisfy the need of customers in every aspect." />
	<meta name="keywords" content="Property Portal Development, Property Portal Development Jaipur, Property Portal Development Company Jaipur, Property Portal Website Services Jaipur, Property Portal Website Development Jaipur" />

	<!-- Twitter Meta -->
	<meta name="twitter:title" content="IMG Global Infotech - Property Portal Development Company  in Jaipur, Property Portal Development Services  in Jaipur">
	<meta name="twitter:description" content="IMG Global Infotech is Property portal development company in the India. We develop property portal that satisfy the need of customers in every aspect.">
	<meta name="twitter:image" content="{{asset('/public')}}/assets/img/property-portal-development/Property-Portal-Development-Company.webp">

	<!-- Facebook Meta -->
	<meta property="og:url" content="{{asset('/')}}property-portal-development.php">
	<meta property="og:title" content="IMG Global Infotech - Property Portal Development Company  in Jaipur, Property Portal Development Services  in Jaipur">
	<meta property="og:description" content="IMG Global Infotech is Property portal development company in the India. We develop property portal that satisfy the need of customers in every aspect.">
	<meta property="og:image" content="{{asset('/public')}}/assets/img/property-portal-development/Property-Portal-Development-Company.webp">
	<meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/property-portal-development/Property-Portal-Development-Company.webp">

	


	<meta name="classification" content="Property Portal Development, Property Portal Development Jaipur, Property Portal Development Company Jaipur, Property Portal Website Services Jaipur, Property Portal Website Development Jaipur" />
	<link rel="canonical" href="{{asset('/')}}property-portal-development.php" />
	<meta name="robots" content="index, follow" />
@endpush
@push('styles')
	<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/property-portal-development.min.css">
@endpush
@section('content')
	<!-- top banner section -->
	<div class="container-fluid overflow-hidden bg-white top_banner position-relative" style="--bg:url({{asset('/public')}}/assets/img/property-portal-development/hero.webp);">
							...
							<div class="row pt-3 text-lg-start text-md-center text-center">
								<div class="col-12">
									<div class="row mx-0 pb-2">
										<h1 class="d-none invisible">Property Portal Development Company</h1>
						...
						<div class="col-lg-6 pe-lg-5 top_banner-left-part">
							<div class="row justify-content-lg-end justify-content-md-center justify-content-center">
								<div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
									<img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/property-portal-development/Property-Portal-Development-Company.webp" alt="Property Portal Development Company">
									<img class="w-100 position-absolute top-md-n50px top-n30px left-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/property-portal-development/12.webp" alt="IMG Global Infotech Layer">
								</div>
							</div>
						</div>
					</div>
	...
	<!-- Property Portal Development section -->
	<div class="container-fluid overflow-hidden property-portal-development bg-white position-relative py-5">
						...
						<div class="col-lg-5 pe-lg-5 top_banner-left-part">
							<div class="row justify-content-center">
								<div class="col-lg-10 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
									<img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/property-portal-development/Why-Property-Portal.webp" alt="Why Property Portal?">
									<img class="w-100 position-absolute top-lg-n40px top-md-n40px top-n40px start-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/property-portal-development/2.webp" alt="IMG Global Infotech Layer">
								</div>
							</div>
						</div>
						<div class="col-lg-7">
							<div class="row">
								<div class="col-12">
									<div class="row mx-0 pb-4 pt-lg-0 pt-4">
										<h2 class="d-none invisible">Why Property Portal?</h2>
	...
	<div class="container-fluid px-0 overflow-hidden why_choose_portal position-relative">
		<div class="row">
			<div class="col-lg-6 col-md-12 px-0">
				<div class="why_choose_portal_left"> </div>
			</div>
...
@endsection
@push('scripts')
	<script src="{{asset('/public')}}/assets/js/property-portal-development.min.js"></script>
@endpush