         ...
         <div class="row mx-lg-2 mx-md-2 mx-2">
            ...
            <div class="col-md-12">
               <div class="portfolio_category_part bg-white border row d-block shadow">
                  <div class="portfolio_category d-flex align-items-center justify-content-between fw-m fs-16 bg-theme1 text-white py-1">Portfolio Category <span class="categrory_ico">Filter By <i class="imgr me-1 fs-16 img-sort-alpha-up"></i></span></div>
                        ...
                        <a href="{{asset('/portfolio/'.$value->slug)}}" class="portfolio_page_box d-block shadow" style="--bg:url({{PORTFOLIO_IMAGE_URL($value->image)}});">
                           ...
                           <div class="portfolio_hover" data-putcolor="samedomain{{$value->slug}}">
                              <div class="portfolio_hover_inner">
                                 <div class="fw-m fs-lg-24 fs-md-19 fs-18 lh-normal">{{Str::title($value->title)}}</div>
                                 <div class="fw-l fs-lg-16 fs-md-14 fs-15 mt-2 mb-0">{{$value->tagline}}</div>
                                 <div class="row justify-content-center mt-3 mx-0 portfolio_tags">
                                    @forelse(GET_TECHNOLOGY($value->tech) as $tech)
                                    <div class="col-auto px-1">
                                       <span class="tag_port fw-m">{{$tech->name}}</span>
                                    </div>
                                    @empty
            ...
            {{-- <div class="seemore text-center mt-3">
               <a class="load-more rounded-pill m-auto d-inline-flex fs-22 text-white align-items-center justify-content-center h-60px w-60px bg-primary fw-m text-decoration-none" href="javascript:;">
