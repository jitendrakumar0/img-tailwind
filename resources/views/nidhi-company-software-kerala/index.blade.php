...
@push('meta')
<!--  Title -->
<title>Nidhi Software in Kerala | Nidhi Company Software Kerala –IMG Global Infotech</title>

<!-- Required meta tags -->
<meta name="title" content="Nidhi Software in Kerala | Nidhi Company Software Kerala –IMG Global Infotech" />
<meta name="description" content="Get one stop solution for all your finance Management requirements with the Nidhi Software in Kerala from IMG global Infotech." />
<meta name="keywords" content="Nidhi Company Software, Nidhi Company Software in Kerala, Online Nidhi Software, Best nidhi Software in India, Nidhi Software Modules, Nidhi Company Software Development, Nidhi Company Software Development Services" />

<!-- Twitter Meta -->
<meta name="twitter:title" content="Nidhi Software in Kerala | Nidhi Company Software Kerala –IMG Global Infotech">
<meta name="twitter:description" content="Get one stop solution for all your finance Management requirements with the Nidhi Software in Kerala from IMG global Infotech.">
<meta name="twitter:image" content="{{asset('/public')}}/assets/img/nidhi-company-software-kerala/Nidhi-Company-Software-Kerala.webp">

<!-- Facebook Meta -->
<meta property="og:url" content="{{asset('/')}}nidhi-company-software-kerala.php">
<meta property="og:title" content="Nidhi Software in Kerala | Nidhi Company Software Kerala –IMG Global Infotech">
<meta property="og:description" content="Get one stop solution for all your finance Management requirements with the Nidhi Software in Kerala from IMG global Infotech.">
<meta property="og:image" content="{{asset('/public')}}/assets/img/nidhi-company-software-kerala/Nidhi-Company-Software-Kerala.webp">
<meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/nidhi-company-software-kerala/Nidhi-Company-Software-Kerala.webp">



<meta name="classification" content="Nidhi Company Software, Nidhi Company Software in Kerala, Online Nidhi Software, Best nidhi Software in India, Nidhi Software Modules, Nidhi Company Software Development, Nidhi Company Software Development Services" />
<link rel="canonical" href="{{asset('/')}}nidhi-company-software-kerala.php" />
<meta name="robots" content="index, follow" />
@endpush
@push('styles')
<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/nidhi-company-software-kerala.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-start position-relative">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Nidhi Company Software Kerala</h1>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/Nidhi-Company-Software-Kerala.webp" alt="Nidhi Company Software Kerala">
   ...
   <div class="container-fluid benifits" style="--bg:white;">
      <div class="container py-5 zi-2 position-relative">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">The Features Loaded In Nidhi Software</h2>
            <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">The Features Loaded In <b>Nidhi Software</b></span></div>
         </div>
         <div class="row h-100">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="position-relative d-block fs-md-50 fs-sm-45 fs-40 text-theme3">
   ...
   <div class="container-fluid position-relative overflow-hidden devolopements-benefits">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row mx-0 pb-5">
                  <h2 class="d-none invisible">Advantages Of Nidhi Company Software</h2>
                  <div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Advantages Of <b> Nidhi Company Software</b></span></div>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="col-12">
               <div class="row mx-0 pb-4">
                  <h2 class="d-none invisible">We Have A History In Building The Best Relationships With Our Customer With Best In Class Software And After Sale Services. Sit With Us At A Cup Of Coffee And Discuss Your Project With Us.</h2>
                  <div class="col-12 heading fs-md-14 fs-12 center text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> We Have A History In Building The Best <br> Relationships With Our Customer With Best In Class Software And <br> <b> After Sale Services. Sit With Us At A Cup Of Coffee And Discuss Your Project With Us.</b></span></div>
               </div>
            </div>
...
@endsection
@push('scripts')
<script src="{{asset('/public')}}/assets/js/nidhi-company-software-kerala.min.js"></script>
@endpush