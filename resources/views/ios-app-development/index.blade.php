...
@push('meta')
   <!--  Title -->
   <title> iOS Application Development Company | IMG Global</title>

   <!-- Required meta tags -->
   <meta name="title" content=" iOS Application Development Company | IMG Global" />
   <meta name="description" content="IMG Global Infotech is the best iOS application development company that provides iOS application development services across the globe." />
   <meta name="keywords" content="" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content=" iOS Application Development Company | IMG Global">
   <meta name="twitter:description" content="IMG Global Infotech is the best iOS application development company that provides iOS application development services across the globe.">
   <meta name="twitter:image" content="{{GETFOLDERPATH()}}/ios-development-banner.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}ios-app-development.php">
   <meta property="og:title" content=" iOS Application Development Company | IMG Global">
   <meta property="og:description" content="IMG Global Infotech is the best iOS application development company that provides iOS application development services across the globe.">
   <meta property="og:image" content="{{GETFOLDERPATH()}}/ios-development-banner.webp">
   <meta property="og:image:secure_url" content="{{GETFOLDERPATH()}}/ios-development-banner.webp">
...
<span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Custom iOS App <b>Development Company</b></span>
@endsection('hero_heading')
@section('hero_tagline')
The finest option for developing safe, scalable digital solutions from iOS mobile app development company. Our iPhone App Development Services make sure that your applications are designed to propel your company into the future.
...
@endsection('hero_btn')
@section('hero_img')
<img src="{{GETFOLDERPATH()}}/ios-development-banner.webp"  alt="Custom iOS App Development Company">
@endsection('hero_img')
            ...
            <div class="col-12">
               ...
               <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        ...
                        <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/ios-app-developmet.webp" alt="Boosting Your Business Through the Development of Custom iOS Applications">
                        </div>
                     </div>
                  </div>
                <div class="col-lg-7">
                        ...
                        <div class="col-12">
                           <div class="row mx-0 pb-3 pt-lg-0 pt-4">
                                 ...
                                 <div class="row mx-0 pb-2">
                                    <h2 class="d-none invisible">Boosting Your Business Through the Development of Custom iOS Applications </h2>
                                    <div class="col-12 heading fs-md-14 fs-12 left text-dark">
                                       <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">iBoosting Your Business Through the Development of<b> Custom iOS Applications</b></span></div>
                                 </div>
                              </div>
                            </div>
                        </div>
                        <div class="col-12 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center">We are a full-stack custom iOS app development firm that has produced hundreds of top-selling native iOS apps that have experienced exponential growth. Our skilled team of seasoned iPhone mobile app developers uses Swift and Objective-C as their primary tech stack while developing iOS solutions. </div>
                        <div class="col-12 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">We are a dedicated team of developers providing iPhone App Development Services for our clients globally with their expertise in the area. We offer custom iOS application development services while considering the unique design and iOS app development consultation to company by following guidelines related to each individual platform, including iPad, iPhone, Apple TV, and Apple Watch. Our native iOS app development company has developed apps for many different use cases across a number of industries, including real-time analytics, route matching, geo-tagging, streaming video, and more.
                        </div>
                     </div>
            ...
            <div class="col-12 fs-lg-25 fs-md-30 fs-20 text-white text-center text-md-start">  <span class="fw-l"> Ready to start your dream project?</span></div>
              ...
              <div class="col-lg-4 col-md-4 col-12 text-center py-2">
                  ...
                  <img class="w-50 position-absolute right-5 top-10" src="{{GETFOLDERPATH()}}/arrow.webp" alt="Arrow">
                     <div class="col-12 fs-md-20 fs-16 text-dark pb-2"> Quick Support </div>
                     <div class="col-12">
                        <a href="{{asset('/ios-app-development.php#contactWithUss')}}" class="btn expert-btn fs-md-14 fs-12 py-1 px-md-2 px-2 text-capitalize fw-m">
...
<div class="container-fluid rect-native-srvices overflow-hidden">
    <div class="container pt-md-5 py-5 pb-md-2 position-relative zi-9">
      <div class="row mx-0 pb-5">
         <h2 class="d-none invisible">iOS App Development Services</h2>
            <div class="col-md-5 col-12 heading fs-md-14 fs-12 text-md-start text-center left text-dark"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20 pt-0">iOS App <br> <b>Development Services </b></span>
           </div>
           <div class="col-md-7 col-12 fs-lg-28 fs-md-21 fs-16 text-dark mt-md-0 mt-3 text-md-start text-center"> <span class="fw-m">  Next-Gen </span>iOS App Development Beside <span class="fw-m">   Professional Excellence  </span></div>
      </div>
      <div class="row">
      ...
      <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-29 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/custom-iphone-app.svg" alt=">Custom iPhone App Development"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Custom iPhone   <span class="d-block">App Development</span></div>
         ...
         <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-29 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/enterprise-ios-solutions.svg" alt="Enterprise iOS Solutions"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Enterprise iOS   <span class="d-block">Solutions</span></div>
         ...
         <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-29 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/iphone-ux-design.svg" alt="iPhone app UI/UX Design"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">iPhone app UI/UX   <span class="d-block">Design</span></div>
                 <div class="col-12 model-card-text">
         ...
         <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-29 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/iphone-app-consultation.svg" alt="iPhone App Consultation"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">iPhone App   <span class="d-block">Consultation</span></div>
                 <div class="col-12 model-card-text">
         ...
         <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-29 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/maintenance-support.svg" alt="iPhone app Support Optimization & Maintenance"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Support  Optimization<span class="d-block">and Maintenance</span></div>
                 <div class="col-12 model-card-text">
         ...
         <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-10 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/iphone-widget-extension-development.svg" alt="iPhone Widget Extension Development"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">iPhone Extension  <span class="d-block">Development</span></div>
                 <div class="col-12 model-card-text">
         ...
         <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
             <div class="model-card position-relative w-100">
                 <div class="col-12 model-card-img">
                    <img class="w-lg-20 w-md-29 w-sm-20 w-20 mx-auto" src="{{GETFOLDERPATH()}}/iPhone-app-Integration.svg" alt="iPhone App Integration"></div>
                 <div class="model-card-title fw-m text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">iPhone App   <span class="d-block">Integration</span></div>
                 <div class="col-12 model-card-text">
            ...
            <div class="container overflow-hidden position-relative ">
               ...
               <div class="col-lg-6 col-md-8 col-12">
                     <div class="col-12 pt-2 text-md-start text-lg-start text-center fs-xl-30 fs-lg-30 fs-md-24 fs-20 fw-m mb-2">
                       <h2 class="d-none invisible">Let the best iOS app development company grow you digitally.</h2>
                       Let The Best iOS App Development Company Grow You Digitally.
                    </div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-16 text-left ">development has come of age and there is no longer a strict divide between native app development and cross-platform development. With help of every growing technology - we can now think of cross-platform apps with native user experience. 
                            This all became possible thanks to the React Native framework. Hire React Native Developer
                        </div>
                        <div class="col-12 text-lg-start text-md-start text-center py-lg-4 py-md-3 mt-lg-0 mb-md-2 mt-md-1 mt-4 mb-4">
                              <a href="{{asset('hire-ios-app-developers.php')}}" class="btn btn-theme2 fs-md-14 fs-13 fw-m py-2 px-md-4 px-3 text-capitalize">
                              <span class="d-block"><span>Hire iOS Developer </span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                           </a>
                     </div>
                     </div>
                     <div class="col-lg-6 col-md-4 col-12">
                         <div class="d-flex w-100 justify-content-lg-end justify-content-md-center justify-content-center leftside">
                        <img class="w-xl-60 w-lg-60 w-md-80 w-sm-60 w-100 zi-9 pt-lg-0 pt-md-0 pt-5" src="{{GETFOLDERPATH()}}/hire-ios-developers.webp" alt="Hire iOS Developers"> 
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row mx-0 pb-3">
                        <h3 class="d-none invisible">Why We are the Best iOS App Development Company?</h3>
                        <div class="col-12 heading fs-md-14 fs-12 text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Why We are the Best iOS <b> App Development Company?</b></span></div>
                    </div>
                    <div class="row">
                               ...
                               <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        <div class="industries_item py-4 bg-white">
                                          <div class="col-12 text-center pb-2">
                                             <img class="w-80px" src="{{GETFOLDERPATH()}}/cost-effective-services.webp" alt="Cost Effective Service">
                                          </div>
                                        </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        <div class="industries_item py-4 bg-white">
                                          <div class="col-12 text-center pb-2">
                                            <img class="w-80px" src="{{GETFOLDERPATH()}}/cuttingEdgetechnology.webp" alt="Cutting Edge Technology">
                                          </div>
                                        </div>
              ...
              <div class="caccordion-item mb-4 position-relative zi-2">
                 <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="headingOne">
                        ...
                        The concept behind building an iOS app for business should be kept confidential. Will you sign an NDA?
                        </button>
                     </div>
                   ...
                   <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="headingThree">
                        ...
                        Do I own the rights to my application's code and ownership?
                        </button>
                     </div>
                     <div id="collapseThree" class="position-relative accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                        As a top iOS app development company, we give you ownership of the application and the source code after it is successfully launched on the App Store. Our Custom iPhone App Development Company always prefer to have upfront communication with our clients about the ownership of the source code once the app is built. Once both the parties mutually agree we prefer to sign a contract.
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="headingThree33">
                        ...
                        How allocation of resources is done for the development of my iOS app?
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="headingThree333">
                        ...
                        Can you assist to get my iOS application launched on the Apple Store once it is developed?
                        </button>
                     </div>
                     <div id="collapseThree333" class="position-relative accordion-collapse collapse" aria-labelledby="headingThree333" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                           <div class="col-12">
                           Yes. Actually, we handle every aspect of publishing an app on the App Store by ourselves. It is a part of our comprehensive bundle of iOS app 
                           development services. For a thorough understanding of iOS application development, visit our iOS app development guide.
                           </div>
                         </div>
                     </div>
                  </div>
...
<script src="{{asset('/public')}}/assets/js/iOS-app-development-company.min.js"></script>
