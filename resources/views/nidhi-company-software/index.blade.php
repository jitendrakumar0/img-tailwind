...
@push('meta')
   <!--  Title -->
   <title>Nidhi Company Software | Best Nidhi Banking Software Online</title>

   <!-- Required meta tags -->
   <meta name="title" content="Nidhi Company Software | Best Nidhi Banking Software Online" />
   <meta name="description" content="Nidhi Company Software Online. IMG Global Infotech is one of the best Nidhi Banking Software development company that offers auto employee & loan modules." />
   <meta name="keywords" content="nidhi company software, nidhi banking software, online nidhi software" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Nidhi Company Software | Best Nidhi Banking Software Online">
   <meta name="twitter:description" content="Nidhi Company Software Online. IMG Global Infotech is one of the best Nidhi Banking Software development company that offers auto employee & loan modules.">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/nidhi-company-software/Nidhi-Company-Software.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}nidhi-company-software.php">
   <meta property="og:title" content="Nidhi Company Software | Best Nidhi Banking Software Online">
   <meta property="og:description" content="Nidhi Company Software Online. IMG Global Infotech is one of the best Nidhi Banking Software development company that offers auto employee & loan modules.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/nidhi-company-software/Nidhi-Company-Software.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/nidhi-company-software/Nidhi-Company-Software.webp">



   <meta name="classification" content="nidhi company software, nidhi banking software, online nidhi software" />
   <link rel="canonical" href="{{asset('/')}}nidhi-company-software.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/nidhi-company-software.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Nidhi Company Software</h1>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                            <img src="{{GETFOLDERPATH()}}/nidhi-company-software-1.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Nidhi-Company-Software.webp"alt="Nidhi Company Software" width="100" height="auto">   
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- What Is Nidhi Software? section -->
   <div class="container-fluid overflow-hidden what-is-software-section bg-white position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/nidhi-company-software/What-Is-Nidhi-Software.webp" alt="What Is Nidhi Software?">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">What Is Nidhi Software?</h2>
            ...
            <div class="col-12">
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part order-lg-2 order-1">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/nidhi-company-software/Why-Do-You-Need-Nidhi-Software.webp" alt="Why Do You Need Nidhi Software?">
                         </div>
                     </div>
                  </div>
                  <div class="col-lg-7 order-lg-1 order-2">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Why Do You Need Nidhi Software?</h2>
   ...
   <div class="container-fluid overflow-hidden ecommerce_solutions position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Why choose IMG Global Infotech Nidhi Software?</h2>
            <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Why choose IMG Global Infotech<b> Nidhi Software? </b></span></div>
         </div>
         <div class="row">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="fs-50 text-theme1 position-relative">
                              <img src="{{asset('/public')}}/assets/img/nidhi-company-software/TERM-DEPOSITS.webp" class=" h-60px" alt="Term deposits">
                           </span>
                        </div>
                        <div class="col-12">
                           <div class="row">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="fs-50 text-theme1 position-relative">
                              <img src="{{asset('/public')}}/assets/img/nidhi-company-software/SHARE-MANAGEMENT.webp" class=" h-60px" alt="Share Management">
                           </span>
                        </div>
                        <div class="col-12">
                           <div class="row">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="fs-50 text-theme1 position-relative">
                              <img src="{{asset('/public')}}/assets/img/nidhi-company-software/MEMBERSHIP-MANAGEMENT.webp" class=" h-60px" alt="Membership Management">
                           </span>
                        </div>
                        <div class="col-12">
                           <div class="row">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="fs-50 text-theme1 position-relative">
                              <img src="{{asset('/public')}}/assets/img/nidhi-company-software/ADVANCED-AND-LOANS.webp" class=" h-60px" alt="Advanced and loans">
                           </span>
                        </div>
                        <div class="col-12">
                           <div class="row">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="fs-50 text-theme1 position-relative">
                              <img src="{{asset('/public')}}/assets/img/nidhi-company-software/REPORT.webp" class=" h-60px" alt="Report">
                           </span>
                        </div>
                        <div class="col-12">
                           <div class="row">
               ...
               <div class="row mx-2 h-100">
                  <div class="col-12 shadow rounded h-100 benifit-item">
                     <div class="row text-center pt-4 pb-5 h-100">
                        <div class="col-12">
                           <span class="fs-50 text-theme1 position-relative">
                              <img src="{{asset('/public')}}/assets/img/nidhi-company-software/ACCOUNTING.webp" class=" h-60px" alt="Accounting">
                           </span>
                        </div>
                        <div class="col-12">
                           <div class="row">
   ...
   @endsection
   @push('scripts')
      <script src="{{asset('/public')}}/assets/js/nidhi-company-software.min.js"></script>
   @endpush