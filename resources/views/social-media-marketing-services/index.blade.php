...
@push('meta')
   <!--  Title -->
   <title>Social Media Marketing Company India | SMO & SMM Services</title>

   <!-- Required meta tags -->
   <meta name="title" content="Social Media Marketing Company India | SMO & SMM Services" />
   ...
   <meta name="keywords" content="social media marketing agency, social media marketing company, social media marketing services, social media agency, social media services, smo services, social media optimization services, social media optimization company" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Social Media Marketing Company India | SMO & SMM Services">
   ...
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/social-media-marketing-services/5.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}social-media-marketing-services.php">
   <meta property="og:title" content="Social Media Marketing Company India | SMO & SMM Services">
   ...
   <meta property="og:image" content="{{asset('/public')}}/assets/img/social-media-marketing-services/5.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/social-media-marketing-services/5.webp">



   <meta name="classification" content="social media marketing agency, social media marketing company, social media marketing services, social media agency, social media services, smo services, social media optimization services, social media optimization company" />
   <link rel="canonical" href="{{asset('/')}}social-media-marketing-services.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/social-media-marketing-services.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Social Media Marketing Company</h1>
                              <div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Social Media <b>Marketing Company</b></span></div>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           <img src="{{GETFOLDERPATH()}}/social-media-marketing-services-1.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Social-Media-Marketing-Company.webp"alt="Social-Media-Marketing-Company" width="100" height="auto">
                         </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        ...
                        <img src="{{GETFOLDERPATH()}}/social-media-marketing-services-2.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Best-Social-Media-Marketing-Agency-in-India.webp"alt="Best-Social-Media-Marketing-Agency-in-India" width="100" height="auto">  
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Best Social Media Marketing Agency in India</h2>
            ...
            <div class="col-lg-6">
               ...
               <div class="row s-sidebar px-4 py-2 gap-4">
                  <a href="javascript:;" id="app-service-1" class="col-auto s-item wave-1 active" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Audit</h3>
                        <div class="col"><span class="d-block">Audit</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-2" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Build Your Audience</h3>
                        <div class="col"><span class="d-block">Build Your Audience</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-3" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Customer Engagement</h3>
                        <div class="col"><span class="d-block">Customer Engagement</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-4" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Social Posting</h3>
                        <div class="col"><span class="d-block">Social Posting</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-5" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Social Media Advertising</h3>
                        <div class="col"><span class="d-block">Social Media Advertising</span></div>
                     </div>
                  </a>
               </div>
            </div>
            <div class="col-lg-6 all-app-services mt-lg-0 mt-4">
...
<script src="{{asset('/public')}}/assets/js/social-media-marketing-services.min.js"></script>
