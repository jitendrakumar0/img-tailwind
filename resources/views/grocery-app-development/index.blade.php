...
@push('meta')
   <!--  Title -->
   <title>On-Demand Grocery App Development Company | Grocery App Development Company</title>

   <!-- Required meta tags -->
   <meta name="title" content="On-Demand Grocery App Development Company | Grocery App Development Company" />
   <meta name="description" content="IMG Global Infotech is top-notch grocery app development company, offers the best grocery mobile app solutions for businesses that want to sell their products online. " />
   <meta name="keywords" content="" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="On-Demand Grocery App Development Company | Grocery App Development Company">
   <meta name="twitter:description" content="IMG Global Infotech is top-notch grocery app development company, offers the best grocery mobile app solutions for businesses that want to sell their products online. ">
   <meta name="twitter:image" content="{{GETFOLDERPATH()}}/grocery-app-development-company.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}grocery-app-development.php">
   <meta property="og:title" content="On-Demand Grocery App Development Company | Grocery App Development Company">
   <meta property="og:description" content="IMG Global Infotech is top-notch grocery app development company, offers the best grocery mobile app solutions for businesses that want to sell their products online. ">
   <meta property="og:image" content="{{GETFOLDERPATH()}}/grocery-app-development-company.webp">
   <meta property="og:image:secure_url" content="{{GETFOLDERPATH()}}/grocery-app-development-company.webp">
...
<span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Grocery App Development Company</b></span>
@endsection('hero_heading')
@section('hero_tagline')
Leverage the best mobile Grocery App Development using the most robust and latest technology you've ever come across.
...
@endsection('hero_btn')
@section('hero_img')
<img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/grocery-app-development-company.webp" alt="grocery app development company">
@endsection('hero_img')
@include('inner-page-section.hero.index')
   ...
   <div class="container-fluid overflow-hidden services-coman bg-white position-relative">
                 ...
                 <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative text-center leftside">
                           <img class="w-lg-100 w-50 position-relative" src="{{GETFOLDERPATH()}}/grocerydeliveryapp.webp" alt="grocery delivery app">
                        </div>
                     </div>
                  </div>
                 <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pt-lg-0">
                                 ...
                                 <div class="row mx-0">
                                    <h2 class="d-none invisible">Affordable On-demand Grocery App Development Solution </h2>
                                    <div class="col-12 heading fs-md-14 fs-12 left text-dark">
                                       <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Affordable On-demand Grocery App <b> Development Solution </b></span></div>
                                 </div>
                              </div>
                            </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">Technology has accelerated the use of mobile phones and other things for people in the digital era. This has also helped businesses reach their intended audiences. If you're thinking of establishing a business, an app solution is an investment you should consider.  </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">Hire IMG Global Infotech and experience the top-notch solution for your Grocery mobile app solutions. We cater to our customers' every demand and offer a bespoke solution at the best market price. We have skilled developers with apt knowledge and an eye for details. Connecting with our brilliant team will keep your worries aside and provide you with peace of mind and the best result.</div>
                     </div>
     ...
     <!-- why-should-section section -->
     <div class="container-fluid overflow-hidden why-should-section bg-white position-relative">
      <div class="container py-md-5 py-4 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row align-items-center">
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pt-lg-0">
                                 <div class="col-12 p-0">
                                 <div class="row mx-0">
                                    <h2 class="d-none invisible">Why you should choose Grocery mobile application development as a business App for Android and iOS</h2>
                                    <div class="col-12 heading fs-md-14 fs-12 left text-white">
                                       <span class="fs-xl-29 fs-lg-28 fs-md-24 fs-20">Why You Should Choose Grocery mobile Application Development As a <b>Business App for Android and iOS </b></span></div>
                                 </div>
                              </div>
                            </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white text-lg-start text-center mt-3">The grocery delivery industry has experienced a surge in demand as customers increasingly opt for online grocery shopping and delivery. This trend has presented a unique opportunity for grocery stores to capitalize on this shift by developing a mobile app for Android and iOS. </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white text-lg-start text-center mt-3">Fortunately, technology has developed so far that now people can order from the comfort of their comfort and get the order in just a few minutes. It saves their time from their hectic schedules and lives. With such a trend, Grocery App For Online Shopping can be beneficial to companies, wholesalers, and small retailers. </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white text-lg-start text-center mt-3">So take a step forward and look for a Grocery App Development Company that can go above and beyond to deliver a quality solution within your budget. This gives your business a face that will help it grow smoothly. We strive to give you the most reliable shopping experience ever.</div>
                     </div>
                    </div>
                    <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative text-center leftside">
                           <img class="w-lg-100 w-40 position-relative " src="{{GETFOLDERPATH()}}/why-choose-mobile-app.webp" alt="why choose mobile app">
                        </div>
                     </div>
                  </div>
                </div>
      ...
      <div class="container py-lg-5 py-md-5 py-4 zi-2 position-relative">
         <div class="row">
               <div class="row mx-0 pb-4">
                  <h3 class="d-none invisible">Online Grocery Ordering System</h3>
                  <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Online Grocery  <b> Ordering System </b></span></div>
               </div>
               </div>
               ...
               <div class="row develop-boxes mt-4">
                     ...
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon01.webp" width="100" height="auto" alt="User friendly">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">User-friendly</h3>
                           <div class="col-12 text-start fw-m text-white fs-md-24 fs-sm-17 fs-16 lh-normal">User-friendly</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-white mt-2">An app that is easy to use, navigate, and understand. </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon02.webp" width="100" height="auto" alt="Online Payment">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Online Payment</h3>
                           <div class="col-12 text-start fw-m text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Online Payment</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Pay via different online modes; Use a credit or debit card.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon03.webp" width="100" height="auto" alt="In App Chat">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">In-App Chat</h3>
                           <div class="col-12 text-start fw-m text-white fs-md-24 fs-sm-17 fs-16 lh-normal">In-App Chat</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-white mt-2">Connect with the supplier and chat about your queries and concerns.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon04.webp" width="100" height="auto" alt="Deals & Rewards">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Deals & Rewards</h3>
                           <div class="col-12 text-start fw-m text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Deals & Rewards</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Earn deals and rewards with your every shopping.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon05.webp" width="100" height="auto" alt="Product Review">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">Product Review</h3>
                           <div class="col-12 text-start fw-m text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Product Review</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-white mt-2">Shop for a quality product, and check reviews before buying.</div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        <div class="col-auto">
                           <span class="d-flex align-items-center justify-content-center h-80px w-80px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white">
                              <img class="w-40px" src="{{GETFOLDERPATH()}}/grocery_user_icon06.webp" width="100" height="auto" alt="On Grocery App">
                           </span>
                        </div>
                        <div class="col">
                           <h3 class="d-none invisible">On Grocery App</h3>
                           <div class="col-12 text-start fw-m text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">On Grocery App</div>
                           <div class="col-12 text-start fw-l fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Shop conveniently on our Grocery app and find the best deals and make your shopping convenient.</div>
                        </div>
                     </div>
                  </div>
                </div>
     ...
     <div class="image-layer"></div>
      <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
         <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
            ...
            <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> On-demand Grocery   <b> App Features </b></span></div>
            <div class="cpl-12 col-md-10 fw-l fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">On Demand Grocery App Development. Deorwine Infotech is a reputed grocery app development company providing on-demand grocery mobile app and same day grocery mobile app development for iPhone & Android.
            </div>
         </div>
            <div class="row d-flex align-items-center ">
                <div class="col-lg-8 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">  
                     <ul class="nav nav-tabs border-0">
                           ...
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-l my-3 py-2 mx-1 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu1">Driver App</a>
                           </li>
                           <li class="nav-item">
                        ...
                        <div class="tab-pane container active p-0" id="home">
                           <div class="row mt-lg-0 mt-md-0 mt-3">
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">             
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/login1.webp" class="w-25" width="100" height="auto" alt="Social Media Login"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Social Media Login</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/social-login.webp" class="w-20" width="100" height="auto" alt="Search Nearby Stores"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Search Nearby Stores</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/track.webp" class="w-25" width="100" height="auto" alt="Add To Cart"></div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Add To Wishlist"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Add To Wishlist</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/search-ad.webp" class="w-25" width="100" height="auto" alt="Live Order Tracking"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Live Order Tracking</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-cart.webp" class="w-25" width="100" height="auto" alt="inApp Payments"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">inApp Payments</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">            
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-wishlist.webp" class="w-25" width="100" height="auto" alt="Ratings & Reviews"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Ratings & Reviews</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/shedule-delivery.webp" class="w-25" width="100" height="auto" alt="Transaction History"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Transaction History</div>
                                          </div>
                                    </div>
                              </div>
                     ...
                     <div class="tab-pane container fade p-0" id="menu1">
                         <div class="row mt-lg-0 mt-md-0 mt-3">
                            <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/login1.webp" class="w-25" width="100" height="auto" alt="Manage Availability"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Availability</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/social-login.webp" class="w-20" width="100" height="auto" alt="Order Requests"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Order Requests</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/track.webp" class="w-25" width="100" height="auto" alt="Manage Payments"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Payments</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Live Tracking"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Live Tracking</div>
                                          </div>
                                    </div>
                              </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">           
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/search-ad.webp" class="w-25" width="100" height="auto" alt="Profile"></div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-cart.webp" class="w-25" width="100" height="auto" alt="Ratings & Reviews"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Ratings & Reviews</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-wishlist.webp" class="w-25" width="100" height="auto" alt="Transaction History"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Transaction History</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/shedule-delivery.webp" class="w-25" width="100" height="auto" alt="Push Notifications"></div>
                     ...
                     <div class="tab-pane container fade p-0" id="menu2">
                           <div class="row mt-lg-0 mt-md-0 mt-3">
                            <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/login1.webp" class="w-25" width="100" height="auto" alt="Authentication"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Authentication</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/social-login.webp" class="w-20" width="100" height="auto" alt="Social Signup"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Dashboard</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/track.webp" class="w-25" width="100" height="auto" alt="Location Based Search"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Orders Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                  
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/browse-product.webp" class="w-25" width="100" height="auto" alt="Browse Products"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Coupons, Discounts, and Offers</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">               
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/search-ad.webp" class="w-25" width="100" height="auto" alt="Advance Search"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Add / Edit / Delete</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">        
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-cart.webp" class="w-25" width="100" height="auto" alt="Sub admin creation"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Sub-admin creation</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/add-to-wishlist.webp" class="w-25" width="100" height="auto" alt="Content Management"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Content Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          <div class="col-12 icon"><img src="{{GETFOLDERPATH()}}/shedule-delivery.webp" class="w-25" width="100" height="auto" alt="Reports"></div>
                                          <div class="col-12 text-dark fw-m fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Reports</div>
                                          </div>
                                    </div>
                              </div>
                   ...
                   <div class="container">
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-12 col-md-12 col-12 py-2">
                           <h3 class="d-none invisible">Ready to Build an Online Mobile App Solution for Grocery Business?</h3>
                           <div class="col-12 fw-m fs-md-33 fs-lg-33 fs-24 text-white  text-md-center text-center">Ready to Build an Online Mobile App Solution for Grocery Business?</div>
                           <div class="col-md-8 col-12 fw-l fs-md-18 fs-lg-18 fs-16 text-white text-md-center text-center mx-auto">Take your business to the next level with Grocery Delivery App Developer. Our team will create a bespoke solution depending on your requirements using state-of-the-art techniques.</div>
                        </div>
                           <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-center justify-content-md-center justify-content-center py-3">
                               <a href="{{asset('/grocery-app-development-company-1.php#contactWithUss')}}" class="btn expert-btn fs-lg-15 fs-md-15 fs-14 fw-m py-3 px-md-4 px-4 bg-white">
                  ...
                  <div class="row align-content-center align-items-center position-relative">
                     <div class="col-lg-7 col-md-12">
                        <div class="row mx-0 pb-3">
                          <h3 class="d-none invisible"> Why Is IMG Global Infotech The Best Company For Grocery App Development?</h3> 
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-33 fs-lg-29 fs-md-24 fs-20 text-dark"> Why Is IMG Global Infotech The Best Company  <b>For Grocery App Development? </b></span></div>
                           </div>
                           <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-mute mb-4">   
                           We offer comprehensive grocery app development services, including UI/UX design, custom development, testing, and deployment. With years of experience and a proven track record, we can help you create a user-friendly and efficient grocery app that meets all your requirements.
                        </div>
                           <div>
                              <div class="row">
               ...
               <div class="accordion" id="accordionExample">
                  <div class="accordion-item mb-4 position-relative zi-2">
                     ...
                     <div id="collapseOne" class="position-relative accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        ...
                        The programming language used for mobile app development depends on the platform you want to develop for. For iOS, Swift and Objective-C are commonly used, while Java and Kotlin are popular for Android development.
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     ...
                     <div id="collapseTwo" class="position-relative accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                        YES! There is no doubt about this. Today, the IT sector is growing, and the development part is at its peak. Online presence is a must for every business, and so is a website. 
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item mb-4 position-relative zi-2">
                     ...
                     <div id="collapseThree" class="position-relative accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                        A mobile app development company is responsible for designing, developing, and maintaining mobile applications for various platforms, such as iOS and Android. They work closely with clients to understand their requirements and provide customized solutions that meet their business needs.
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     ...
                     <div id="collapsefour" class="position-relative accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-l fs-lg-15 fs-md-14 text-muted fs-14">
                        With a highly skilled and professional team, IMG Global Infotech prides itself on delivering quality service that meets the client's expectations and goes beyond. We adhere to cutting-edge technology to design and develop the app for iOS and Android.
                        </div>
                     </div>
                  </div>
              </div>
              ...
              <div class="col-lg-12 col-sm-12 col-md-12 rounded-4 ">      
                <div class="row fantasy-cricket-sldier owl-carousel ">
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4 ">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico  rounded mb-2 text-center">
                          ...
                          <h3 class="d-none invisible">Food Delivery App Development</h3>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                          ...
                          <h3 class="d-none invisible">Medicine App Development</h3>
                        <div class="col-12 fw-m text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Medicine App  <br>Development</div>
                     </div>
                  </div>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                          ...
                          <h3 class="d-none invisible">Healthcare App  Development</h3>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                          ...
                          <h3 class="d-none invisible">Clothing App Development</h3>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                           <img src="{{GETFOLDERPATH()}}/b2b.webp" alt="Jewellery PHP Development" class="mx-auto w-lg-20 w-md-20 w-30"></div>
                          <h3 class="d-none invisible">Jewellery PHP Development</h3>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                           <img src="{{GETFOLDERPATH()}}/ecome.webp" alt="Clothing App Developmen" class="mx-auto w-lg-20 w-md-20 w-30"></div>
                          <h3 class="d-none invisible">Clothing App Development</h3>
                        <div class="col-12 fw-m text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Clothing  App <br>Development</div>
                     </div>
                  </div>
                  ...
                  <div class="w-lg-100 w-md-100 w-100 mb-4 rounded-4">
                     <div class="service-box h-100 text-center rounded shadowp-lg-4 p-md-4 p-2 rounded-4">
                        <div class="col-12 service_ico justify-content-center align-items-center rounded mb-2">
                          ...
                          <h3 class="d-none invisible">Jewellery App Development</h3>
                        <div class="col-12 fw-m text-balck fs-md-15 fs-sm-18 fs-15 lh-normal tz" style="--tz:30px;">Jewellery App<br>Development</div>
                     </div>
                  </div>
                </div>
...
<script src="{{asset('/public')}}/assets/js/grocery-app-development-company.min.js"></script>
