...
@section('content')
 ...
 {{-- Hero Section --}}
   ...
   Scale your retail business with our revolutionary eCommerce website development services.
         ...
         <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 mb-4 d-flex align-items-stretch">
               <div class="service-box text-center w-100 rounded shadow">
                  ...
                  <h3 class="d-none invisible">Fashion</h3>
                  <div class="col-12 fw-m text-theme1 fs-md-19 fs-sm-18 fs-17 lh-normal tz" style="--tz:30px;">Fashion</div>
             ...
             <div class="row align-items-center justify-content-center owl-portfolio-slider owl-carousel mx-0">
                 <div class="col-lg-12 col-md-12">
                    <div class="portfolioBox">
                       ...
                       data-src="{{asset('/public')}}/assets/img/portfolio-section/starquik.webp" alt="starquik">
                          <div class="portfolioBoxContent">
                            <h4>Starquik</h4>
                            <p>Grocery Ecommerce Website</p>
                        </div>
                    </div>
                </div>
				<div class="col-lg-12 col-md-12">
                    <div class="portfolioBox ">
                     <img src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp" class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1"
                       data-src="{{asset('/public')}}/assets/img/portfolio-section/umbra.webp" alt="umbra">
                         <div class="portfolioBoxContent">
                            <h4>Umbra</h4>
                            <p>Furniture Ecommerce Website</p>
                        </div>
                    </div>
                </div>
				<div class="col-lg-12 col-md-12 ">
				...
				<div class="col-lg-12 col-md-12 ">
                    <div class="portfolioBox">
                      <img src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp"class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1" 
                            data-src="{{asset('/public')}}/assets/img/portfolio-section/deliveroo.webp" alt="deliveroo">
                                <div class="portfolioBoxContent">
                                    <h4>Deliveroo</h4>
                                    <p>Food Delivery Ecommerce Website</p>
                                </div>
                         </div>
                 </div>
                 <div class="col-lg-12 col-md-12 ">
                    <div class="portfolioBox ">
                      <img src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp" class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1"
                       data-src="{{asset('/public')}}/assets/img/portfolio-section/fabindia.webp" alt="fabindia">
                             <div class="portfolioBoxContent">
                            <h4>Fabindia</h4>
                            <p>Fashion Website</p>
                        </div>
                ...
                <div class="col-lg-12 col-md-12 ">
                    <div class="portfolioBox ">
                      <img src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp" class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1"
                       data-src="{{asset('/public')}}/assets/img/portfolio-section/zoniraz.webp" alt="zoniraz">
                             <div class="portfolioBoxContent">
                            <h4>Zoniraz</h4>
                            <p>Jewellery Website</p>
                        </div>
                    </div>
                </div>
			</div>
