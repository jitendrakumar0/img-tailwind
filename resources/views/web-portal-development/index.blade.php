...
@push('meta')
   <!--  Title -->
   <title>Custom Web Portal Development, Web Portal Development Company India- IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Custom Web Portal Development, Web Portal Development Company India- IMG Global Infotech" />
   <meta name="description" content="Looking for a web portal development company? IMG Global Infotech is top rated web portal development company in India serving businesses across the globe." />
   <meta name="keywords" content="Web Portal Development, Web Portal Development Company, Web Portal Development Services, Web Portal Development Solution, Website Portal Development Company, Website Portal Development Services, Web Portal Development Firm, Web Portal Development in India, Web Portal Development Company in India, Web Portal Development Services in India, Web Portal Development Solution in India, Website Portal Development Company in India, Website Portal Development Services in India, Web Portal Development Firm in India, Web Portal Development in Jaipur, Web Portal Development Company in Jaipur, Web Portal Development Services in Jaipur, Web Portal Development Solution in Jaipur, Website Portal Development Company in Jaipur, Website Portal Development Services in Jaipur, Web Portal Development Firm in Jaipur" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Custom Web Portal Development, Web Portal Development Company India- IMG Global Infotech">
   <meta name="twitter:description" content="Looking for a web portal development company? IMG Global Infotech is top rated web portal development company in India serving businesses across the globe.">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/web-portal-development/Web-Portal-Development.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}web-portal-development.php">
   <meta property="og:title" content="Custom Web Portal Development, Web Portal Development Company India- IMG Global Infotech">
   <meta property="og:description" content="Looking for a web portal development company? IMG Global Infotech is top rated web portal development company in India serving businesses across the globe.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/web-portal-development/Web-Portal-Development.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/web-portal-development/Web-Portal-Development.webp">


   
   <meta name="classification" content="Web Portal Development, Web Portal Development Company, Web Portal Development Services, Web Portal Development Solution, Website Portal Development Company, Website Portal Development Services, Web Portal Development Firm, Web Portal Development in India, Web Portal Development Company in India, Web Portal Development Services in India, Web Portal Development Solution in India, Website Portal Development Company in India, Website Portal Development Services in India, Web Portal Development Firm in India, Web Portal Development in Jaipur, Web Portal Development Company in Jaipur, Web Portal Development Services in Jaipur, Web Portal Development Solution in Jaipur, Website Portal Development Company in Jaipur, Website Portal Development Services in Jaipur, Web Portal Development Firm in Jaipur" />
   <link rel="canonical" href="{{asset('/')}}web-portal-development.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/web-portal-development.min.css">
...
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center position-relative">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Web Portal Development</h1>
                              <div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Web Portal <b> Development</b></span></div>
                           </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white mt-3 mb-lg-3">As a Web Portal Development from India, IMG Global InfoTech having Web Portal Developers offers portal designing and web development services to its clients at best prices in the market. The modern business is Internet driven and if you want to expand your business horizons it is necessary to have a professionally developed web portal that reflects your business. IMG Global Infotech is a professional web portal development company, which provides comprehensive portal development services.</div>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;">
                           <img src="{{GETFOLDERPATH()}}/web-portal-development-1.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Web-Portal-Development.webp"alt="Web Portal Development" width="100" height="auto">  
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="container-fluid overflow-hidden portal-management bg-white position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                         <div class="col-lg-10 col-md-5 col-7 position-relative">
                            <img src="{{GETFOLDERPATH()}}/web-portal-development-2.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Benefits-Of-Taking-Online-Portal-Management.webp"alt="Benefits-Of-Taking-Online-Portal-Management" width="100" height="auto">   
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4">
                              <h2 class="d-none invisible">Benefits Of Taking Online Portal Management</h2>
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Benefits Of Taking <b> Online Portal Management</b></span></div>
                           </div>
                        </div>
                        <div class="col-12 mt-3">
                           <div class="row align-items-center">
                              <div class="col-auto">
                                 <i class="imgs img-star rounded-pill text-white fs-md-18 fs-16 bg-theme1 d-flex w-md-55px w-45px h-md-55px h-45px justify-content-center align-items-center position-relative zi-2 left-md-n8px left-n15px"></i>
                              </div>
                              <h3 class="d-none invisible">User Engagement</h3>
                              <div class="col fs-md-15 fs-14 text-dark bg-white ps-md-5 ps-4 py-2 zi-0 rounded position-relative border border-theme1 border-3 ms-n5"><strong class="d-block fw-m mb-2">User Engagement </strong> Mobile-friendly, adaptive design with a unified look-and-feel across all screens. Media-rich pages displaying embedded media, uploaded directly or hosted via YouTube, Vimeo and other websites.</div>
                           </div>
                        </div>
                        <div class="col-12 mt-3">
                           <div class="row align-items-center">
                              <div class="col-auto">
                                 <i class="imgs img-star rounded-pill text-white fs-md-18 fs-16 bg-theme2 d-flex w-md-55px w-45px h-md-55px h-45px justify-content-center align-items-center position-relative zi-2 left-md-n8px left-n15px"></i>
                              </div>
                              <h3 class="d-none invisible">Reliability</h3>
                              <div class="col fs-md-15 fs-14 text-dark bg-white ps-md-5 ps-4 py-2 zi-0 rounded position-relative border border-theme2 border-3 ms-n5"><strong class="d-block fw-m mb-2"> Reliability </strong> Scalability to handle the growing number of users and data. High performance to ensure users can access the content and tools quickly.</div>
                           </div>
                        </div>
                        <div class="col-12 mt-3">
                           <div class="row align-items-center">
                              <div class="col-auto">
                                 <i class="imgs img-star rounded-pill text-white fs-md-18 fs-16 bg-success d-flex w-md-55px w-45px h-md-55px h-45px justify-content-center align-items-center position-relative zi-2 left-md-n8px left-n15px"></i>
                              </div>
                              <h3 class="d-none invisible">Easy Content Management</h3>
                              <div class="col fs-md-15 fs-14 text-dark bg-white ps-md-5 ps-4 py-2 zi-0 rounded position-relative border border-success border-3 ms-n5"> <strong class="d-block fw-m mb-2">Easy Content Management </strong> Non-technical users can update the content easily and regularly. Unified content publishing styles to bring order to inform and ensure integrity during the portal updates.</div>
                           </div>
                        </div>
                        <div class="col-12 mt-3">
                           <div class="row align-items-center">
                              <div class="col-auto">
                                 <i class="imgs img-star rounded-pill text-white fs-md-18 fs-16 bg-theme3 d-flex w-md-55px w-45px h-md-55px h-45px justify-content-center align-items-center position-relative zi-2 left-md-n8px left-n15px"></i>
                              </div>
                              <h3 class="d-none invisible">Integration</h3>
                              <div class="col fs-md-15 fs-14 text-dark bg-white ps-md-5 ps-4 py-2 zi-0 rounded position-relative border border-theme3 border-3 ms-n5"><strong class="d-block fw-m mb-2">Integration </strong> Automated integration with other business systems such as ERP, CRM, HRM, e-commerce solutions and others. API development to guarantee tight integration with your customers’ vendors’ ERP systems, if needed. </div>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <div class="container-fluid overflow-hidden portal_services bg-white position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row mx-0 pb-5">
                  <h2 class="d-none invisible">The Treasure Of Online Portal Services Here</h2>
                  <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> The Treasure Of Online <b> Portal Services Here</b></span></div>
               </div>
            </div>
         </div>
         <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 mb-4">
               <a href="{{asset('/')}}news-portal-development.php" class="portal_services_box d-block text-decoration-none bg-white  px-4 py-md-5 py-4 text-center">
                  <span class="api_ico d-block mb-3">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/News-Portal.webp" alt="NEWS PORTAL">
                  </span>
                  <h3 class="d-none invisible">NEWS PORTAL</h3>
                  <div class="col-12 fw-m text-theme1 fs-lg-18 fs-md-17 fs-16  lh-normal mt-2 tz" style="--tz:30px;">NEWS PORTAL</div>
                  {{-- <div class="col-12 fw-l fs-lg-16 fs-md-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos, minima, enim provident possimus numquam sapiente.</div> --}}
               </a>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
               <a href="{{asset('/')}}property-portal-development.php" class="portal_services_box d-block text-decoration-none bg-white  px-4 py-md-5 py-4 text-center">
                  <span class="api_ico d-block mb-3">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Property-Portal.webp" alt="PROPERTY PORTAL">
                  </span>
                  <h3 class="d-none invisible">PROPERTY PORTAL</h3>
                  <div class="col-12 fw-m text-theme1 fs-lg-18 fs-md-17 fs-16  lh-normal mt-2 tz" style="--tz:30px;">PROPERTY PORTAL</div>
                  {{-- <div class="col-12 fw-l fs-lg-16 fs-md-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos, minima, enim provident possimus numquam sapiente.</div> --}}
               </a>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
               <a href="{{asset('/')}}matrimonial-portal-development.php" class="portal_services_box d-block text-decoration-none bg-white  px-4 py-md-5 py-4 text-center">
                  <span class="api_ico d-block mb-3">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Matrimonial-Portal.webp" alt="MATRIMONIAL PORTAL">
                  </span>
                  <h3 class="d-none invisible">MATRIMONIAL PORTAL</h3>
                  <div class="col-12 fw-m text-theme1 fs-lg-18 fs-md-17 fs-16  lh-normal mt-2 tz" style="--tz:30px;">MATRIMONIAL PORTAL</div>
                  {{-- <div class="col-12 fw-l fs-lg-16 fs-md-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos, minima, enim provident possimus numquam sapiente.</div> --}}
               </a>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
               <a href="{{asset('/')}}financial-portal-development.php" class="portal_services_box d-block text-decoration-none bg-white  px-4 py-md-5 py-4 text-center">
                  <span class="api_ico d-block mb-3">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Financial-Portal.webp" alt="FINANCIAL PORTAL">
                  </span>
                  <h3 class="d-none invisible">FINANCIAL PORTAL</h3>
                  <div class="col-12 fw-m text-theme1 fs-lg-18 fs-md-17 fs-16  lh-normal mt-2 tz" style="--tz:30px;">FINANCIAL PORTAL</div>
                  {{-- <div class="col-12 fw-l fs-lg-16 fs-md-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos, minima, enim provident possimus numquam sapiente.</div> --}}
               </a>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
               <a href="{{asset('/')}}education-portal-development.php" class="portal_services_box d-block text-decoration-none bg-white  px-4 py-md-5 py-4 text-center">
                  <span class="api_ico d-block mb-3">
                     <img class="h-60px" src="{{GETFOLDERPATH()}}/Education--Portal.webp" alt="EDUCATION PORTAL">
                  </span>
                  <h3 class="d-none invisible">EDUCATION PORTAL</h3>
                  <div class="col-12 fw-m text-theme1 fs-lg-18 fs-md-17 fs-16  lh-normal mt-2 tz" style="--tz:30px;">EDUCATION PORTAL</div>
                  {{-- <div class="col-12 fw-l fs-lg-16 fs-md-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos, minima, enim provident possimus numquam sapiente.</div> --}}
               </a>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="row mx-0 pb-4">
                  ...
                  <div class="col-12 heading fs-md-14 fs-12 center text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Get in touch with our experts and discuss <br> <b> how we can implement customized solution to improve your business growth. </b></span></div>
               </div>
            </div>
            <div class="col-12 pt-3 text-center">
               <a href="{{asset('/contact-us.php')}}" class="btn btn-theme1 fs-lg-14 fs-md-13 fs-12 fw-m py-2 px-lg-4 px-md-3 px-2" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                                       ...
                                       <option value="ZW +263">ZW +263</option>
                                             ...
                                             <div class="col-7 ps-0">
                                                <div class="form-floating">
                                                   ...
                                                   <input type="tel" name="tel" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control rounded-0 fs-md-16 fs-14 border border-0" id="phoneNumber" placeholder="Enter Phone Number" required>
                                         ...
                                         <div class="col-md-7">
                                                <div class="form-floating">
                                                    <select name="requirement" required="" class="form-control rounded-0 pt-2 fw-400">
                                                         ...
                                                         <option value="Web Portal Development" selcted="selcted">Web Portal Development</option>
                              ...
                              <div class="col-md-12">
                                    <div class="row">
                                       ...
                                       <option value="ZW +263">ZW +263</option>
                                            ...
                                            <div class="form-floating">
                                                <input type="tel" name="tel" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control rounded-0 border border-0" id="phoneNumber" placeholder="Enter Phone Number" required>
                              ...
                              <div class="col-md-12 ">
                                        <div class="form-floating">
                                            <select name="type"required="" id="type" class="form-control rounded-0 pt-2 fw-400">
                                                ...
                                                <option value="MLM Software Development">MLM Software Development</option>
                                                <option value="Website Design" >Website Design</option>
                                                <option value="Web Portal Development" selected="selected">Web Portal Development</option>
                                                <option value="Custom ERP Development">Custom ERP Development</option>
                                                <option value="Hire Dedicated Developer">Hire Dedicated Developer</option>
                                                <option value="SEO/Social Media Marketing">SEO/Social Media Marketing</option>
                                                <option value="Other Servicest" >Other Services</option>
...
<script src="{{asset('/public')}}/assets/js/web-portal-development.min.js"></script>
