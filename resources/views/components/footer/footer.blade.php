                                ...
                                <div class="md:mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="col-span-full">
                                        <div class="mt-2 w-full block">
                                            <label for="country" class="block text-sm font-medium text-gray-700 relative -z-20 -mt-5">Project Type*</label>
                                            <select id="country" name="country" autocomplete="country-name" class="block w-full rounded-md border-0 py-2.5 rounded-br-none text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-sky-400 invalid:ring-2 invalid:ring-inset invalid:ring-pink-600 sm:text-sm sm:leading-6">
                                    ...
                                    <div class="col-span-full">
                                        <div class="mt-2 flex justify-center items-center gap-3 text-center rounded-lg border border-dashed border-gray-900/25 px-3 py-5">
                                            ...
                                            <label for="file-upload" class="flex text-sm leading-6 text-gray-600 relative cursor-pointer rounded-md bg-white font-semibold">
                                                Upload a file
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 z-[1] relative">
        ...
        <div class="w-full flex flex-wrap py-8 gap-y-10 text-sm lg:text-base">
            <div class="w-full md:w-1/2 lg:w-1/4">
                <div class="flex flex-col w-full px-3">
                    ...
                    <a href="https://www.imgglobalinfotech.com/about-us.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                    ...
                    <a href="https://www.imgglobalinfotech.com/testimonials.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Testimonials</span>
                    </a>
                    <a href="https://www.flickr.com/photos/imgglobalinfotech" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Life @IMG</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/career.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Career</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/blog" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Blog</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/contact-us.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4">
                <div class="flex flex-col w-full px-3">
                    ...
                    <a href="https://www.imgglobalinfotech.com/mobile-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Mobile App Development</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/web-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                    ...
                    <a href="https://www.imgglobalinfotech.com/software-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Software Development</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/ecommerce-solutions.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4">
                <div class="flex flex-col w-full px-3">
                    ...
                    <a href="https://www.imgglobalinfotech.com/fantasy-sports-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Fantasy Sports App</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/healthcare-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Healthcare App</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/elearning-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Education App</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/food-delivery-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Food Delivery App</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                    ...
                    <a href="https://www.imgglobalinfotech.com/grocery-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Grocery Delivery</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/pharmacy-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
                        <span>Pharmacy App</span>
                    </a>
                    <a href="https://www.imgglobalinfotech.com/fitness-app-development.php" class="w-full opacity-80 hover:text-cyan-500 duration-200 py-4 md:py-1 hoverLink flex items-center gap-2">
                        <svg class="w-2.5 h-2.5 opacity-60" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96z"></path></svg>
        ...
        <div class="w-full flex flex-wrap items-center gap-x-10 gap-y-5 justify-center pt-8 lg:pt-14 lg:mt-8 border-t border-white/20 text-xs lg:text-sm">
            ...
            <div class="w-auto inline-flex flex-wrap gap-2 items-center">
                <a href="https://www.imgglobalinfotech.com/privacy-policy.php" class="w-auto opacity-80 hover:text-cyan-500 duration-200 hoverLink flex items-center gap-2">Privacy Policy</a>
                <div class="border-l border-white/20 h-4 w-[1px]"></div>
                <a href="https://www.imgglobalinfotech.com/terms-and-conditions.php" class="w-auto opacity-80 hover:text-cyan-500 duration-200 hoverLink flex items-center gap-2">Terms & Conditions</a>
                <div class="border-l border-white/20 h-4 w-[1px]"></div>
                <a href="https://www.imgglobalinfotech.com/disclaimer.php" class="w-auto opacity-80 hover:text-cyan-500 duration-200 hoverLink flex items-center gap-2">Disclaimer</a>
                <div class="border-l border-white/20 h-4 w-[1px]"></div>
                <a href="https://www.imgglobalinfotech.com/sitemap.html" class="w-auto opacity-80 hover:text-cyan-500 duration-200 hoverLink flex items-center gap-2">Sitemap</a>
            </div>
        </div>
    </div>
</footer>