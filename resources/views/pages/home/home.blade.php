...
<div class="relative isolate overflow-hidden">
    <div class="overflow-hidden bg-gradient-to-b from-white to-slate-200 pt-5 pb-36 sm:ps-0 ps-5 sm:pr-0 pr-5">
        <div class="absolute inset-x-0 top-0 h-96 z-0 text-slate-600/10 [mask-image:linear-gradient(to_top,transparent,white)]">
        ...
        <div class="pt-3 relative container mx-auto max-w-7xl px-6 lg:px-8 z-10">
            <p class="mt-4 select-none max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black">
                ...
                <span class="font-bold bg-gradient-to-r from-theme6 via-yellow-600 to-theme6 bg-clip-text text-transparent"> For You?</span>
            </p>
            <div class="md:text-base sm:text-sm text-xs text-black/70 mt-3 mb-lg-1">
                ...
                <div class="swiper servicesSwiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-sky-950 via-sky-900 to-sky-800 !pt-28">
                                ...
                                <p class="select-none max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-white">
                                ...
                                <div class="md:text-base sm:text-sm text-xs text-white/60 mt-3 mb-lg-1 md:font-semibold">
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Bespoke Software Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">SaaS Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">White Label Software Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">ERP Software Development</a></li>
                                    </ul>
                                </div>
                                <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Java</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">PHP</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">C#</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Ruby</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Python</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">JavaScript</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-fuchsia-950 via-fuchsia-900 to-fuchsia-800 !pt-28">
                                <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
                                    <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Android App Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Cross-Platform App Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">iOS App Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">PWA Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Flutter App Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Wearable App Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">React Native App Development</a></li>
                                    </ul>
                                </div>
                                <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Flutter</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Swift</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">React Native</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Kotlin</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Android</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">iOS</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-teal-950 via-teal-900 to-teal-800 !pt-28">
                                <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
                                    <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Website Design</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">CMS Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Responsive Website Design</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">API Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Website Redesign</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Web Portal Development</a></li>
                                    </ul>
                                </div>
                                <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">HTML5</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">CSS3</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Angular JS</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Node.Js</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Laraval</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                            <svg class="w-full h-full" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M439.8 200.5c-7.7-30.9-22.3-54.2-53.4-54.2h-40.1v47.4c0 36.8-31.2 67.8-66.8 67.8H172.7c-29.2 0-53.4 25-53.4 54.3v101.8c0 29 25.2 46 53.4 54.3 33.8 9.9 66.3 11.7 106.8 0 26.9-7.8 53.4-23.5 53.4-54.3v-40.7H226.2v-13.6h160.2c31.1 0 42.6-21.7 53.4-54.2 11.2-33.5 10.7-65.7 0-108.6zM286.2 404c11.1 0 20.1 9.1 20.1 20.3 0 11.3-9 20.4-20.1 20.4-11 0-20.1-9.2-20.1-20.4.1-11.3 9.1-20.3 20.1-20.3zM167.8 248.1h106.8c29.7 0 53.4-24.5 53.4-54.3V91.9c0-29-24.4-50.7-53.4-55.6-35.8-5.9-74.7-5.6-106.8.1-45.2 8-53.4 24.7-53.4 55.6v40.7h106.9v13.6h-147c-31.1 0-58.3 18.7-66.8 54.2-9.8 40.7-10.2 66.1 0 108.6 7.6 31.6 25.7 54.2 56.8 54.2H101v-48.8c0-35.3 30.5-66.4 66.8-66.4zm-6.7-142.6c-11.1 0-20.1-9.1-20.1-20.3.1-11.3 9-20.4 20.1-20.4 11 0 20.1 9.2 20.1 20.4s-9 20.3-20.1 20.3z"></path></svg>
                        ...
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-amber-950 via-amber-900 to-amber-800 !pt-28">
                                <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
                                    <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Blockchain Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Smart Contract Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">NFT Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">NFT Marketplace Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Cryptocurrency Exchange Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Metaverse Development</a></li>
                                    </ul>
                                </div>
                                <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Solidity</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Vyper</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Golang</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Simplicity</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Rholang</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Rust</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-lime-950 via-lime-900 to-lime-800 !pt-28">
                                <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
                                    <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Ecommerce Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Magento Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Shopify Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Wordpress Development</a></li>
                                    </ul>
                                </div>
                                <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Magento</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Shopify</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">BigCommerce</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                            <img class="w-full h-full" src="https://www.imgglobalinfotech.com/public/assets/img/hero-section/uber-cart.webp" alt="Ubercart">
                                        </div>
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Ubercart</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Woocommerce</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Wordpress</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-orange-950 via-orange-900 to-orange-800 !pt-28">
                                <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
                                    <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Mobile App Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire iOS App Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Flutter App Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire PHP Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Website Designers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire MEAN Stack Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Laravel Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Software Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Java Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Node.js Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Android App Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire React Native App Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Website Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Python Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Full Stack Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire MERN Stack Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire UI / UX Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire React JS Developers</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Hire Angularjs Developers</a></li>
                                    </ul>
                                </div>
                                {{-- <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Fullstack</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                    ...
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Mean Stack</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                                            
                                        </div>
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">Mern Stack</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
                        ...
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:block hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-cyan-950 via-cyan-900 to-cyan-800 !pt-28">
                                <div class="absolute inset-x-0 bottom-0 h-96 z-0 text-white/20 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent,white)]">
                                    <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                ...
                                <div class="py-10">
                                    <ul class="list-none flex flex-row g-3 flex-wrap w-full gap-3 relative z-0">
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Food Delivery App Development</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Grocery Delivery</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Fantasy sports App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Video Streaming App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Social Media App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Event Management App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Elearning App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Travel App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Pharmacy App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Fashion App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Doctor on Demand App</a></li>
                                        <li class="w-auto backdrop-blur-lg"><a href="javascript:;" class="text-white block md:font-semibold text-[12px] md:text-sm shadow-sm p-2 md:p-3 bg-white/20">Healthacare App</a></li>
                                    </ul>
                                </div>
                                <div class="text-white sm:text-lg text-base font-bold">Core Tech:</div>
                                <ul class="flex items-center flex-wrap overflow-hidden mt-5 gap-8">
                                    ...
                                    <li class="w-auto text-center gap-2">
                                        ...
                                        <div class="text-white sm:text-base text-sm text-center font-semibold mt-1">React JS</div>
                                    </li>
                                    <li class="w-auto text-center gap-2">
                                        <div class="md:w-10 w-8 md:h-10 h-8 text-center text-white mx-auto">
...
<div class="relative isolate py-16 sm:py-24 lg:py-32 overflow-hidden">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
