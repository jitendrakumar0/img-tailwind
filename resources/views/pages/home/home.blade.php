...
<div class="relative isolate overflow-hidden bg-gray-900 py-8 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0 select-none">
            ...
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl peer-checked/Inception:relative absolute peer-checked/Inception:z-[1] -z-20 peer-checked/Inception:translate-x-0 translate-x-1/4 peer-checked/Inception:opacity-100 opacity-0 duration-300 transition-[transform,opacity] ease-in">Inception</h2>
            ...
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl peer-checked/Innovation:relative absolute peer-checked/Innovation:z-[1] -z-20 peer-checked/Innovation:translate-x-0 translate-x-1/4 peer-checked/Innovation:opacity-100 opacity-0 duration-300 transition-[transform,opacity] ease-in">Innovation</h2>
            ...
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl peer-checked/Experience:relative absolute peer-checked/Experience:z-[1] -z-20 peer-checked/Experience:translate-x-0 translate-x-1/4 peer-checked/Experience:opacity-100 opacity-0 duration-300 transition-[transform,opacity] ease-in">Experience</h2>
            ...
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl peer-checked/Expertise:relative absolute peer-checked/Expertise:z-[1] -z-20 peer-checked/Expertise:translate-x-0 translate-x-1/4 peer-checked/Expertise:opacity-100 opacity-0 duration-300 transition-[transform,opacity] ease-in">Expertise</h2>
            ...
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl peer-checked/Assurance:relative absolute peer-checked/Assurance:z-[1] -z-20 peer-checked/Assurance:translate-x-0 translate-x-1/4 peer-checked/Assurance:opacity-100 opacity-0 duration-300 transition-[transform,opacity] ease-in">Assurance</h2>
...
<div class="relative isolate overflow-hidden">
    <div class="overflow-hidden bg-gradient-to-b from-white to-slate-200 pt-5 pb-36 sm:ps-0 ps-5 sm:pr-0 pr-5">
        ...
        <div class="pt-3 relative container mx-auto max-w-7xl px-6 lg:px-8 z-10">
            ...
            <div class="md:text-base sm:text-sm text-xs text-black/70 mt-3 mb-lg-1 select-none">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide group/service">
                            <div class="sm:p-6 p-4 rounded-2xl md:rounded-3xl relative z-0 opacity-0 group-[.swiper-slide-active]/service:h-auto h-0 overflow-hidden group-[.swiper-slide-active]/service:opacity-100 bg-gradient-to-b from-sky-950 via-sky-900 to-sky-800 !pt-28">
                                ...
                                <div class="md:text-base sm:text-sm text-xs text-white/60 mt-3 mb-lg-1 md:font-semibold select-none opacity-0 translate-x-1/4 delay-100 duration-300 group-[.swiper-slide-active]/service:opacity-100 group-[.swiper-slide-active]/service:translate-x-0">
                        ...
                        <div class="swiper-slide rounded-2xl overflow-hidden">
                            <div class="flex flex-col items-center text-center">
                                <div class="flex flex-col items-center text-center py-4 rounded-2xl bg-black/5 p-2 ring-1 ring-black/10">
                                    <div class="rounded-md bg-black/5 p-2 ring-1 ring-black/10 select-none">
                                    ...
                                    <dt class="mt-4 font-semibold text-black select-none">Mid-Market High Performer United States – 2022-2023</dt>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide rounded-2xl overflow-hidden">
    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="relative isolate overflow-hidden text-center justify-center bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div class="mx-auto max-w-3xl lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-300 text-center select-none">Do you want to experience the best-in-class quality mobile apps? Send us your inquiry and one of our executives will catch you up in no time by Call, Email or Skype.</p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#" class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 select-none shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Book A Discovery Call</a>
...
<div class="bg-white relative py-10">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="absolute inset-x-0 top-0 h-96 z-0 text-slate-600/10 [mask-image:linear-gradient(to_top,transparent,white)] pointer-events-none">
            <svg class="absolute inset-0 h-full w-full" xmlns="http://www.w3.org/2000/svg">
                <defs>
        ...
        <p class="mt-4 select-none max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-black">
            ...
            <span class="font-bold bg-gradient-to-r from-theme6 via-yellow-600 to-theme6 bg-clip-text text-transparent"> Industries Covered By Us!</span>
        </p>
        <div class="md:text-base sm:text-sm text-xs text-black/70 mt-3 mb-lg-1 select-none">
...
<div class="bg-white relative overflow-hidden py-4 select-none">
    <div class="hidden z-0 sm:absolute sm:-top-10 sm:right-1/2 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl" aria-hidden="true">
        <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-yellow-700 to-pink-700 opacity-20" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
    <div class="absolute z-0 -top-52 left-1/2 -translate-x-1/2 transform-gpu blur-3xl sm:top-[-28rem] sm:ml-16 sm:translate-x-0 sm:transform-gpu" aria-hidden="true">
        <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-yellow-700 to-pink-700 opacity-20" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
    <div class="mx-auto max-w-7xl px-6 lg:px-8 z-[1] relative">
        <p class="mt-4 select-none max-md:text-xl/tight max-xl:text-2xl/tight text-3xl/tight tracking-[-0.04em] text-black text-center">
            <span class="font-normal">Stay Informed Of Latest Innovations and Trends With Our Blogs!</span> <br>
            <span class="font-bold bg-gradient-to-r from-theme6 via-yellow-600 to-theme6 bg-clip-text text-transparent"> Explore our insightful blogs to stay abreast of the latest innovations and trends. Stay informed, stay ahead.</span>
        </p>
      <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 pt-10 sm:pt-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <article class="flex max-w-xl flex-col items-start justify-between">
          ...
          <div class="flex items-center gap-x-4 text-xs pt-5">
            ...
            <a href="#" class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">Mobile App</a>
          </div>
