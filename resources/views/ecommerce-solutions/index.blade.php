      ...
      <div class="container py-5 zi-2 position-relative">
         <div class="row">
            ...
            <div class="col-12 pt-3 text-center">
               <a class="btn btn-white fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
               ...
               <div class="row align-items-center">
                  <div class="col-12 text-center">
                     <div class="row">
                        ...
                        <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-2">Sell your products/services with our best-fit, high-performance eCommerce websites. We'll offer the best CMS based eCommerce solution that allows you to update pricing, add and manage products efficiently. Our eCommerce solution is integrated with popular payment processor partners so that your company can be paid easily.</div>
                        <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-2">We also offer integration with top-ranked shipping companies. Contact us to get a customized quote right away for eCommerce development platforms! Research, Analyze and Strategize</div>
                        <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-2">Our eCommerce services company in India have technical analysts, web designers, and strategists working together as one single unit on every project. Before commencing with your designing project, they will conduct in-depth research and analysis to propose a data-driven web designing solution.</div>
                        <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-2">We believe in the power of research-driven strategies to create quality products that ensure our clients are at the forefront of their respective markets.</div>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row align-items-center justify-content-center text-center px-4 h-100">
                  <div class="col-md-12 h-100">
                     <div class="row h-100 app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                        ...
                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-m tz" style="--tz:30px;">Digital Competitive Analysis</div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-l py-4 tz" style="--tz:30px;">A thorough digital competitive analysis report will identify your weaknesses, strengths, weaknesses, threats, and opportunities from a digital marketing perspective.</div>
                        <div class="col-12">
               ...
               <div class="row align-items-center justify-content-center text-center px-4 h-100">
                  <div class="col-md-12 h-100">
                     <div class="row h-100 app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                        ...
                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-m tz" style="--tz:30px;">Content Marketing Strategy</div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-l py-4 tz" style="--tz:30px;">We provide engaging content to shoppers and answer their questions preemptively through landing pages, review articles, product blog posts, email newsletters, and eBooks.</div>
                        <div class="col-12">
                           <a class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                              <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                           </a>
               ...
               <div class="row align-items-center justify-content-center text-center px-4 h-100">
                  <div class="col-md-12 h-100">
                     <div class="row h-100 app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                        ...
                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-m tz" style="--tz:30px;">Email Marketing Campaigns</div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-l py-4 tz" style="--tz:30px;">It is one of the popular forms of eCommerce marketing strategy where you can reach new shoppers and encourage your existing customers to repeat purchases.</div>
                        <div class="col-12">
                           <a class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                              <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                           </a>
               ...
               <div class="row align-items-center justify-content-center text-center px-4 h-100">
                  <div class="col-md-12 h-100">
                     <div class="row h-100 app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                        ...
                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-m tz" style="--tz:30px;">Conversion Rate Optimization</div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-l py-4 tz" style="--tz:30px;">Our skilled conversion rate experts will execute multiple tests to improve your website’s visit-to-lead conversion rates and convert your site visitors into lifelong shoppers.</div>
                        <div class="col-12">
                           <a class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                              <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                           </a>
               ...
               <div class="row align-items-center justify-content-center text-center px-4 h-100">
                  <div class="col-md-12 h-100">
                     <div class="row h-100 app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                        ...
                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-m tz" style="--tz:30px;">Ecommerce SEO Solutions</div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-l py-4 tz" style="--tz:30px;">Being a leading ecommerce SEO services company, we combine on-site optimization techniques and SEO-focused content strategy to enhance your domain authority according to the latest Google algorithm updates.</div>
                        <div class="col-12">
                           <a class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                              <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                           </a>
               ...
               <div class="row align-items-center justify-content-center text-center px-4 h-100">
                  <div class="col-md-12 h-100">
                     <div class="row h-100 app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                        ...
                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-m tz" style="--tz:30px;">Ecommerce PPC Solutions</div>
                        <div class="col-12 fs-md-16 fs-sm-15 fs-14 fw-l py-4 tz" style="--tz:30px;">We skillfully optimize, execute, verify, and manage all-inclusive eCommerce PPC campaigns using real-time data that are intended to skyrocket your expected sales target.</div>
                        <div class="col-12">
                           <a class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                              <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                           </a>
         ...
         <div class="row justify-content-center">
            <div class="col-md-6 mt-4 d-flex align-items-stretch">
               <div class="api_benifits text-center shadow bg-white rounded px-4 py-5">
                  ...
                  <div class="col-12 fw-m text-theme1 fs-md-20 fs-sm-18 fs-16 text-uppercase lh-normal mt-3 tz" style="--tz:30px;">Ecommerce Development Services</div>
                  <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Our philosophy is to make your site aesthetically appealing, but at the same time, the website design must allow effortless navigation. So, our web designers are ready to go that extra mile in creating a site design, i.e., both powerful and effective.</div>
                  <div class="col-12 pt-4">
                     <a class="btn btn-theme3 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                        <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                     </a>
                  </div>
               </div>
            ...
            <div class="col-md-6 mt-4 d-flex align-items-stretch">
               <div class="api_benifits text-center shadow bg-white rounded px-4 py-5">
                  ...
                  <div class="col-12 fw-m text-theme1 fs-md-20 fs-sm-18 fs-16 text-uppercase lh-normal mt-3 tz" style="--tz:30px;">Ecommerce Consulting Services</div>
                  <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">Setting up your online presence on the Internet is quite easy. But reaching out to your potential customers and maximizing your sales is more complex. Our team of experienced marketing experts works closely with you to design and execute marketing campaigns, allowing you to focus on your business.</div>
                  <div class="col-12 pt-4">
                     <a class="btn btn-theme3 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                        <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                     </a>
