...
@push('styles')
   ...
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/ecommerce-website-development-in-jaipur.min.css">
@endpush
@section('content')
...
<script src="{{asset('/public')}}/assets/js/ecommerce-website-development-in-jaipur.min.js"></script>
