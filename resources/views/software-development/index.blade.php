...
@push('meta')
   ...
   <meta name="classification" content="software development company, software development services, custom software development company, software development services company, enterprise software development company, software development consulting services, enterprise software development firm" />
   <link rel="canonical" href="{{asset('/')}}software-development.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/software-development.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Custom Software Development Services</h1>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           <img src="{{GETFOLDERPATH()}}/software-development-1.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Custom-Software-Development-Services.webp"alt="Custom Software Development Services" width="100" height="auto">
                         </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- Software Development Company section -->
   <div class="container-fluid overflow-hidden software-development-company-section bg-white position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                           <img src="{{GETFOLDERPATH()}}/software-development-2.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Software-Development-Company.webp"alt="Software Development Company" width="100" height="auto">
                       </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Software Development Company</h2>
            ...
            <div class="col-lg-7">
               ...
               <div class="row s-sidebar mx-0 py-4 gap-4 justify-content-start">
                  <a href="javascript:;" id="app-service-1" class="col-auto s-item wave-1 active" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Front-end-development-service</h3>
                        <div class="col"><span class="d-block">Front-end-development-service</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-2" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Do not let Development Service</h3>
                        <div class="col"><span class="d-block">Do not let Development Service</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-3" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Backend Development Service</h3>
                        <div class="col"><span class="d-block">Backend Development Service</span></div>
                     </div>
                  </a>
                  <a href="javascript:;" id="app-service-4" class="col-auto s-item wave-1" style="--tz:20px;">
                     <div class="row align-items-center">
                        <h3 class="d-none invisible">Mobile App Development Service</h3>
                        <div class="col"><span class="d-block">Mobile App Development Service</span></div>
                     </div>
                  </a>
               </div>
            </div>
            <div class="col-lg-5 all-app-services">
               <div class="col-12 h-100" data-hash="app-service-1">
                  <div class="row align-items-center justify-content-center text-center px-4 h-100">
                     <div class="col-md-12">
                        <div class="row bg-white app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5 bg-white" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                           <div class="col-12">
               ...
               <div class="col-12 h-100" data-hash="app-service-2" style="display: none;">
                  <div class="row align-items-center justify-content-center text-center px-4 h-100">
                     <div class="col-md-12">
                        <div class="row bg-white app_service_content position-relative py-5 px-3 border-top border-theme3 border-5 border-bottom border-theme3 border-5" style="transform-style: preserve-3d;" data-tilt data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2000">
                           <div class="col-12">
                              <span class="tab_icos d-block tz" style="--tz:30px;">
   ...
   <!-- Top-notch Enterprise Software Development Company Process -->
   <div class="container-fluid overflow-hidden software-development-company-section bg-white position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                           <img src="{{GETFOLDERPATH()}}/software-development-3.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/Top-notch-Enterprise-Software-Development-Company-Process.webp"alt="Top-notch Enterprise Software Development Company Process" width="100" height="auto">
                       </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Top-notch Enterprise Software Development Company Process</h2>
   ...
   <!-- software devolopment solutions section -->
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           How to choose the best Software Development Services Company in India?
                        </button>
                     </h2>
                  ...
                  <div class="accordion-item mb-4 position-relative zi-2">
                     <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           What are the top benefits of Outsourcing a Software Development Firm?
                        </button>
                     </h2>
...
@push('scripts')
   ...
   <script src="{{asset('/public')}}/assets/js/software-development.min.js"></script>
@endpush
