...
@push('meta')
	<!--  Title -->
	<title>Real Estate Financial Management, Financial Management Solution, Financial Management System India- IMG Global Infotech</title>

	<!-- Required meta tags -->
	<meta name="title" content="Real Estate Financial Management, Financial Management Solution, Financial Management System India- IMG Global Infotech" />
	<meta name="description" content="Financial management is design to manage various financial issues related to real estate like deliver automation, control and integration for property accounting." />
	<meta name="keywords" content="Real Estate Software, Real Estate Financial Management, Financial Management Solution, Financial Management System, Financial Management System India, Real Estate Financial Management Solution, Real Estate Financial Management Software" />

	<!-- Twitter Meta -->
	<meta name="twitter:title" content="Real Estate Financial Management, Financial Management Solution, Financial Management System India- IMG Global Infotech">
	<meta name="twitter:description" content="Financial management is design to manage various financial issues related to real estate like deliver automation, control and integration for property accounting.">
	<meta name="twitter:image" content="{{asset('/public')}}/assets/img/financial-management/Financial-Management.webp">

	<!-- Facebook Meta -->
	<meta property="og:url" content="{{asset('/')}}financial-management.php">
	<meta property="og:title" content="Real Estate Financial Management, Financial Management Solution, Financial Management System India- IMG Global Infotech">
	<meta property="og:description" content="Financial management is design to manage various financial issues related to real estate like deliver automation, control and integration for property accounting.">
	<meta property="og:image" content="{{asset('/public')}}/assets/img/financial-management/Financial-Management.webp">
	<meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/financial-management/Financial-Management.webp">

	


	<meta name="classification" content="Real Estate Software, Real Estate Financial Management, Financial Management Solution, Financial Management System, Financial Management System India, Real Estate Financial Management Solution, Real Estate Financial Management Software" />
	<link rel="canonical" href="{{asset('/')}}financial-management.php" />
	<meta name="robots" content="index, follow" />
@endpush
@push('styles')
	<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/financial-management.min.css">
@endpush
@section('content')

	<!-- top banner section -->
	<div class="container-fluid overflow-hidden bg-white top_banner position-relative" style="--bg:url({{asset('/public')}}/assets/img/financial-management/hero.webp);">
							...
							<div class="row pt-3 text-lg-start text-md-center text-center">
								<div class="col-12">
									<div class="row mx-0 pb-2">
										<h1 class="d-none invisible">Financial Management</h1>
						...
						<div class="col-lg-6 pe-lg-5 top_banner-left-part">
							<div class="row justify-content-lg-end justify-content-md-center justify-content-center">
								<div class="col-lg-8 col-md-5 col-7 position-relative" style="transform-style: preserve-3d;" data-tilt-full-page-listening data-tilt="" data-tilt-max="2" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
									<img class="w-100 position-relative tz" style="--tz:90px;" src="{{asset('/public')}}/assets/img/financial-management/Financial-Management.webp" alt="Financial Management">
									<img class="w-100 position-absolute top-0 left-0 bottom-0 end-0 tz" style="--tz:20px;" src="{{asset('/public')}}/assets/img/financial-management/2.webp" alt="IMG Global Infotech Layer">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="row mx-0 pb-4">
								<h2 class="d-none invisible">Advantages Of Financial Management Software</h2>
								<div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Advantages Of <b> Financial Management Software </b></span></div>
							</div>
						</div>
...
@endsection
@push('scripts')
	<script src="{{asset('/public')}}/assets/js/financial-management.min.js"></script>
@endpush