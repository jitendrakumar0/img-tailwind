...
Route::get('/hire-ott-app-developers.php', 'HomeController@hire_ott_app_developers');
...
Route::get('case-study/bobilive.php', 'HomeController@casestudy_1');
Route::get('case-study/hozzo.php', 'HomeController@casestudy_2');
Route::get('case-study/myfab11.php', 'HomeController@casestudy_3');
Route::get('case-study/fabindia.php', 'HomeController@casestudy_4');
Route::get('/ready-to-move.php', 'HomeController@ready_to_move');

Route::get('casestudy-5.php', 'HomeController@casestudy_5');

Route::get('/real-estate-app-development.php', 'HomeController@real_estate_demo');
Route::get('/healthcare-software-development.php', 'HomeController@healthcare_demo');
Route::get('/retail-and-eCommerce.php', 'HomeController@ecommerce_demo');

Route::get('/edtech-software-development.php', 'HomeController@education_demo');
Route::get('/fintech-software-development.php', 'HomeController@banking_demo');
Route::get('/logistics-software-development.php', 'HomeController@transport_demo');
Route::get('/media-and-entertainment-app-development.php', 'HomeController@media_demo');
Route::get('/travel-app-development.php', 'HomeController@tour_demo');
...
Route::get('/ar-vr-app-development.php', 'HomeController@ar_vr_app_development');
Route::get('/video-streaming-app-development.php', 'HomeController@video_streaming_app_development');
Route::get('/iot-app-development.php', 'HomeController@iot_app_development');
Route::get('/home-services-app-development.php', 'HomeController@home_services_app_development');

Route::get('/laundry-services-app-development.php', 'HomeController@laundry_services_app_development');
Route::get('/tracking-app-development.php', 'HomeController@tracking_app_development');
Route::get('/car-wash-app-development.php', 'HomeController@car_wash_app_development');

Route::get('/bespoke-software-development.php', 'HomeController@bespoke_software_development');
Route::get('/food-delivery-demo.php', 'HomeController@food_delivery_demo');

Route::get('/fantasy-sports-app-demo.php', 'HomeController@fantasy_sports_app_demo');
...
Route::get('/fantasy-stock-market-app-development.php', 'HomeController@fantasy_sports_app_development');
...
Route::any('/thankyou.php', 'HomeController@thankyou')->name('thankyou');
...
Route::post('/contact_action', 'HomeController@contact_action')->name('contact_action');
Route::post('/contact_action_help', 'HomeController@contact_action_help')->name('contact_action_help');
